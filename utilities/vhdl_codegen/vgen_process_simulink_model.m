...
vhdl_source_path = [mp.model_path '\hdl_prj\ipcore\' avalon.entity '_v1_0\hdl\'];
outfile = [vhdl_source_path avalon.entity, '_avalon.vhd'];
...
source_directory = [mp.model_path '\hdl_prj\ipcore\' avalon.entity '_v1_0'];
destination_directory = [mp.quartus_project_path '\ip\' avalon.entity '_v1_0'];
disp(['vgen: Copying IP Core to Quartus project directory'])
disp(['vgen: Copying IP Core ' avalon.entity '_v1_0 from: ' source_directory ' to: ' destination_directory])
[status,message,messageId] = copyfile(source_directory, destination_directory, 'f');
if status ~= 1
    disp(['vgen: directory copy issue: ' message])
end
