...
set_interface_property clock clockRate 96000
...
add_interface_port avalon_streaming_sink avalon_sink_data data Input 8
...
add_interface_port avalon_streaming_source avalon_source_data data Output 8
