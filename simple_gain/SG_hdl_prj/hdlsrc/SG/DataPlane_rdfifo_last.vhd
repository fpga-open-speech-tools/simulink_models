-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_rdfifo_last
-- Source Path: DataPlane/DataPlane_axi4/DataPlane_axi4_module/DataPlane_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataPlane_rdfifo_last IS
...
END DataPlane_rdfifo_last;


ARCHITECTURE rtl OF DataPlane_rdfifo_last IS

  -- Component Declarations
  COMPONENT DataPlane_rdfifo_last_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DataPlane_rdfifo_last_classic
    USE ENTITY work.DataPlane_rdfifo_last_classic(rtl);
...
BEGIN
  u_DataPlane_rdfifo_last_classic_inst : DataPlane_rdfifo_last_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
