-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_axi4_module
-- Source Path: DataPlane/DataPlane_axi4/DataPlane_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataPlane_axi4_module IS
...
END DataPlane_axi4_module;


ARCHITECTURE rtl OF DataPlane_axi4_module IS

  -- Component Declarations
  COMPONENT DataPlane_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DataPlane_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DataPlane_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DataPlane_rdfifo_data
    USE ENTITY work.DataPlane_rdfifo_data(rtl);

  FOR ALL : DataPlane_rdfifo_rid
    USE ENTITY work.DataPlane_rdfifo_rid(rtl);

  FOR ALL : DataPlane_rdfifo_last
    USE ENTITY work.DataPlane_rdfifo_last(rtl);
...
BEGIN
  u_DataPlane_rdfifo_data_inst : DataPlane_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_DataPlane_rdfifo_rid_inst : DataPlane_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_DataPlane_rdfifo_last_inst : DataPlane_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
