-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_rdfifo_data
-- Source Path: DataPlane/DataPlane_axi4/DataPlane_axi4_module/DataPlane_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataPlane_rdfifo_data IS
...
END DataPlane_rdfifo_data;


ARCHITECTURE rtl OF DataPlane_rdfifo_data IS

  -- Component Declarations
  COMPONENT DataPlane_rdfifo_data_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  FOR ALL : DataPlane_rdfifo_data_classic
    USE ENTITY work.DataPlane_rdfifo_data_classic(rtl);
...
BEGIN
  u_DataPlane_rdfifo_data_classic_inst : DataPlane_rdfifo_data_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
