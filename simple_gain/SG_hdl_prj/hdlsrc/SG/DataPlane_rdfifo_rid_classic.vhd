-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_rdfifo_rid_classic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_rdfifo_rid_classic
-- Source Path: DataPlane/DataPlane_axi4/DataPlane_axi4_module/DataPlane_rdfifo_rid/DataPlane_rdfifo_rid_classic
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataPlane_rdfifo_rid_classic IS
...
END DataPlane_rdfifo_rid_classic;


ARCHITECTURE rtl OF DataPlane_rdfifo_rid_classic IS

  -- Component Declarations
  COMPONENT DataPlane_SimpleDualPortRAM_generic
  ...
  FOR ALL : DataPlane_SimpleDualPortRAM_generic
    USE ENTITY work.DataPlane_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DataPlane_rdfifo_rid_classic_ram : DataPlane_SimpleDualPortRAM_generic
