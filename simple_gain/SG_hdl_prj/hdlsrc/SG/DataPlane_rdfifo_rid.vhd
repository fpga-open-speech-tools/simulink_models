-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_rdfifo_rid
-- Source Path: DataPlane/DataPlane_axi4/DataPlane_axi4_module/DataPlane_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataPlane_rdfifo_rid IS
...
END DataPlane_rdfifo_rid;


ARCHITECTURE rtl OF DataPlane_rdfifo_rid IS

  -- Component Declarations
  COMPONENT DataPlane_rdfifo_rid_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  FOR ALL : DataPlane_rdfifo_rid_classic
    USE ENTITY work.DataPlane_rdfifo_rid_classic(rtl);
...
BEGIN
  u_DataPlane_rdfifo_rid_classic_inst : DataPlane_rdfifo_rid_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
