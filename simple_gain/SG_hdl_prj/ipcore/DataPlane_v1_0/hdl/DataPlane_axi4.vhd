-- -------------------------------------------------------------
-- 
-- File Name: SG_hdl_prj\hdlsrc\SG\DataPlane_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DataPlane_axi4
-- Source Path: DataPlane/DataPlane_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF DataPlane_axi4 IS

  -- Component Declarations
  COMPONENT DataPlane_addr_decoder
  ...
  COMPONENT DataPlane_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : DataPlane_addr_decoder
    USE ENTITY work.DataPlane_addr_decoder(rtl);

  FOR ALL : DataPlane_axi4_module
    USE ENTITY work.DataPlane_axi4_module(rtl);
...
BEGIN
  u_DataPlane_addr_decoder_inst : DataPlane_addr_decoder
  ...
  u_DataPlane_axi4_module_inst : DataPlane_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
