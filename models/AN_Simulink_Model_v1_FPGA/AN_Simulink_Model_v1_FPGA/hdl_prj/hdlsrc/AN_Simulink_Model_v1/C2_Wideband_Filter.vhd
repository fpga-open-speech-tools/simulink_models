-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\AN_Simulink_Model_v1\C2_Wideband_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: C2_Wideband_Filter
-- Source Path: AN_Simulink_Model_v1/Auditory Nerve Model/C2 Wideband Filter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END C2_Wideband_Filter;


ARCHITECTURE rtl OF C2_Wideband_Filter IS
  ...
  COMPONENT Calculate_C2filterout
  ...
  FOR ALL : Calculate_C2filterout
    USE ENTITY work.Calculate_C2filterout(rtl);
  ...
  SIGNAL c2filterouttmp                   : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  -- C2 Wideband Filter:
  -- 
  -- Input: ME Filtered Signal (meout)
  -- 
  -- Output: C2 Filtered Signal (c2filterout)
  -- 
  ...
  -- 
  -- Calculate C2 Filter Output:
  -- 
  -- - Simply scale filter output
  ...
  u_nfp_mul_comp_25 : nfp_mul_single
    PORT MAP( nfp_in1 => kconst,  -- single
              ...
              nfp_out => c2filterouttmp  -- single
              );

  u_Calculate_C2filterout : Calculate_C2filterout
    PORT MAP( C2filterouttmp => c2filterouttmp,  -- single
              C2filterout => output  -- single
              );

  kconst <= X"59f1801e";

  Constant23_out1 <= X"37267677";

  Constant18_out1 <= X"3733694e";

  Constant14_out1 <= X"37267677";

  Constant7_out1 <= X"372cc1bb";

  Constant3_out1 <= X"35cb655c";
  ...
  Constant4_out1 <= X"b719fca2";

  Constant2_out1 <= X"3733694e";
  ...
  Constant5_out1 <= X"bff2a9f1";

  Constant6_out1 <= X"3f6a079f";
  ...
  Constant8_out1 <= X"35c3da0c";

  Constant9_out1 <= X"b714467a";

  Constant10_out1 <= X"bfe96bff";

  Constant11_out1 <= X"3f585627";
  ...
  Constant15_out1 <= X"35bcb761";

  Constant16_out1 <= X"b70edf8b";

  Constant12_out1 <= X"bfe081fe";

  Constant13_out1 <= X"3f47f2a0";
  ...
  Constant19_out1 <= X"35cb655c";

  Constant20_out1 <= X"b719fca2";

  Constant1_out1 <= X"bff2a9f1";

  Constant17_out1 <= X"3f6a079f";
  ...
  Constant24_out1 <= X"35bcb761";

  Constant25_out1 <= X"b70edf8b";

  Constant21_out1 <= X"bfe081fe";

  Constant22_out1 <= X"3f47f2a0";
