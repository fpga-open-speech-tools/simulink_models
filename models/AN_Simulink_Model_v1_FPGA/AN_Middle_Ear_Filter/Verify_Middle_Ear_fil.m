...
subplot(2,1,1)
plot(out.mearout1);
title('Middle Ear Filter Output - Simulink Single Precision')
xlabel('Sample Number');
subplot(2,1,2)
plot(out.mearoutfpga)
title('Middle Ear Filter Output - FPGA-in-the-Loop')
xlabel('Sample Number');
...
[avgpercerror,maxpercerror,normerror,percerror] = calcerror(out.mearout1, out.mearoutfpga);

% Adding more detailed title to function generated Error Distribution Plot
title('Percent Error Distribution (Stage 2) - Middle Ear Filter');

% Display in Simulink Diagnostics menu
disp('Middle Ear Filter Average Percent Error =');
disp(avgpercerror);

% Display in Simulink Diagnostics menu
disp('Middle Ear Filter Maximum Percent Error =');
disp(maxpercerror);

% Display in Simulink Diagnostics menu
disp('Middle Ear Filter Euclidean Norm Error =');
disp(normerror);
