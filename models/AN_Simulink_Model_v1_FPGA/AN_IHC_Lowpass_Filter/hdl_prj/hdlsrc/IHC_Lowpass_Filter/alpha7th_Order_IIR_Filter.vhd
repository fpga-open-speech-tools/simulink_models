-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\IHC_Lowpass_Filter\alpha7th_Order_IIR_Filter.vhd
...
-- -------------------------------------------------------------
-- Model base rate: 3.25521e-07
-- Target subsystem base rate: 3.25521e-07
...
-- -------------------------------------------------------------
-- 
-- Module: alpha7th_Order_IIR_Filter
-- Source Path: alpha7th_Order_IIR_Filter
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY alpha7th_Order_IIR_Filter IS
...
END alpha7th_Order_IIR_Filter;


ARCHITECTURE rtl OF alpha7th_Order_IIR_Filter IS

  -- Component Declarations
  COMPONENT alpha7th_Order_IIR_Filter_tc
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  FOR ALL : alpha7th_Order_IIR_Filter_tc
    USE ENTITY work.alpha7th_Order_IIR_Filter_tc(rtl);
...
BEGIN
  ...
  u_alpha7th_Order_IIR_Filter_tc : alpha7th_Order_IIR_Filter_tc
    PORT MAP( clk => clk,
              reset => reset,
