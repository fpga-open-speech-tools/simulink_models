...
ARCHITECTURE rtl OF fft_filters_Overlap_and_Add_block IS
  ...
  COMPONENT fft_filters_FIFO_Write_Select_block
  ...
  COMPONENT fft_filters_fifo_state_machine_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2048_0                    :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  COMPONENT fft_filters_fifo_state_machine1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2048_0                    :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  COMPONENT fft_filters_fifo_state_machine2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2048_0                    :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  COMPONENT fft_filters_fifo_state_machine3_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_2048_0                    :   IN    std_logic;
          valid                           :   IN    std_logic;
  ...
  FOR ALL : fft_filters_FIFO_Write_Select_block
    USE ENTITY work.fft_filters_FIFO_Write_Select_block(rtl);

  FOR ALL : fft_filters_fifo_state_machine_block
    USE ENTITY work.fft_filters_fifo_state_machine_block(rtl);

  FOR ALL : fft_filters_fifo_state_machine1_block
    USE ENTITY work.fft_filters_fifo_state_machine1_block(rtl);

  FOR ALL : fft_filters_fifo_state_machine2_block
    USE ENTITY work.fft_filters_fifo_state_machine2_block(rtl);

  FOR ALL : fft_filters_fifo_state_machine3_block
    USE ENTITY work.fft_filters_fifo_state_machine3_block(rtl);
...
BEGIN
  ...
  u_FIFO_Write_Select : fft_filters_FIFO_Write_Select_block
  ...
  u_fifo_state_machine : fft_filters_fifo_state_machine_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2048_0 => enb_1_2048_0,
              valid => valid_1,
  ...
  u_fifo_state_machine1 : fft_filters_fifo_state_machine1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2048_0 => enb_1_2048_0,
              valid => valid_2,
  ...
  u_fifo_state_machine2 : fft_filters_fifo_state_machine2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2048_0 => enb_1_2048_0,
              valid => valid_3,
  ...
  u_fifo_state_machine3 : fft_filters_fifo_state_machine3_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_2048_0 => enb_1_2048_0,
              valid => valid_4,
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb_1_2048_0 = '1' AND FFT_Frame_Pulse = '1' THEN
