...
switch filter_select
    case 1
        plot([low_pass_cutoff low_pass_cutoff],[a(3) a(4)],'r')
        plot([a(1) a(2)],[-3 -3],'r')
        f1 = low_pass_index * Fs / FFT_size;
        plot([f1 f1],[a(3) a(4)],'g')
        title(['Low Pass Cutoff = ' num2str(low_pass_cutoff) ' Hz'])
    ...
    case 3
        plot([high_pass_cutoff high_pass_cutoff],[a(3) a(4)],'r')
        plot([a(1) a(2)],[-3 -3],'r')
        f1 = high_pass_index * Fs / FFT_size;
        plot([f1 f1],[a(3) a(4)],'g')
        title(['High Pass Cutoff = ' num2str(high_pass_cutoff) ' Hz'])
