...
if {$argc > 0} {
    ...
    quietly set base_dir "D:/trevor/research/NIH_SBIR_R44_DC015443/Audio_Beamforming/hw/library/acoustic_delay_buffer/./rtl"
...
if {! [file exists $base_dir/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05]} {
    file delete -force $base_dir/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05
}

project new $base_dir busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/acoustic_delay_buffer/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05_fpc.do"
} else {
...
vcom -quiet $base_dir/acoustic_delay_buffer/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05.vhd
vcom -quiet -O0 $base_dir/acoustic_delay_buffer/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05_atb.vhd
vcom -quiet $base_dir/acoustic_delay_buffer/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_AMMregisterWireData_acoustic_delay_buffer_adb_RegField_x} mismatch] == 0 && $mismatch } {
                report_mismatch out_AMMregisterWireData_acoustic_delay_buffer_adb_RegField_x $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05_atb 
    do $base_dir/acoustic_delay_buffer/busSlaveFabric_acoustic_delay_buffer_adb_3c06i26010e10x10y10070o7054cz5iwt1y05_atb.wav.do
