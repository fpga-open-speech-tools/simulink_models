...
if {! [file exists $base_dir/acoustic_delay_buffer_adb_AStInput]} {
    file delete -force $base_dir/acoustic_delay_buffer_adb_AStInput
}

project new $base_dir acoustic_delay_buffer_adb_AStInput
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/acoustic_delay_buffer/acoustic_delay_buffer_adb_AStInput_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/acoustic_delay_buffer/acoustic_delay_buffer_adb_AStInput_atb.vhd
vcom -quiet $base_dir/acoustic_delay_buffer/acoustic_delay_buffer_adb_AStInput_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps acoustic_delay_buffer_adb_AStInput_atb 
    do $base_dir/acoustic_delay_buffer/acoustic_delay_buffer_adb_AStInput_atb.wav.do
