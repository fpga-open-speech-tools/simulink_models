-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_axi4
-- Source Path: SG_DataPlane/SG_DataPlane_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END SG_DataPlane_axi4;


ARCHITECTURE rtl OF SG_DataPlane_axi4 IS

  -- Component Declarations
  COMPONENT SG_DataPlane_addr_decoder
  ...
  COMPONENT SG_DataPlane_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : SG_DataPlane_addr_decoder
    USE ENTITY work.SG_DataPlane_addr_decoder(rtl);

  FOR ALL : SG_DataPlane_axi4_module
    USE ENTITY work.SG_DataPlane_axi4_module(rtl);
...
BEGIN
  u_SG_DataPlane_addr_decoder_inst : SG_DataPlane_addr_decoder
  ...
  u_SG_DataPlane_axi4_module_inst : SG_DataPlane_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
