-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_src_Avalon_Data_Processing.vhd
-- Created: 2019-08-02 08:24:15
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_src_Avalon_Data_Processing
...
ENTITY SG_DataPlane_src_Avalon_Data_Processing IS
...
END SG_DataPlane_src_Avalon_Data_Processing;


ARCHITECTURE rtl OF SG_DataPlane_src_Avalon_Data_Processing IS

  -- Component Declarations
  COMPONENT SG_DataPlane_src_Left_Channel_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SG_DataPlane_src_Right_Channel_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SG_DataPlane_src_Left_Channel_Processing
    USE ENTITY work.SG_DataPlane_src_Left_Channel_Processing(rtl);

  FOR ALL : SG_DataPlane_src_Right_Channel_Processing
    USE ENTITY work.SG_DataPlane_src_Right_Channel_Processing(rtl);
...
BEGIN
  ...
  u_Left_Channel_Processing : SG_DataPlane_src_Left_Channel_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
  ...
  u_Right_Channel_Processing : SG_DataPlane_src_Right_Channel_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
