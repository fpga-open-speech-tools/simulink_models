-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_rdfifo_rid
-- Source Path: SG_DataPlane/SG_DataPlane_axi4/SG_DataPlane_axi4_module/SG_DataPlane_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SG_DataPlane_rdfifo_rid IS
...
END SG_DataPlane_rdfifo_rid;


ARCHITECTURE rtl OF SG_DataPlane_rdfifo_rid IS

  -- Component Declarations
  COMPONENT SG_DataPlane_rdfifo_rid_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  FOR ALL : SG_DataPlane_rdfifo_rid_classic
    USE ENTITY work.SG_DataPlane_rdfifo_rid_classic(rtl);
  ...
  SIGNAL fifo_data_out                    : std_logic_vector(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL fifo_data_out_unsigned           : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_SG_DataPlane_rdfifo_rid_classic_inst : SG_DataPlane_rdfifo_rid_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => In_rsvd,  -- ufix12
              Push => fifo_push,  -- ufix1
              Pop => fifo_pop,  -- ufix1
              Out_rsvd => fifo_data_out,  -- ufix12
