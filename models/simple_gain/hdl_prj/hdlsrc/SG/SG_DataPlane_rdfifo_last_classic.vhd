-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_rdfifo_last_classic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_rdfifo_last_classic
-- Source Path: SG_DataPlane/SG_DataPlane_axi4/SG_DataPlane_axi4_module/SG_DataPlane_rdfifo_last/SG_DataPlane_rdfifo_last_classic
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SG_DataPlane_rdfifo_last_classic IS
...
END SG_DataPlane_rdfifo_last_classic;


ARCHITECTURE rtl OF SG_DataPlane_rdfifo_last_classic IS

  -- Component Declarations
  COMPONENT SG_DataPlane_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : SG_DataPlane_SimpleDualPortRAM_singlebit
    USE ENTITY work.SG_DataPlane_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_SG_DataPlane_rdfifo_last_classic_ram_singlebit : SG_DataPlane_SimpleDualPortRAM_singlebit
