-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_rdfifo_data
-- Source Path: SG_DataPlane/SG_DataPlane_axi4/SG_DataPlane_axi4_module/SG_DataPlane_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SG_DataPlane_rdfifo_data IS
...
END SG_DataPlane_rdfifo_data;


ARCHITECTURE rtl OF SG_DataPlane_rdfifo_data IS

  -- Component Declarations
  COMPONENT SG_DataPlane_rdfifo_data_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  FOR ALL : SG_DataPlane_rdfifo_data_classic
    USE ENTITY work.SG_DataPlane_rdfifo_data_classic(rtl);
...
BEGIN
  u_SG_DataPlane_rdfifo_data_classic_inst : SG_DataPlane_rdfifo_data_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
