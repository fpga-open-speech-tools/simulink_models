-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\SG\SG_DataPlane_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SG_DataPlane_axi4_module
-- Source Path: SG_DataPlane/SG_DataPlane_axi4/SG_DataPlane_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SG_DataPlane_axi4_module IS
...
END SG_DataPlane_axi4_module;


ARCHITECTURE rtl OF SG_DataPlane_axi4_module IS

  -- Component Declarations
  COMPONENT SG_DataPlane_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SG_DataPlane_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT SG_DataPlane_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SG_DataPlane_rdfifo_data
    USE ENTITY work.SG_DataPlane_rdfifo_data(rtl);

  FOR ALL : SG_DataPlane_rdfifo_rid
    USE ENTITY work.SG_DataPlane_rdfifo_rid(rtl);

  FOR ALL : SG_DataPlane_rdfifo_last
    USE ENTITY work.SG_DataPlane_rdfifo_last(rtl);
...
BEGIN
  u_SG_DataPlane_rdfifo_data_inst : SG_DataPlane_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_SG_DataPlane_rdfifo_rid_inst : SG_DataPlane_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_SG_DataPlane_rdfifo_last_inst : SG_DataPlane_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
