// audiomini_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module audiomini_system_mm_interconnect_0 (
	...
	audiomini_system_mm_interconnect_0_router router (
	...
	audiomini_system_mm_interconnect_0_router router_001 (
	...
	audiomini_system_mm_interconnect_0_router_002 router_002 (
	...
	audiomini_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_hps_clk_clk),                                                //       clk.clk
		.reset              (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_hps_clk_clk),                                                //       clk.clk
		.reset              (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_hps_clk_clk),                                  //       clk.clk
		.reset               (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_hps_clk_clk),                                  //       clk.clk
		.reset              (onchip_memory_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_hps_clk_clk),                                                //       clk.clk
		.reset               (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_hps_clk_clk),                                                //       clk.clk
		.reset               (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audiomini_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
