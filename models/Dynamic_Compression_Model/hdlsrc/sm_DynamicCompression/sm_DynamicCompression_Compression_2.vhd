-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_2.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_2
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_2
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_2 IS
...
END sm_DynamicCompression_Compression_2;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_2 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Compression_Gain_Calc_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Compression_Envelope_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_Compression_Gain_Calc_block
    USE ENTITY work.sm_DynamicCompression_Compression_Gain_Calc_block(rtl);

  FOR ALL : sm_DynamicCompression_Compression_Envelope_block
    USE ENTITY work.sm_DynamicCompression_Compression_Envelope_block(rtl);
  ...
  SIGNAL Rate_Transition2_ds_out          : signed(31 DOWNTO 0);  -- sfix32_En28
...
BEGIN
  ...
  u_Compression_Gain_Calc : sm_DynamicCompression_Compression_Gain_Calc_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Compression_Envelope : sm_DynamicCompression_Compression_Envelope_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_1024_0 => enb_1_1024_0,
              Desired_Gain => std_logic_vector(Rate_Transition2_out1_1),  -- sfix32_En28
  ...
  Compare_To_Constant_out1 <= '1' WHEN Table_Sel_unsigned = to_unsigned(16#1#, 3) ELSE
      '0';
  ...
  BEGIN
    IF reset = '1' THEN
      Rate_Transition2_ds_out <= to_signed(0, 32);
    ELSIF rising_edge(clk) THEN
      IF enb_1_1024_5 = '1' THEN
        Rate_Transition2_ds_out <= Compression_Gain_Calc_out1_signed;
      END IF;
    END IF;
