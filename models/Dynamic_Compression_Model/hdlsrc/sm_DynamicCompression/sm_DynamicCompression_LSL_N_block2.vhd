-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_LSL_N_block2.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_LSL_N_block2
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_2/Compression_Gain_Calc/LogAddressing/LSL(N)
-- Hierarchy Level: 8
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_LSL_N_block2 IS
...
END sm_DynamicCompression_LSL_N_block2;


ARCHITECTURE rtl OF sm_DynamicCompression_LSL_N_block2 IS

  -- Signals
  SIGNAL NShifts_unsigned                 : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL x_in_unsigned                    : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate_out1                  : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate1_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate2_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate3_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate4_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate5_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate6_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate7_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate8_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate9_out1                 : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate10_out1                : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate11_out1                : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate12_out1                : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate13_out1                : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Bit_Rotate14_out1                : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Multiport_Switch_out1            : unsigned(31 DOWNTO 0);  -- ufix32_En28
