-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_LogAddressing_block3.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_LogAddressing_block3
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_5/Compression_Gain_Calc/LogAddressing
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_LogAddressing_block3 IS
...
END sm_DynamicCompression_LogAddressing_block3;


ARCHITECTURE rtl OF sm_DynamicCompression_LogAddressing_block3 IS
  ...
  COMPONENT sm_DynamicCompression_LSL_N_block8
  ...
  FOR ALL : sm_DynamicCompression_LSL_N_block8
    USE ENTITY work.sm_DynamicCompression_LSL_N_block8(rtl);
...
BEGIN
  ...
  u_LSL_N : sm_DynamicCompression_LSL_N_block8
