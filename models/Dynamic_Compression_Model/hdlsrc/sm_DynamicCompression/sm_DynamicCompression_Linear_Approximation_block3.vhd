-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Linear_Approximation_block3.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Linear_Approximation_block3
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_5/Compression_Gain_Calc/Linear_Approximation
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Linear_Approximation_block3 IS
...
END sm_DynamicCompression_Linear_Approximation_block3;


ARCHITECTURE rtl OF sm_DynamicCompression_Linear_Approximation_block3 IS

  -- Component Declarations
  COMPONENT sm_DynamicCompression_LSR_N_block3
  ...
  COMPONENT sm_DynamicCompression_LSL_N_block7
    PORT( NShifts                         :   IN    std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  FOR ALL : sm_DynamicCompression_LSR_N_block3
    USE ENTITY work.sm_DynamicCompression_LSR_N_block3(rtl);

  FOR ALL : sm_DynamicCompression_LSL_N_block7
    USE ENTITY work.sm_DynamicCompression_LSL_N_block7(rtl);
...
BEGIN
  ...
  u_LSR_N : sm_DynamicCompression_LSR_N_block3
  ...
  u_LSL_N : sm_DynamicCompression_LSL_N_block7
    PORT MAP( NShifts => std_logic_vector(NShifts),  -- ufix4
