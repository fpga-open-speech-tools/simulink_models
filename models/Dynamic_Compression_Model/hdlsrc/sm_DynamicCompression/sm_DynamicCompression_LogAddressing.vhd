-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_LogAddressing.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_LogAddressing
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_1/Compression_Gain_Calc/LogAddressing
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_LogAddressing IS
...
END sm_DynamicCompression_LogAddressing;


ARCHITECTURE rtl OF sm_DynamicCompression_LogAddressing IS
  ...
  COMPONENT sm_DynamicCompression_LSL_N_block
  ...
  FOR ALL : sm_DynamicCompression_LSL_N_block
    USE ENTITY work.sm_DynamicCompression_LSL_N_block(rtl);

  -- Signals
  SIGNAL x_in_signed                      : signed(31 DOWNTO 0);  -- sfix32_En28
  SIGNAL Data_Type_Conversion_out1        : unsigned(39 DOWNTO 0);  -- ufix40_En36
  SIGNAL lzc_count                        : std_logic_vector(5 DOWNTO 0);  -- ufix6
  SIGNAL lzc_count_unsigned               : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  u_MATLAB_Function : sm_DynamicCompression_MATLAB_Function
    PORT MAP( x => std_logic_vector(Data_Type_Conversion_out1),  -- ufix40_En36
              lzc_count => lzc_count  -- ufix6
              );

  u_LSL_N : sm_DynamicCompression_LSL_N_block
  ...
  lzc_count_unsigned <= unsigned(lzc_count);

  Constant1_out1 <= to_unsigned(16#03#, 6);

  Subtract_out1 <= lzc_count_unsigned - Constant1_out1;
