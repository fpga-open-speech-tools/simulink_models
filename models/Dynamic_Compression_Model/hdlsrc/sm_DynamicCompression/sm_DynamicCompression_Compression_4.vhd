-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_4.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_4
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_4
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_4 IS
...
END sm_DynamicCompression_Compression_4;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_4 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Compression_Gain_Calc_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Compression_Envelope_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_Compression_Gain_Calc_block2
    USE ENTITY work.sm_DynamicCompression_Compression_Gain_Calc_block2(rtl);

  FOR ALL : sm_DynamicCompression_Compression_Envelope_block2
    USE ENTITY work.sm_DynamicCompression_Compression_Envelope_block2(rtl);
...
BEGIN
  ...
  u_Compression_Gain_Calc : sm_DynamicCompression_Compression_Gain_Calc_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Compression_Envelope : sm_DynamicCompression_Compression_Envelope_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  Compare_To_Constant_out1 <= '1' WHEN Table_Sel_unsigned = to_unsigned(16#3#, 3) ELSE
      '0';
