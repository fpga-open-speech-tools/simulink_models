-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_Envelope_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_Envelope_block
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_2/Compression_Envelope
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_Envelope_block IS
...
END sm_DynamicCompression_Compression_Envelope_block;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_Envelope_block IS

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Release_Envelope_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Attack_Envelope_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
          Curr                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  FOR ALL : sm_DynamicCompression_Release_Envelope_block
    USE ENTITY work.sm_DynamicCompression_Release_Envelope_block(rtl);

  FOR ALL : sm_DynamicCompression_Attack_Envelope_block
    USE ENTITY work.sm_DynamicCompression_Attack_Envelope_block(rtl);
...
BEGIN
  ...
  u_Release_Envelope : sm_DynamicCompression_Release_Envelope_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Attack_Envelope : sm_DynamicCompression_Attack_Envelope_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_1024_0 => enb_1_1024_0,
              Curr => Curr_Gain,  -- sfix32_En28
