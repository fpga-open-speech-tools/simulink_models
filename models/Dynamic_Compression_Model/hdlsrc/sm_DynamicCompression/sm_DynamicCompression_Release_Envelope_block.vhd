-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Release_Envelope_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Release_Envelope_block
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_2/Compression_Envelope/Release_Envelope
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Release_Envelope_block IS
...
END sm_DynamicCompression_Release_Envelope_block;


ARCHITECTURE rtl OF sm_DynamicCompression_Release_Envelope_block IS
  ...
  SIGNAL r_rel_2_out1                     : signed(63 DOWNTO 0);  -- sfix64_En60
...
BEGIN
  ...
  r_rel_2_out1 <= signed'(X"0FFFDE777A533980");

  Product_mul_temp <= Subtract_out1 * r_rel_2_out1;
