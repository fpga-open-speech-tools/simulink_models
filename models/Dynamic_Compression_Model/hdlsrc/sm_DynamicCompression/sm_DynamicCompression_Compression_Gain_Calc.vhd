-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_Gain_Calc.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_Gain_Calc
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_1/Compression_Gain_Calc
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_Gain_Calc IS
...
END sm_DynamicCompression_Compression_Gain_Calc;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_Gain_Calc IS

  -- Component Declarations
  COMPONENT sm_DynamicCompression_LogAddressing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_High_Gain_Table
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Low_Gain_Table
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          wr_din                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  COMPONENT sm_DynamicCompression_Linear_Approximation
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_LogAddressing
    USE ENTITY work.sm_DynamicCompression_LogAddressing(rtl);

  FOR ALL : sm_DynamicCompression_High_Gain_Table
    USE ENTITY work.sm_DynamicCompression_High_Gain_Table(rtl);

  FOR ALL : sm_DynamicCompression_Low_Gain_Table
    USE ENTITY work.sm_DynamicCompression_Low_Gain_Table(rtl);

  FOR ALL : sm_DynamicCompression_Linear_Approximation
    USE ENTITY work.sm_DynamicCompression_Linear_Approximation(rtl);
...
BEGIN
  ...
  u_LogAddressing : sm_DynamicCompression_LogAddressing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_High_Gain_Table : sm_DynamicCompression_High_Gain_Table
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Low_Gain_Table : sm_DynamicCompression_Low_Gain_Table
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              wr_din => Table_Fill,  -- sfix32_En28
  ...
  u_Linear_Approximation : sm_DynamicCompression_Linear_Approximation
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
