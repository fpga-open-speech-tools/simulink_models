-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_Envelope_block3.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_Envelope_block3
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_5/Compression_Envelope
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_Envelope_block3 IS
...
END sm_DynamicCompression_Compression_Envelope_block3;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_Envelope_block3 IS

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Release_Envelope_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Attack_Envelope_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
          Curr                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  FOR ALL : sm_DynamicCompression_Release_Envelope_block3
    USE ENTITY work.sm_DynamicCompression_Release_Envelope_block3(rtl);

  FOR ALL : sm_DynamicCompression_Attack_Envelope_block3
    USE ENTITY work.sm_DynamicCompression_Attack_Envelope_block3(rtl);
...
BEGIN
  ...
  u_Release_Envelope : sm_DynamicCompression_Release_Envelope_block3
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Attack_Envelope : sm_DynamicCompression_Attack_Envelope_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_1024_0 => enb_1_1024_0,
              Curr => Curr_Gain,  -- sfix32_En28
