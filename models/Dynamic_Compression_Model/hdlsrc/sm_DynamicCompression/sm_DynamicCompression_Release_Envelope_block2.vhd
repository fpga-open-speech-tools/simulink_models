-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Release_Envelope_block2.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Release_Envelope_block2
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_4/Compression_Envelope/Release_Envelope
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Release_Envelope_block2 IS
...
END sm_DynamicCompression_Release_Envelope_block2;


ARCHITECTURE rtl OF sm_DynamicCompression_Release_Envelope_block2 IS
  ...
  SIGNAL r_rel_4_out1                     : signed(63 DOWNTO 0);  -- sfix64_En60
...
BEGIN
  ...
  r_rel_4_out1 <= signed'(X"0FFFCDB351D7C300");

  Product_mul_temp <= Subtract_out1 * r_rel_4_out1;
