-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Attack_Envelope_block1.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Attack_Envelope_block1
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_3/Compression_Envelope/Attack_Envelope
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Attack_Envelope_block1 IS
...
END sm_DynamicCompression_Attack_Envelope_block1;


ARCHITECTURE rtl OF sm_DynamicCompression_Attack_Envelope_block1 IS

  -- Signals
  SIGNAL Enable_out3                      : std_logic;
  SIGNAL r_att_3_out1                     : signed(63 DOWNTO 0);  -- sfix64_En60
...
BEGIN
  ...
  r_att_3_out1 <= signed'(X"0FFE091CFD438A80");
  ...
  Product_mul_temp <= r_att_3_out1 * Subtract_out1;
