-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Static_pFIR.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Static_pFIR
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Static_pFIR
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Static_pFIR IS
...
END sm_DynamicCompression_Static_pFIR;


ARCHITECTURE rtl OF sm_DynamicCompression_Static_pFIR IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Addr_Gen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_B_k_Memory_Block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Multiply_And_Sum
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_Addr_Gen
    USE ENTITY work.sm_DynamicCompression_Addr_Gen(rtl);
  ...
  FOR ALL : sm_DynamicCompression_B_k_Memory_Block
    USE ENTITY work.sm_DynamicCompression_B_k_Memory_Block(rtl);

  FOR ALL : sm_DynamicCompression_Multiply_And_Sum
    USE ENTITY work.sm_DynamicCompression_Multiply_And_Sum(rtl);
...
BEGIN
  ...
  u_Addr_Gen : sm_DynamicCompression_Addr_Gen
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_B_k_Memory_Block : sm_DynamicCompression_B_k_Memory_Block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Multiply_And_Sum : sm_DynamicCompression_Multiply_And_Sum
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  Valid_out <= Multiply_And_Sum_out2;
