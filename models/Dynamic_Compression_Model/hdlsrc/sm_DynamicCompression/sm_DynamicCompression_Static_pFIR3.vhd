-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Static_pFIR3.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Static_pFIR3
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Static_pFIR3
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Static_pFIR3 IS
...
END sm_DynamicCompression_Static_pFIR3;


ARCHITECTURE rtl OF sm_DynamicCompression_Static_pFIR3 IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT sm_DynamicCompression_Addr_Gen_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_B_k_Memory_Block_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Multiply_And_Sum_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_Addr_Gen_block2
    USE ENTITY work.sm_DynamicCompression_Addr_Gen_block2(rtl);
  ...
  FOR ALL : sm_DynamicCompression_B_k_Memory_Block_block2
    USE ENTITY work.sm_DynamicCompression_B_k_Memory_Block_block2(rtl);

  FOR ALL : sm_DynamicCompression_Multiply_And_Sum_block2
    USE ENTITY work.sm_DynamicCompression_Multiply_And_Sum_block2(rtl);
...
BEGIN
  ...
  u_Addr_Gen : sm_DynamicCompression_Addr_Gen_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_B_k_Memory_Block : sm_DynamicCompression_B_k_Memory_Block_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Multiply_And_Sum : sm_DynamicCompression_Multiply_And_Sum_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
