-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Compression_Gain_Calc_block1.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Compression_Gain_Calc_block1
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_3/Compression_Gain_Calc
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Compression_Gain_Calc_block1 IS
...
END sm_DynamicCompression_Compression_Gain_Calc_block1;


ARCHITECTURE rtl OF sm_DynamicCompression_Compression_Gain_Calc_block1 IS

  -- Component Declarations
  COMPONENT sm_DynamicCompression_LogAddressing_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_High_Gain_Table_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT sm_DynamicCompression_Low_Gain_Table_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          wr_din                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  COMPONENT sm_DynamicCompression_Linear_Approximation_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : sm_DynamicCompression_LogAddressing_block1
    USE ENTITY work.sm_DynamicCompression_LogAddressing_block1(rtl);

  FOR ALL : sm_DynamicCompression_High_Gain_Table_block1
    USE ENTITY work.sm_DynamicCompression_High_Gain_Table_block1(rtl);

  FOR ALL : sm_DynamicCompression_Low_Gain_Table_block1
    USE ENTITY work.sm_DynamicCompression_Low_Gain_Table_block1(rtl);

  FOR ALL : sm_DynamicCompression_Linear_Approximation_block1
    USE ENTITY work.sm_DynamicCompression_Linear_Approximation_block1(rtl);
...
BEGIN
  ...
  u_LogAddressing : sm_DynamicCompression_LogAddressing_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_High_Gain_Table : sm_DynamicCompression_High_Gain_Table_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Low_Gain_Table : sm_DynamicCompression_Low_Gain_Table_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              wr_din => Table_Fill,  -- sfix32_En28
  ...
  u_Linear_Approximation : sm_DynamicCompression_Linear_Approximation_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
