-- -------------------------------------------------------------
-- 
-- File Name: /home/cb54103/Documents/fpga-open-speech-tools/simulink_models/models/Dynamic_Compression_Model/hdlsrc/sm_DynamicCompression/sm_DynamicCompression_Release_Envelope.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: sm_DynamicCompression_Release_Envelope
-- Source Path: sm_DynamicCompression/dataplane/Avalon Data Processing/Left Channel Processing/recalculate/Nchan_FbankAGC_AID/Compression_1/Compression_Envelope/Release_Envelope
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY sm_DynamicCompression_Release_Envelope IS
...
END sm_DynamicCompression_Release_Envelope;


ARCHITECTURE rtl OF sm_DynamicCompression_Release_Envelope IS
  ...
  SIGNAL r_rel_1_out1                     : signed(63 DOWNTO 0);  -- sfix64_En60
...
BEGIN
  ...
  r_rel_1_out1 <= signed'(X"0FFFE6D99527AC80");

  Product_mul_temp <= Subtract_out1 * r_rel_1_out1;
