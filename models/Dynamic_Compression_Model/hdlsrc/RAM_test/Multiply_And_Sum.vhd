...
ARCHITECTURE rtl OF Multiply_And_Sum IS
  ...
  SIGNAL Sum_add_cast                     : signed(31 DOWNTO 0);  -- sfix32_En28
...
BEGIN
  ...
  Product_out1 <= x_n_i_signed * b_i_signed;

  Sum_add_cast <= Product_out1(59 DOWNTO 28);
  Sum_out1 <= Sum_memory_out1 + Sum_add_cast;
