-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc/RAM_test/Static_pFIR.vhd
...
ARCHITECTURE rtl OF Static_pFIR IS
  ...
  COMPONENT Input_Data_Circular_Buffer
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          enb_1_1024_0                    :   IN    std_logic;
  ...
  FOR ALL : Input_Data_Circular_Buffer
    USE ENTITY work.Input_Data_Circular_Buffer(rtl);
  ...
  SIGNAL Never_write_B_out1               : signed(31 DOWNTO 0);  -- sfix32_En28
...
BEGIN
  ...
  u_Input_Data_Circular_Buffer : Input_Data_Circular_Buffer
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              enb_1_1024_0 => enb_1_1024_0,
              din_A => Left_Data_In,  -- sfix32_En28
              addr_A => Addr_Gen_out1,  -- ufix10
              we_A => Valid_in,
              din_B => std_logic_vector(Never_write_B_out1),  -- sfix32_En28
              addr_B => Addr_Gen_out2,  -- ufix10
              we_B => Always_read_B_out1,
              dout_B => x_n_i  -- sfix32_En28
              );
  ...
  Never_write_B_out1 <= to_signed(0, 32);
