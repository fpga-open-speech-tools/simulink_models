-- -------------------------------------------------------------
-- 
-- File Name: /home/justin/Documents/Flat Earth Inc/simulink_models/simulink_models/models/wiener_noise_reduction/hdlsrc/wiener/wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering
-- Source Path: wiener/dataplane/Adaptive_Wiener_Filter Sample Based Filtering
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering IS
...
END wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering;


ARCHITECTURE rtl OF wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT wiener_Left_Channel_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT wiener_Right_Channel_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : wiener_Left_Channel_Processing
    USE ENTITY work.wiener_Left_Channel_Processing(rtl);

  FOR ALL : wiener_Right_Channel_Processing
    USE ENTITY work.wiener_Right_Channel_Processing(rtl);
...
BEGIN
  ...
  u_Left_Channel_Processing : wiener_Left_Channel_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Right_Channel_Processing : wiener_Right_Channel_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Right_Data_Sink => Sink_Data,  -- sfix32_En28
              Enable => rightEnable_1,
              Left_Data_Out => Right_Channel_Processing_out1  -- sfix32_En28
              );
