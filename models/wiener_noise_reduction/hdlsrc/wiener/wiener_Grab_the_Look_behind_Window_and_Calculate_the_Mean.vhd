-- -------------------------------------------------------------
-- 
-- File Name: /home/justin/Documents/Flat Earth Inc/simulink_models/simulink_models/models/wiener_noise_reduction/hdlsrc/wiener/wiener_Grab_the_Look_behind_Window_and_Calculate_the_Mean.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: wiener_Grab_the_Look_behind_Window_and_Calculate_the_Mean
-- Source Path: wiener/dataplane/Adaptive_Wiener_Filter Sample Based Filtering/Left Channel Processing/Grab the Look-behind 
...
ENTITY wiener_Grab_the_Look_behind_Window_and_Calculate_the_Mean IS
...
END wiener_Grab_the_Look_behind_Window_and_Calculate_the_Mean;


ARCHITECTURE rtl OF wiener_Grab_the_Look_behind_Window_and_Calculate_the_Mean IS
...
BEGIN
  ...
  startup_2 <= startup_last_value WHEN Enable_out3 = '0' ELSE
      startup_1;
