-- -------------------------------------------------------------
-- 
-- File Name: /home/justin/Documents/Flat Earth Inc/simulink_models/simulink_models/models/wiener_noise_reduction/hdlsrc/wiener/wiener_dataplane.vhd
-- 
...
-- -------------------------------------------------------------
-- avalon_source_valid           ce_out        2.60417e-06
-- avalon_source_data            ce_out        2.60417e-06
-- avalon_source_channel         ce_out        2.60417e-06
-- avalon_source_error           ce_out        2.60417e-06
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- 
-- Module: wiener_dataplane
-- Source Path: wiener/dataplane
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY wiener_dataplane IS
  PORT( clk                               :   IN    std_logic;
        ...
        noise_std                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
...
END wiener_dataplane;


ARCHITECTURE rtl OF wiener_dataplane IS

  -- Component Declarations
  COMPONENT wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering
    USE ENTITY work.wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering(rtl);
...
BEGIN
  ...
  u_Adaptive_Wiener_Filter_Sample_Based_Filtering : wiener_Adaptive_Wiener_Filter_Sample_Based_Filtering
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
