...
if {! [file exists $base_dir/dummy_beamformer_ch_sum_AStOutput]} {
    file delete -force $base_dir/dummy_beamformer_ch_sum_AStOutput
}

project new $base_dir dummy_beamformer_ch_sum_AStOutput
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/dummy_beamformer/dummy_beamformer_ch_sum_AStOutput_fpc.do"
} else {
...
vcom -quiet $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_AStOutput.vhd
vcom -quiet -O0 $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_AStOutput_atb.vhd
vcom -quiet $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_AStOutput_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps dummy_beamformer_ch_sum_AStOutput_atb 
    do $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_AStOutput_atb.wav.do
