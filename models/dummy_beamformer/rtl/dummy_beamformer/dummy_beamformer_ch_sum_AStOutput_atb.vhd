...
entity dummy_beamformer_ch_sum_AStOutput_atb is
end;

architecture normal of dummy_beamformer_ch_sum_AStOutput_atb is
...
component dummy_beamformer_ch_sum_AStOutput_stm is
    port (
...
dut : dummy_beamformer_ch_sum_AStOutput port map (
...
sim : dummy_beamformer_ch_sum_AStOutput_stm port map (
    in_1_avalonIfaceRole_valid_output_valid_stm,
    in_2_avalonIfaceRole_channel_output_channel_stm,
    in_3_avalonIfaceRole_data_output_data_stm,
