# This is the top level tcl file for 'dummy_beamformer_ch_sum'
...
if {!$overwrite_opt && [project_exists dummy_beamformer_ch_sum]} {
    puts "The dummy_beamformer_ch_sum quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "D:/trevor/research/NIH_SBIR_R44_DC015443/Audio_Beamforming/hw/library/dummy_beamformer/./rtl/dummy_beamformer/dummy_beamformer_ch_sum.tcl"]}    {
    puts "You must run dummy_beamformer_ch_sum.tcl "
...
puts "Creating dummy_beamformer_ch_sum Quartus project..."

if $overwrite_opt {
    project_new -overwrite dummy_beamformer_ch_sum
} else {
    project_new dummy_beamformer_ch_sum
}

set_global_assignment -name FAMILY "Arria 10"
set_global_assignment -name TOP_LEVEL_ENTITY dummy_beamformer_ch_sum
set_global_assignment -name DEVICE 10AX066K2F35I1LG
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE D:/trevor/research/NIH_SBIR_R44_DC015443/Audio_Beamforming/hw/library/dummy_beamformer/./rtl/dummy_beamformer/dummy_beamformer_ch_sum.sdc
source D:/trevor/research/NIH_SBIR_R44_DC015443/Audio_Beamforming/hw/library/dummy_beamformer/./rtl/dummy_beamformer/dummy_beamformer_ch_sum.add.tcl
...
source "D:/trevor/research/NIH_SBIR_R44_DC015443/Audio_Beamforming/hw/library/dummy_beamformer/./rtl/dummy_beamformer/dummy_beamformer_ch_sum_fpc.add.tcl"
