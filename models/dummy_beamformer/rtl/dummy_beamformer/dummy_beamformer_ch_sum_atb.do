...
if {! [file exists $base_dir/dummy_beamformer_ch_sum]} {
    file delete -force $base_dir/dummy_beamformer_ch_sum
}

project new $base_dir dummy_beamformer_ch_sum
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/dummy_beamformer/dummy_beamformer_ch_sum_fpc.do"
} else {
...
vcom -quiet $base_dir/dummy_beamformer/dummy_beamformer_ch_sum.vhd
...
vcom -quiet $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_ch_sum.vhd
vcom -quiet -O0 $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_atb.vhd
vcom -quiet $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473  -voptargs="+acc" -t ps dummy_beamformer_ch_sum_atb 
    do $base_dir/dummy_beamformer/dummy_beamformer_ch_sum_atb.wav.do
