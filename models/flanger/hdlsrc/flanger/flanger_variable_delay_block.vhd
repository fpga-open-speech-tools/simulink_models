-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\research\NIH\simulink_models\models\flanger\hdlsrc\flanger\flanger_variable_delay_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: flanger_variable_delay_block
-- Source Path: flanger/dataplane/Avalon Data Processing/Right Channel Processing/variable delay
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY flanger_variable_delay_block IS
...
END flanger_variable_delay_block;


ARCHITECTURE rtl OF flanger_variable_delay_block IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT flanger_read_address_generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          delay                           :   IN    std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  FOR ALL : flanger_read_address_generator_block
    USE ENTITY work.flanger_read_address_generator_block(rtl);
...
BEGIN
  u_read_address_generator : flanger_read_address_generator_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              delay => delay,  -- ufix9
