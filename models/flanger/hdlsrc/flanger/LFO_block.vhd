-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\NIH\simulink_models\models\flanger\hdlsrc\flanger\LFO_block.vhd
...
-- 
-- Module: LFO_block
-- Source Path: flanger/flanger_dataplane/Avalon Data Processing/Right Channel Processing/LFO
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LFO_block IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT NCO_HDL_Optimized_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : NCO_HDL_Optimized_block
    USE ENTITY work.NCO_HDL_Optimized_block(rtl);
...
BEGIN
  ...
  u_NCO_HDL_Optimized : NCO_HDL_Optimized_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
