-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\NIH\simulink_models\models\flanger\hdlsrc\flanger\flanger_dataplane.vhd
...
-- Source Path: flanger/flanger_dataplane
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  u_Avalon_Data_Processing : Avalon_Data_Processing
    PORT MAP( clk => clk,
              ...
              bypass => register_control_bypass,
