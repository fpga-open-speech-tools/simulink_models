-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\research\NIH\simulink_models\models\flanger\hdlsrc\flanger\flanger_Right_Channel_Processing.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: flanger_Right_Channel_Processing
-- Source Path: flanger/dataplane/Avalon Data Processing/Right Channel Processing
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY flanger_Right_Channel_Processing IS
...
END flanger_Right_Channel_Processing;


ARCHITECTURE rtl OF flanger_Right_Channel_Processing IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT flanger_LFO_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          rate                            :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8_En5
  ...
  COMPONENT flanger_variable_delay_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : flanger_LFO_block
    USE ENTITY work.flanger_LFO_block(rtl);

  FOR ALL : flanger_variable_delay_block
    USE ENTITY work.flanger_variable_delay_block(rtl);
...
BEGIN
  ...
  u_variable_delay : flanger_variable_delay_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        delayMatch4_reg(0) <= enable;
        delayMatch4_reg(1) <= delayMatch4_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch4_process;

  enable_2 <= delayMatch4_reg(1);
  ...
  Switch_out1 <= original_signal WHEN enable_2 = '0' ELSE
      Add_out1;
