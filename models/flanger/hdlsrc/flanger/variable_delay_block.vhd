-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\NIH\simulink_models\models\flanger\hdlsrc\flanger\variable_delay_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: variable_delay_block
-- Source Path: flanger/flanger_dataplane/Avalon Data Processing/Right Channel Processing/variable delay
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY variable_delay_block IS
...
END variable_delay_block;


ARCHITECTURE rtl OF variable_delay_block IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT read_address_generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          delay                           :   IN    std_logic_vector(8 DOWNTO 0);  -- ufix9
  ...
  FOR ALL : read_address_generator_block
    USE ENTITY work.read_address_generator_block(rtl);
...
BEGIN
  u_read_address_generator : read_address_generator_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              delay => delay,  -- ufix9
