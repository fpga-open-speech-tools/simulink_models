-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\NIH\simulink_models\models\flanger\hdlsrc\flanger\Left_Channel_Processing.vhd
...
-- Source Path: flanger/flanger_dataplane/Avalon Data Processing/Left Channel Processing
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Left_Channel_Processing IS
  ...
  FOR ALL : LFO
    USE ENTITY work.LFO(rtl);

  FOR ALL : variable_delay
    USE ENTITY work.variable_delay(rtl);
...
BEGIN
  ...
  u_variable_delay : variable_delay
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
