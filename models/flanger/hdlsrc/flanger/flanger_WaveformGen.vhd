-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\bugsbunny\research\NIH\simulink_models\models\flanger\hdlsrc\flanger\flanger_WaveformGen.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: flanger_WaveformGen
-- Source Path: flanger/dataplane/Avalon Data Processing/Left Channel Processing/LFO/NCO HDL Optimized/WaveformGen
-- Hierarchy Level: 5
-- 
...
END flanger_WaveformGen;


ARCHITECTURE rtl OF flanger_WaveformGen IS

  -- Component Declarations
  COMPONENT flanger_LookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : flanger_LookUpTableGen
    USE ENTITY work.flanger_LookUpTableGen(rtl);
...
BEGIN
  u_SineWave_inst : flanger_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
