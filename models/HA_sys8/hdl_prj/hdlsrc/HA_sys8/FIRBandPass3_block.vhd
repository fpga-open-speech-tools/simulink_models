-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRBandPass3_block
-- Created: 2018-12-04 11:17:47
...
-- ------------------------------------------------------------
-- 
-- Module: FIRBandPass3_block
-- Source Path: /FIRBandPass3_block
-- 
-- ------------------------------------------------------------
-- 
...
END FIRBandPass3_block;


----------------------------------------------------------------
--Module Architecture: FIRBandPass3_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRBandPass3_block IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRBandPass3_block_in_regtype    : signed(31 DOWNTO 0); -- sfix32_En28
...
BEGIN
  ...
  phase_0 <= '1' WHEN cur_count = to_unsigned(0, 3) AND enb_1_1_1 = '1' ELSE '0';
  ...
  phase_1 <= '1' WHEN  (((cur_count = to_unsigned(0, 3))  OR
                         ...
                         (cur_count = to_unsigned(4, 3)))  AND enb_1_1_1 = '1') ELSE '0';
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_0 = '1' THEN
        delay_pipeline(0) <= signed(FIRBandPass3_block_in);
        delay_pipeline(1 TO 32) <= delay_pipeline(0 TO 31);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRBandPass3_block_in_regtype <= signed(FIRBandPass3_block_in);

  inputmux_1 <= FIRBandPass3_block_in_regtype WHEN ( cur_count = to_unsigned(0, 3) ) ELSE
  ...
  FIRBandPass3_block_out <= std_logic_vector(output_typeconvert);
END rtl;
