-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRBandPass3
-- Created: 2018-12-04 11:17:33
...
----------------------------------------------------------------
--Module Architecture: FIRBandPass3
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRBandPass3 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRBandPass3_in_regtype          : signed(31 DOWNTO 0); -- sfix32_En28
...
BEGIN
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_0 = '1' THEN
        delay_pipeline(0) <= signed(FIRBandPass3_in);
        delay_pipeline(1 TO 32) <= delay_pipeline(0 TO 31);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRBandPass3_in_regtype <= signed(FIRBandPass3_in);

  inputmux_1 <= FIRBandPass3_in_regtype WHEN ( cur_count = to_unsigned(0, 3) ) ELSE
  ...
  FIRBandPass3_out <= std_logic_vector(output_typeconvert);
END rtl;
