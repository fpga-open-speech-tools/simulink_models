-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRDecimator4_block
-- Created: 2018-12-04 11:17:50
...
-- ------------------------------------------------------------
-- 
-- Module: FIRDecimator4_block
-- Source Path: /FIRDecimator4_block
-- 
-- ------------------------------------------------------------
-- 
...
END FIRDecimator4_block;


----------------------------------------------------------------
--Module Architecture: FIRDecimator4_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRDecimator4_block IS
  -- Local Functions
  -- Type Definitions
...
BEGIN
  ...
  phase_7 <= '1' WHEN cur_count = to_unsigned(7, 4) AND enb_8_16_1 = '1' ELSE '0';

  phase_8 <= '1' WHEN cur_count = to_unsigned(8, 4) AND enb_8_16_1 = '1' ELSE '0';
  ...
  phase_9 <= '1' WHEN cur_count = to_unsigned(9, 4) AND enb_8_16_1 = '1' ELSE '0';

  input_typeconvert <= signed(FIRDecimator4_block_in);
  ...
  FIRDecimator4_block_out <= std_logic_vector(output_typeconvert);
END rtl;
