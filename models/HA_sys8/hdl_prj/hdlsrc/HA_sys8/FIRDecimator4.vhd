-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRDecimator4
-- Created: 2018-12-04 11:17:36
...
-- ------------------------------------------------------------
-- 
-- Module: FIRDecimator4
-- Source Path: /FIRDecimator4
-- 
-- ------------------------------------------------------------
-- 
...
----------------------------------------------------------------
--Module Architecture: FIRDecimator4
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRDecimator4 IS
  -- Local Functions
  -- Type Definitions
...
BEGIN
  ...
  input_typeconvert <= signed(FIRDecimator4_in);
  ...
  FIRDecimator4_out <= std_logic_vector(output_typeconvert);
END rtl;
