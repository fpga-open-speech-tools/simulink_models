-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRInterpolator2_block
-- Created: 2018-12-04 11:17:54
...
-- ------------------------------------------------------------
-- 
-- Module: FIRInterpolator2_block
-- Source Path: /FIRInterpolator2_block
-- 
-- ------------------------------------------------------------
-- 
...
ENTITY FIRInterpolator2_block IS
...
END FIRInterpolator2_block;


----------------------------------------------------------------
--Module Architecture: FIRInterpolator2_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRInterpolator2_block IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRInterpolator2_block_in_regtype : signed(32 DOWNTO 0); -- sfix33_En28
...
BEGIN
  ...
  phase_8 <= '1' WHEN  (((cur_count = to_unsigned(8, 4))  OR
                         (cur_count = to_unsigned(0, 4)))  AND enb_8_4_1 = '1') ELSE '0';
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_15 = '1' THEN
        delay_pipeline(0) <= signed(FIRInterpolator2_block_in);
        delay_pipeline(1 TO 15) <= delay_pipeline(0 TO 14);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRInterpolator2_block_in_regtype <= signed(FIRInterpolator2_block_in);
  ...
  muxout <= output_typeconvert WHEN ( enb_8_4_1 = '1' ) ELSE
            regout;
  -- Assignment Statements
  FIRInterpolator2_block_out <= std_logic_vector(muxout);
END rtl;
