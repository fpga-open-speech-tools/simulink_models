-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRInterpolator3_block
-- Created: 2018-12-04 11:17:53
...
-- ------------------------------------------------------------
-- 
-- Module: FIRInterpolator3_block
-- Source Path: /FIRInterpolator3_block
-- 
-- ------------------------------------------------------------
-- 
...
ENTITY FIRInterpolator3_block IS
...
END FIRInterpolator3_block;


----------------------------------------------------------------
--Module Architecture: FIRInterpolator3_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRInterpolator3_block IS
  -- Local Functions
  -- Type Definitions
  ...
  CONSTANT coeffphase2_1                  : signed(32 DOWNTO 0) := to_signed(-962006, 33); -- sfix33_En31
  CONSTANT coeffphase2_2                  : signed(32 DOWNTO 0) := to_signed(5276969, 33); -- sfix33_En31
  CONSTANT coeffphase2_3                  : signed(32 DOWNTO 0) := to_signed(-17092938, 33); -- sfix33_En31
  CONSTANT coeffphase2_4                  : signed(32 DOWNTO 0) := to_signed(43016896, 33); -- sfix33_En31
  CONSTANT coeffphase2_5                  : signed(32 DOWNTO 0) := to_signed(-93504983, 33); -- sfix33_En31
  CONSTANT coeffphase2_6                  : signed(32 DOWNTO 0) := to_signed(189473302, 33); -- sfix33_En31
  CONSTANT coeffphase2_7                  : signed(32 DOWNTO 0) := to_signed(-400137009, 33); -- sfix33_En31
  CONSTANT coeffphase2_8                  : signed(32 DOWNTO 0) := to_signed(1347659956, 33); -- sfix33_En31
  CONSTANT coeffphase2_9                  : signed(32 DOWNTO 0) := to_signed(1347659956, 33); -- sfix33_En31
  CONSTANT coeffphase2_10                 : signed(32 DOWNTO 0) := to_signed(-400137009, 33); -- sfix33_En31
  CONSTANT coeffphase2_11                 : signed(32 DOWNTO 0) := to_signed(189473302, 33); -- sfix33_En31
  CONSTANT coeffphase2_12                 : signed(32 DOWNTO 0) := to_signed(-93504983, 33); -- sfix33_En31
  CONSTANT coeffphase2_13                 : signed(32 DOWNTO 0) := to_signed(43016896, 33); -- sfix33_En31
  CONSTANT coeffphase2_14                 : signed(32 DOWNTO 0) := to_signed(-17092938, 33); -- sfix33_En31
  CONSTANT coeffphase2_15                 : signed(32 DOWNTO 0) := to_signed(5276969, 33); -- sfix33_En31
  CONSTANT coeffphase2_16                 : signed(32 DOWNTO 0) := to_signed(-962006, 33); -- sfix33_En31

  CONSTANT const_zero                     : signed(66 DOWNTO 0) := to_signed(0, 67); -- sfix67_En59
  CONSTANT const_zero_1                   : signed(65 DOWNTO 0) := to_signed(0, 66); -- sfix66_En59
  -- Signals
  ...
  SIGNAL FIRInterpolator3_block_in_regtype : signed(32 DOWNTO 0); -- sfix33_En28
  SIGNAL tapsum_and                       : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_1                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_2                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_3                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_4                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_5                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_6                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL tapsum_and_7                     : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL inputmux                         : signed(33 DOWNTO 0); -- sfix34_En28
  SIGNAL product1                         : signed(66 DOWNTO 0); -- sfix67_En59
  SIGNAL product1_mux                     : signed(32 DOWNTO 0); -- sfix33_En31
  SIGNAL phasemux                         : signed(66 DOWNTO 0); -- sfix67_En59
...
BEGIN
  ...
  phase_0 <= '1' WHEN cur_count = to_unsigned(0, 4) AND enb_1_1_1 = '1' ELSE '0';
  ...
  phase_1 <= '1' WHEN  (((cur_count = to_unsigned(8, 4))  OR
                         ...
                         (cur_count = to_unsigned(15, 4)))  AND enb_1_1_1 = '1') ELSE '0';

  phase_8 <= '1' WHEN  (((cur_count = to_unsigned(8, 4))  OR
                         (cur_count = to_unsigned(0, 4)))  AND enb_1_1_1 = '1') ELSE '0';
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_15 = '1' THEN
        delay_pipeline(0) <= signed(FIRInterpolator3_block_in);
        delay_pipeline(1 TO 15) <= delay_pipeline(0 TO 14);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRInterpolator3_block_in_regtype <= signed(FIRInterpolator3_block_in);

  -- Adding (or subtracting) the taps based on the symmetry (or asymmetry)

  tapsum_and <= resize(delay_pipeline(0), 34) + resize(delay_pipeline(15), 34);

  tapsum_and_1 <= resize(delay_pipeline(1), 34) + resize(delay_pipeline(14), 34);

  tapsum_and_2 <= resize(delay_pipeline(2), 34) + resize(delay_pipeline(13), 34);

  tapsum_and_3 <= resize(delay_pipeline(3), 34) + resize(delay_pipeline(12), 34);

  tapsum_and_4 <= resize(delay_pipeline(4), 34) + resize(delay_pipeline(11), 34);

  tapsum_and_5 <= resize(delay_pipeline(5), 34) + resize(delay_pipeline(10), 34);

  tapsum_and_6 <= resize(delay_pipeline(6), 34) + resize(delay_pipeline(9), 34);

  tapsum_and_7 <= resize(delay_pipeline(7), 34) + resize(delay_pipeline(8), 34);
  ...
  FIRInterpolator3_block_out <= std_logic_vector(muxout);
END rtl;
