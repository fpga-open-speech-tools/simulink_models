-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRBandPass1_block
-- Created: 2018-12-04 11:17:51
...
-- ------------------------------------------------------------
-- 
-- Module: FIRBandPass1_block
-- Source Path: /FIRBandPass1_block
-- 
-- ------------------------------------------------------------
-- 
...
END FIRBandPass1_block;


----------------------------------------------------------------
--Module Architecture: FIRBandPass1_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRBandPass1_block IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRBandPass1_block_in_regtype    : signed(31 DOWNTO 0); -- sfix32_En28
...
BEGIN
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_0 = '1' THEN
        delay_pipeline(0) <= signed(FIRBandPass1_block_in);
        delay_pipeline(1 TO 16) <= delay_pipeline(0 TO 15);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRBandPass1_block_in_regtype <= signed(FIRBandPass1_block_in);

  inputmux_1 <= FIRBandPass1_block_in_regtype WHEN ( cur_count = to_unsigned(0, 2) ) ELSE
  ...
  FIRBandPass1_block_out <= std_logic_vector(output_typeconvert);
END rtl;
