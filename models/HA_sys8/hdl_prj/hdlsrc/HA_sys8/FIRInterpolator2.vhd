-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRInterpolator2
-- Created: 2018-12-04 11:17:40
...
-- ------------------------------------------------------------
-- 
-- Module: FIRInterpolator2
-- Source Path: /FIRInterpolator2
-- 
-- ------------------------------------------------------------
-- 
...
END FIRInterpolator2;


----------------------------------------------------------------
--Module Architecture: FIRInterpolator2
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRInterpolator2 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRInterpolator2_in_regtype      : signed(32 DOWNTO 0); -- sfix33_En28
...
BEGIN
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_15 = '1' THEN
        delay_pipeline(0) <= signed(FIRInterpolator2_in);
        delay_pipeline(1 TO 15) <= delay_pipeline(0 TO 14);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRInterpolator2_in_regtype <= signed(FIRInterpolator2_in);
  ...
  FIRInterpolator2_out <= std_logic_vector(muxout);
END rtl;
