-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRDecimator3_block
-- Created: 2018-12-04 11:17:48
...
-- ------------------------------------------------------------
-- 
-- Module: FIRDecimator3_block
-- Source Path: /FIRDecimator3_block
-- 
-- ------------------------------------------------------------
-- 
...
END FIRDecimator3_block;


----------------------------------------------------------------
--Module Architecture: FIRDecimator3_block
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRDecimator3_block IS
  -- Local Functions
  -- Type Definitions
...
BEGIN
  ...
  phase_7 <= '1' WHEN cur_count = to_unsigned(7, 4) AND enb_1_1_1 = '1' ELSE '0';

  phase_8 <= '1' WHEN cur_count = to_unsigned(8, 4) AND enb_1_1_1 = '1' ELSE '0';
  ...
  phase_9 <= '1' WHEN cur_count = to_unsigned(9, 4) AND enb_1_1_1 = '1' ELSE '0';

  input_typeconvert <= signed(FIRDecimator3_block_in);
  ...
  FIRDecimator3_block_out <= std_logic_vector(output_typeconvert);
END rtl;
