-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRInterpolator3
-- Created: 2018-12-04 11:17:39
...
-- ------------------------------------------------------------
-- 
-- Module: FIRInterpolator3
-- Source Path: /FIRInterpolator3
-- 
-- ------------------------------------------------------------
-- 
...
END FIRInterpolator3;


----------------------------------------------------------------
--Module Architecture: FIRInterpolator3
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRInterpolator3 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRInterpolator3_in_regtype      : signed(32 DOWNTO 0); -- sfix33_En28
...
BEGIN
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_15 = '1' THEN
        delay_pipeline(0) <= signed(FIRInterpolator3_in);
        delay_pipeline(1 TO 15) <= delay_pipeline(0 TO 14);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRInterpolator3_in_regtype <= signed(FIRInterpolator3_in);
  ...
  FIRInterpolator3_out <= std_logic_vector(muxout);
END rtl;
