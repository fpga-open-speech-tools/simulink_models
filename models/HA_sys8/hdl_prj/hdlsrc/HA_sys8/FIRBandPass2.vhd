-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\HA_sys8\FIRBandPass2
-- Created: 2018-12-04 11:17:35
...
----------------------------------------------------------------
--Module Architecture: FIRBandPass2
----------------------------------------------------------------
ARCHITECTURE rtl OF FIRBandPass2 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIRBandPass2_in_regtype          : signed(31 DOWNTO 0); -- sfix32_En28
...
BEGIN
  ...
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      ELSIF phase_0 = '1' THEN
        delay_pipeline(0) <= signed(FIRBandPass2_in);
        delay_pipeline(1 TO 32) <= delay_pipeline(0 TO 31);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIRBandPass2_in_regtype <= signed(FIRBandPass2_in);

  inputmux_1 <= FIRBandPass2_in_regtype WHEN ( cur_count = to_unsigned(0, 3) ) ELSE
  ...
  FIRBandPass2_out <= std_logic_vector(output_typeconvert);
END rtl;
