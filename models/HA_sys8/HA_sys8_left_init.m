...
%-----------------------------------------------
FIRDecimator1.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRDecimator1'];
...
FIRDecimator2.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRDecimator2'];
...
FIRDecimator3.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRDecimator3'];
...
FIRDecimator4.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRDecimator4'];
...
%-----------------------------------------------
FIRInterpolator1.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRInterpolator1'];
...
FIRInterpolator2.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRInterpolator2'];
...
FIRInterpolator3.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRInterpolator3'];
...
FIRInterpolator4.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRInterpolator4'];
...
% FIR Bandpass Blocks
%-----------------------------------------------
FIRBandPass1.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRBandPass1'];
...
length(FIRBandPass1.FIR_coefficients)

FIRBandPass2.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRBandPass2'];
...
FIRBandPass3.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRBandPass3'];
...
FIRBandPass4.simulink_block              = ['HA_sys8/HA_LR/HA_left/FIRBandPass4'];
...
% 
% figure(100)
% [H,F]=freqz(FIRBandPass1.filter_object,1024,Fs_1);
% H1 = 20*log10(abs(H));
% h=plot(F,H1); hold on; set(h,'LineWidth',3)
% 
% [H,F]=freqz(FIRBandPass2.filter_object,1024,Fs_2);
% H2 = 20*log10(abs(H));
% h=plot(F,H2); hold on; set(h,'LineWidth',3)
% 
% [H,F]=freqz(FIRBandPass3.filter_object,1024,Fs_3);
% H3 = 20*log10(abs(H));
% h=plot(F,H2); hold on; set(h,'LineWidth',3)
% 
% [H,F]=freqz(FIRBandPass4.filter_object,1024,Fs_4);
% H3 = 20*log10(abs(H));
% h=plot(F,H2); hold on; set(h,'LineWidth',3)
% 
% xlabel('Frequency')
% ylabel('dB')
% title('Frequency Response of Bandpass Filters : 0.25-0.5, 0.5-1, 1-2, 2-4 kHz')
% set(gca, 'FontSize', 50)


% [H,F]=freqz(FIRDecimator1.filter_object,1024,Fs_1);
% H1 = 20*log10(abs(H));
% H1 = H1 - max(H1);
% plot(F,H1); hold on
% [H,F]=freqz(FIRInterpolator1.filter_object,1024,Fs_1);
% H3 = 20*log10(abs(H));
% H3 = H3 - max(H3);
% plot(F,H3)
% 
...
% 
% 
% FIRInterpolator3.filter_object 
% 
% freqz(FIRBandPass4.filter_object)
% 
% 
% 
