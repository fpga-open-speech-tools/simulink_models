-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/NIH/simulink_models/models/noise_suppression/hdlsrc/noise_suppression/noise_suppression_compute_statistics.vhd
-- 
...
ARCHITECTURE rtl OF noise_suppression_compute_statistics IS
  ...
  SIGNAL rd_11_reg                        : vector_of_unsigned32(0 TO 2);  -- ufix32 [3]
  SIGNAL rd_11_reg_next                   : vector_of_unsigned32(0 TO 2);  -- ufix32_En31 [3]
  ...
  SIGNAL rd_6_out_1                       : signed(1 DOWNTO 0);  -- sfix2
  SIGNAL rd_6_1_reg                       : vector_of_signed2(0 TO 3);  -- sfix2 [4]
  SIGNAL rd_6_out_2                       : signed(1 DOWNTO 0);  -- sfix2
  SIGNAL rd_6_1_reg_1                     : vector_of_signed2(0 TO 3);  -- sfix2 [4]
  ...
  SIGNAL mulOutput_3                      : vector_of_unsigned29(0 TO 1);  -- ufix29 [2]
  SIGNAL mulOutput_4                      : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  SIGNAL bitshiftoutput                   : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  SIGNAL bitshiftoutput_1                 : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  SIGNAL slicedOutput_2                   : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL slicedOutput_3                   : unsigned(26 DOWNTO 0);  -- ufix27
  SIGNAL mulOutput_5                      : vector_of_unsigned51(0 TO 1);  -- ufix51 [2]
  SIGNAL mulOutput_6                      : vector_of_unsigned51(0 TO 1);  -- ufix51 [2]
  SIGNAL mulOutput_7                      : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  SIGNAL mulOutput_8                      : vector_of_unsigned56(0 TO 1);  -- ufix56 [2]
  SIGNAL mulOutput_9                      : vector_of_unsigned57(0 TO 1);  -- ufix57 [2]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      data_2(0) <= to_signed(16#000000#, 24);
      data_2(1) <= to_signed(16#000000#, 24);
  ...
  SignumOutput(0) <= to_signed(16#1#, 2) WHEN data_2(0) > to_signed(16#000000#, 24) ELSE
      to_signed(-16#1#, 2) WHEN data_2(0) < to_signed(16#000000#, 24) ELSE
      to_signed(16#0#, 2);
  
  SignumOutput(1) <= to_signed(16#1#, 2) WHEN data_2(1) > to_signed(16#000000#, 24) ELSE
      to_signed(-16#1#, 2) WHEN data_2(1) < to_signed(16#000000#, 24) ELSE
      to_signed(16#0#, 2);
  ...
  Constant1_out1_1 <= rd_12_reg(2);
  rd_12_reg_next(0) <= Constant1_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      rd_11_reg(0) <= to_unsigned(0, 32);
      rd_11_reg(1) <= to_unsigned(0, 32);
      rd_11_reg(2) <= to_unsigned(0, 32);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
  ...
  exponential_moving_average_weight_out1_1 <= rd_11_reg(2);
  rd_11_reg_next(0) <= exponential_moving_average_weight_out1;
  rd_11_reg_next(1) <= rd_11_reg(0);
  rd_11_reg_next(2) <= rd_11_reg(1);
  ...
  SignumOutput_2 <= to_signed(16#1#, 2) WHEN Switch1_out1 > to_unsigned(0, 32) ELSE
      to_signed(16#0#, 2);

  rd_7_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      SignumOutput_3 <= to_signed(16#0#, 2);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        SignumOutput_3 <= SignumOutput_2;
      END IF;
    END IF;
  END PROCESS rd_7_process;


  mul_sign_mul_temp <= SignumOutput_1(0) * SignumOutput_3;
  mulOutput(0) <= mul_sign_mul_temp(1 DOWNTO 0);
  mul_sign_mul_temp_1 <= SignumOutput_1(1) * SignumOutput_3;
  mulOutput(1) <= mul_sign_mul_temp_1(1 DOWNTO 0);

  mulOutput_0 <= mulOutput(0);

  rd_6_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      rd_6_1_reg(0) <= to_signed(16#0#, 2);
      rd_6_1_reg(1) <= to_signed(16#0#, 2);
      rd_6_1_reg(2) <= to_signed(16#0#, 2);
      rd_6_1_reg(3) <= to_signed(16#0#, 2);
      rd_6_1_reg_1(0) <= to_signed(16#0#, 2);
      rd_6_1_reg_1(1) <= to_signed(16#0#, 2);
      rd_6_1_reg_1(2) <= to_signed(16#0#, 2);
      rd_6_1_reg_1(3) <= to_signed(16#0#, 2);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        rd_6_1_reg(0) <= rd_6_1_reg_next(0);
        rd_6_1_reg(1) <= rd_6_1_reg_next(1);
        rd_6_1_reg(2) <= rd_6_1_reg_next(2);
        rd_6_1_reg(3) <= rd_6_1_reg_next(3);
        rd_6_1_reg_1(0) <= rd_6_1_reg_next_1(0);
        rd_6_1_reg_1(1) <= rd_6_1_reg_next_1(1);
        rd_6_1_reg_1(2) <= rd_6_1_reg_next_1(2);
        rd_6_1_reg_1(3) <= rd_6_1_reg_next_1(3);
      END IF;
    END IF;
  END PROCESS rd_6_1_process;

  rd_6_1_reg_next(0) <= mulOutput_0;
  rd_6_1_reg_next(1) <= rd_6_1_reg(0);
  rd_6_1_reg_next(2) <= rd_6_1_reg(1);
  rd_6_1_reg_next(3) <= rd_6_1_reg(2);
  rd_6_out_1 <= rd_6_1_reg(3);
  rd_6_1_reg_next_1(0) <= mulOutput_1;
  rd_6_1_reg_next_1(1) <= rd_6_1_reg_1(0);
  rd_6_1_reg_next_1(2) <= rd_6_1_reg_1(1);
  rd_6_1_reg_next_1(3) <= rd_6_1_reg_1(2);
  rd_6_out_2 <= rd_6_1_reg_1(3);

  
  switch_compare_1 <= '1' WHEN rd_6_out_1 > to_signed(16#0#, 2) ELSE
      '0';

  Product_in0_dtc_in_abs_cast <= resize(data_2(0), 25);
  
  Product_in0_dtc_in_abs_y(0) <=  - (Product_in0_dtc_in_abs_cast) WHEN data_2(0) < to_signed(16#000000#, 24) ELSE
      resize(data_2(0), 25);
  Product_in0_dtc_in_abs_cast_1 <= resize(data_2(1), 25);
  
  Product_in0_dtc_in_abs_y(1) <=  - (Product_in0_dtc_in_abs_cast_1) WHEN data_2(1) < to_signed(16#000000#, 24) ELSE
      resize(data_2(1), 25);
  data_3(0) <= unsigned(Product_in0_dtc_in_abs_y(0)(23 DOWNTO 0));
  data_3(1) <= unsigned(Product_in0_dtc_in_abs_y(1)(23 DOWNTO 0));
  ...
  Switch1_out1_1 <= resize(Switch1_out1, 54);

  slicedOutput <= Switch1_out1_1(31 DOWNTO 27);

  HwModeRegister3_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      slicedOutput_1 <= to_unsigned(16#00#, 5);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        slicedOutput_1 <= slicedOutput;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      mulOutput_3(0) <= to_unsigned(16#00000000#, 29);
      mulOutput_3(1) <= to_unsigned(16#00000000#, 29);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_3(0) <= mulOutput_2(0);
        mulOutput_3(1) <= mulOutput_2(1);
      END IF;
    END IF;
  END PROCESS PipelineRegister1_process;


  mulOutput_4(0) <= resize(mulOutput_3(0), 56);
  mulOutput_4(1) <= resize(mulOutput_3(1), 56);

  bitshiftoutput(0) <= mulOutput_4(0) sll 27;
  bitshiftoutput(1) <= mulOutput_4(1) sll 27;

  rd_13_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      bitshiftoutput_1(0) <= to_unsigned(0, 56);
      bitshiftoutput_1(1) <= to_unsigned(0, 56);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        bitshiftoutput_1(0) <= bitshiftoutput(0);
        bitshiftoutput_1(1) <= bitshiftoutput(1);
      END IF;
    END IF;
  END PROCESS rd_13_process;


  slicedOutput_2 <= Switch1_out1_1(26 DOWNTO 0);

  HwModeRegister1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      slicedOutput_3 <= to_unsigned(16#0000000#, 27);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        slicedOutput_3 <= slicedOutput_2;
      END IF;
    END IF;
  END PROCESS HwModeRegister1_process;


  mulOutput_5(0) <= data_5(0) * slicedOutput_3;
  mulOutput_5(1) <= data_5(1) * slicedOutput_3;
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_6(0) <= mulOutput_5(0);
        mulOutput_6(1) <= mulOutput_5(1);
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      mulOutput_8(0) <= to_unsigned(0, 56);
      mulOutput_8(1) <= to_unsigned(0, 56);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_8(0) <= mulOutput_7(0);
        mulOutput_8(1) <= mulOutput_7(1);
      END IF;
    END IF;
  END PROCESS rd_10_process;


  mulOutput_9(0) <= resize(bitshiftoutput_1(0), 57) + resize(mulOutput_8(0), 57);
  mulOutput_9(1) <= resize(bitshiftoutput_1(1), 57) + resize(mulOutput_8(1), 57);

  mulOutput_10(0) <= signed(mulOutput_9(0));
  mulOutput_10(1) <= signed(mulOutput_9(1));

  rd_14_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      mulOutput_11(0) <= to_signed(0, 57);
      mulOutput_11(1) <= to_signed(0, 57);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_11(0) <= mulOutput_10(0);
        mulOutput_11(1) <= mulOutput_10(1);
      END IF;
    END IF;
  END PROCESS rd_14_process;


  SwitchComp_in2_uminus_in0 <=  - (resize(mulOutput_11(0), 58));
  mulOutput_12(0) <= SwitchComp_in2_uminus_in0(56 DOWNTO 0);
  SwitchComp_in2_uminus_in0_1 <=  - (resize(mulOutput_11(1), 58));
  mulOutput_12(1) <= SwitchComp_in2_uminus_in0_1(56 DOWNTO 0);
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_13(0) <= mulOutput_12(0);
        mulOutput_13(1) <= mulOutput_12(1);
      END IF;
    END IF;
  END PROCESS rd_4_process;


  mulOutput_0_1 <= mulOutput_13(0);

  rd_15_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      mulOutput_14(0) <= to_signed(0, 57);
      mulOutput_14(1) <= to_signed(0, 57);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        mulOutput_14(0) <= mulOutput_11(0);
        mulOutput_14(1) <= mulOutput_11(1);
      END IF;
    END IF;
  ...
  switch_compare_2 <= '1' WHEN rd_6_out_2 > to_signed(16#0#, 2) ELSE
      '0';

  mulOutput_1_1 <= mulOutput_13(1);

  mulOutput_0_2 <= mulOutput_14(0);

  
  mulOutput_0_3 <= mulOutput_0_1 WHEN switch_compare_1 = '0' ELSE
      mulOutput_0_2;

  mulOutput_1_2 <= mulOutput_14(1);

  
  mulOutput_1_3 <= mulOutput_1_1 WHEN switch_compare_2 = '0' ELSE
      mulOutput_1_2;

  mulOutput_15(0) <= mulOutput_0_3;
  mulOutput_15(1) <= mulOutput_1_3;

  mulOutput_16(0) <= mulOutput_15(0)(55 DOWNTO 0);
  mulOutput_16(1) <= mulOutput_15(1)(55 DOWNTO 0);

  Product_out1(0) <= mulOutput_16(0)(54 DOWNTO 31);
  Product_out1(1) <= mulOutput_16(1)(54 DOWNTO 31);
  ...
  outputgen1: FOR k IN 0 TO 1 GENERATE
    data_signed_1(k) <= signed(data(k));
  END GENERATE;

  data_6 <= data_signed_1;

  Add_out1_2 <= Add_out1_1;

  Add1_out1(0) <= data_6(0) - Add_out1_2(0);
  Add1_out1(1) <= data_6(1) - Add_out1_2(1);
