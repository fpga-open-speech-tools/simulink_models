...
% OHC_NL_Boltzman_Test_Parameters
% 06/26/2019
...
% The following script is designed as an init script for the OHC NL
% Boltzman Function Simulink model. It sets the parameters for both the 
