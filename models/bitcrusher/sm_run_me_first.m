...
mp.fastsim_Nsamples = 96000; % set to the string 'all' to use all the samples from the input signal specified in sm_init_test_signals.m
...
% Change working directory to model directory (this may already be the case)
cd(mp.model_path);
