-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\ohc_nonlinear_filter\ohc_nonlinear_filter_nfp_div_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ohc_nonlinear_filter_nfp_div_single
...
ENTITY ohc_nonlinear_filter_nfp_div_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ohc_nonlinear_filter_nfp_div_single;


ARCHITECTURE rtl OF ohc_nonlinear_filter_nfp_div_single IS
