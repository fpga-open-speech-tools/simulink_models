-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\ohc_nonlinear_filter\ohc_nonlinear_filter_ohc_nonlinear_filter.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ohc_nonlinear_filter_ohc_nonlinear_filter
...
ENTITY ohc_nonlinear_filter_ohc_nonlinear_filter IS
  PORT( ohc_nl_fnc_in                     :   IN    std_logic_vector(31 DOWNTO 0);  -- single
        ohc_nl_fnc_out                    :   OUT   std_logic_vector(31 DOWNTO 0)  -- single
        );
END ohc_nonlinear_filter_ohc_nonlinear_filter;


ARCHITECTURE rtl OF ohc_nonlinear_filter_ohc_nonlinear_filter IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT ohc_nonlinear_filter_nfp_abs_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT ohc_nonlinear_filter_nfp_div_single
  ...
  COMPONENT ohc_nonlinear_filter_nfp_uminus_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT ohc_nonlinear_filter_nfp_exp_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT ohc_nonlinear_filter_nfp_mul_single
    PORT( nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_in2                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  ...
  COMPONENT ohc_nonlinear_filter_nfp_add_single
    PORT( nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_in2                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  ...
  COMPONENT ohc_nonlinear_filter_nfp_relop_single_block
    PORT( nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_in2                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT ohc_nonlinear_filter_nfp_relop_single
    PORT( nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_in2                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out1                        :   OUT   std_logic
          );
  ...
  FOR ALL : ohc_nonlinear_filter_nfp_abs_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_abs_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_div_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_div_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_uminus_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_uminus_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_exp_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_exp_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_mul_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_mul_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_add_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_add_single(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_relop_single_block
    USE ENTITY work.ohc_nonlinear_filter_nfp_relop_single_block(rtl);

  FOR ALL : ohc_nonlinear_filter_nfp_relop_single
    USE ENTITY work.ohc_nonlinear_filter_nfp_relop_single(rtl);
