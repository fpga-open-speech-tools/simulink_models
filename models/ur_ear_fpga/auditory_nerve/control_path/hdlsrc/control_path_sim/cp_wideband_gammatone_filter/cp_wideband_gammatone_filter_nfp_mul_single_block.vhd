-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\cp_wideband_gammatone_filter\cp_wideband_gammatone_filter_nfp_mul_single_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: cp_wideband_gammatone_filter_nfp_mul_single_block
...
ENTITY cp_wideband_gammatone_filter_nfp_mul_single_block IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END cp_wideband_gammatone_filter_nfp_mul_single_block;


ARCHITECTURE rtl OF cp_wideband_gammatone_filter_nfp_mul_single_block IS
