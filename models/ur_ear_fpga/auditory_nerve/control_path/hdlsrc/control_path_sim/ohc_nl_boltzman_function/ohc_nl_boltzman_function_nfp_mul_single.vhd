-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\ohc_nl_boltzman_function\ohc_nl_boltzman_function_nfp_mul_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ohc_nl_boltzman_function_nfp_mul_single
...
ENTITY ohc_nl_boltzman_function_nfp_mul_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ohc_nl_boltzman_function_nfp_mul_single;


ARCHITECTURE rtl OF ohc_nl_boltzman_function_nfp_mul_single IS
