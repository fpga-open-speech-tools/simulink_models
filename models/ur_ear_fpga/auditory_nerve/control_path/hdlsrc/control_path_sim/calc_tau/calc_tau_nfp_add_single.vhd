-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\calc_tau\calc_tau_nfp_add_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: calc_tau_nfp_add_single
...
ENTITY calc_tau_nfp_add_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END calc_tau_nfp_add_single;


ARCHITECTURE rtl OF calc_tau_nfp_add_single IS
