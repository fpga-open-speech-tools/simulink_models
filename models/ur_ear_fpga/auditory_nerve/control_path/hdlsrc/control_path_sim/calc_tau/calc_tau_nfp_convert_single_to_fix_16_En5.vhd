-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\control_path_sim\calc_tau\calc_tau_nfp_convert_single_to_fix_16_En5.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: calc_tau_nfp_convert_single_to_fix_16_En5
...
ENTITY calc_tau_nfp_convert_single_to_fix_16_En5 IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- ufix16
        );
END calc_tau_nfp_convert_single_to_fix_16_En5;


ARCHITECTURE rtl OF calc_tau_nfp_convert_single_to_fix_16_En5 IS
