-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\calc_c1_coefficients\ur_ear_fpga_sim_calc_c1_coefficients_nfp_add2_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_calc_c1_coefficients_nfp_add2_single
-- Source Path: calc_c1_coefficients/nfp_add2_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_calc_c1_coefficients_nfp_add2_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_calc_c1_coefficients_nfp_add2_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_calc_c1_coefficients_nfp_add2_single IS
  ...
  SIGNAL Zero_out1                        : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL EqE1_relop1                      : std_logic;
  SIGNAL Zero0_out1                       : unsigned(22 DOWNTO 0);  -- ufix23
  SIGNAL EqM_relop1                       : std_logic;
  SIGNAL Logical_Operator_out1_1          : std_logic;  -- ufix1
  SIGNAL Inv_out1                         : std_logic;  -- ufix1
  SIGNAL Zero1_out1                       : std_logic;  -- ufix1
  SIGNAL Switch_out1                      : std_logic;  -- ufix1
  SIGNAL Zero_out1_1                      : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL EqE1_relop1_1                    : std_logic;
  SIGNAL Zero0_out1_1                     : unsigned(22 DOWNTO 0);  -- ufix23
  SIGNAL EqM_relop1_1                     : std_logic;
  SIGNAL Logical_Operator_out1_2          : std_logic;  -- ufix1
  SIGNAL Inv_out1_1                       : std_logic;  -- ufix1
  SIGNAL Zero1_out1_1                     : std_logic;  -- ufix1
  ...
  SIGNAL Switch_out1_2                    : unsigned(4 DOWNTO 0);  -- ufix5
...
BEGIN
  ...
  Zero_out1 <= to_unsigned(16#00#, 8);

  
  EqE1_relop1 <= '1' WHEN Zero_out1 = BE ELSE
      '0';

  Zero0_out1 <= to_unsigned(16#000000#, 23);

  
  EqM_relop1 <= '1' WHEN Zero0_out1 = BM ELSE
      '0';

  Logical_Operator_out1_1 <= EqE1_relop1 AND EqM_relop1;
  ...
  Switch_out1 <= Inv_out1 WHEN Logical_Operator_out1_1 = '0' ELSE
      Zero1_out1;

  Zero_out1_1 <= to_unsigned(16#00#, 8);

  
  EqE1_relop1_1 <= '1' WHEN Zero_out1_1 = AE ELSE
      '0';

  Zero0_out1_1 <= to_unsigned(16#000000#, 23);

  
  EqM_relop1_1 <= '1' WHEN Zero0_out1_1 = AM ELSE
      '0';

  Logical_Operator_out1_2 <= EqE1_relop1_1 AND EqM_relop1_1;
  ...
  Switch_out1_1 <= Inv_out1_1 WHEN Logical_Operator_out1_2 = '0' ELSE
      Zero1_out1_1;

  
  if_bitconcat_aExponent_aMantiss_2_out1 <= Switch_out1 WHEN Logical_Operator1_out1 = '0' ELSE
      Switch_out1_1;

  
  if_bitconcat_aExponent_aMantiss_5_out1 <= Switch_out1_1 WHEN Logical_Operator1_out1 = '0' ELSE
      Switch_out1;
  ...
  Logical_Operator_out1_3 <= exp_norm_cfType_Exponent_In_out1 AND BitSlice_out1;
  ...
  Switch_out1_2 <= Constant_out1_1 WHEN Bit_Slice_out1_1 = '0' ELSE
      Constant1_out1;

  Logical_Operator_out1_4 <= Bit_Slice3_out1_1 OR Bit_Slice2_out1_2;

  Constant2_out1 <= to_unsigned(16#18#, 5);

  
  Switch1_out1 <= Switch_out1_2 WHEN Bit_Slice1_out1_1 = '0' ELSE
      Constant2_out1;
  ...
  Switch4_out1 <= Switch1_out1 WHEN Logical_Operator_out1_4 = '0' ELSE
      Switch3_out1;
  ...
  Logical_Operator_out1_5 <= Logical_Operator1_out1_1 OR Logical_Operator12_out1;
  ...
  Switch34_out1 <= Switch33_out1 WHEN Logical_Operator_out1_5 = '0' ELSE
      Switch1_out1_1;
  ...
  if_exp_norm_cfType_Exponent_I_out1 <= if_bitget_Sum_Sum_WordLength_out1 WHEN Logical_Operator_out1_3 = '0' ELSE
      C5_out1;
  ...
  Logical_Operator_out1_6 <= Bit_Slice1_out1_3 OR Data_Type_Conversion_out1_2;
  ...
  Logical_Operator1_out1_4 <= Bit_Slice2_out1_3 OR Logical_Operator_out1_6;
  ...
  Logical_Operator_out1_7 <= Bit_Slice1_out1_4 OR Logical_Operator3_out1_1;
  ...
  Logical_Operator1_out1_5 <= Bit_Slice2_out1_4 OR Logical_Operator_out1_7;
  ...
  Logical_Operator_out1_8 <= Bit_Slice1_out1_5 OR Logical_Operator3_out1_2;
  ...
  Logical_Operator1_out1_6 <= Bit_Slice2_out1_5 OR Logical_Operator_out1_8;
  ...
  Logical_Operator_out1_9 <= Bit_Slice1_out1_6 OR Logical_Operator3_out1_3;
  ...
  Logical_Operator1_out1_7 <= Bit_Slice2_out1_6 OR Logical_Operator_out1_9;
  ...
  Logical_Operator_out1_10 <= Bit_Slice1_out1_7 OR Logical_Operator3_out1_4;
  ...
  Logical_Operator1_out1_8 <= Bit_Slice2_out1_7 OR Logical_Operator_out1_10;
  ...
  Logical_Operator_out1_11 <= Bit_Slice1_out1_8 OR Logical_Operator3_out1_5;
  ...
  Logical_Operator1_out1_9 <= Bit_Slice2_out1_8 OR Logical_Operator_out1_11;
  ...
  Logical_Operator_out1_12 <= Bit_Slice1_out1_9 OR Logical_Operator3_out1_6;

  
  Switch6_out1_9 <= Logical_Operator3_out1_6 WHEN Bit_Slice14_out1_2 = '0' ELSE
      Logical_Operator_out1_12;

  Bit_Slice2_out1_9 <= Bit_Slice6_out1_1(2);

  Logical_Operator1_out1_10 <= Bit_Slice2_out1_9 OR Logical_Operator_out1_12;
  ...
  Logical_Operator_out1_13 <=  NOT Bit_Slice1_out1_10;

  Logical_Operator1_out1_11 <= Logical_Operator_out1_13 AND Logical_Operator2_out1_7;
