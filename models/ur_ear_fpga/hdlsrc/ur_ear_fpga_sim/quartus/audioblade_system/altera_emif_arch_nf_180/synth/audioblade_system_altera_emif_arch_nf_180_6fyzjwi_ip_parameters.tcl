...
set ::GLOBAL_audioblade_system_altera_emif_arch_nf_180_6fyzjwi_corename audioblade_system_altera_emif_arch_nf_180_6fyzjwi
...
set var(VIN_Ms)                                                  0.13
set var(VIN_Mh)                                                  0.065000000000000002
set var(SLEW_RATE_PHY)                                           2.0
set var(SLEW_RATE_PHY_CLOCK)                                     4.0
set var(SLEW_RATE_CA)                                            2.0
set var(SLEW_RATE_CLOCK)                                         4.0
set var(UI)                                                      0.83299999999999996
set var(tCK)                                                     0.83299999999999996
set var(tDQSQ)                                                   0.058310000000000001
set var(tQH)                                                     0.42999999999999999
set var(tDS)                                                     0.041666666666666671
set var(tDH)                                                     0.041666666666666671
set var(tIS)                                                     0.062
set var(tIH)                                                     0.086999999999999994
set var(tDQSCK)                                                  0.17499999999999999
set var(tDQSS)                                                   0.27
set var(tWLS)                                                    0.108
set var(tWLH)                                                    0.108
set var(tDSS)                                                    0.18
set var(tDSH)                                                    0.18
set var(BD_PKG_SKEW)                                             0.00682426337929178
set var(CA_BD_PKG_SKEW)                                          0.16803950907323917
set var(CA_TO_CK_BD_PKG_SKEW)                                    0.0054713984999832
set var(DQS_BOARD_SKEW)                                          0.142200242799049
set var(DQS_TO_CK_BOARD_SKEW)                                    0.171474003509201
...
set var(PLL_NUM_OF_EXTRA_CLKS)                                   1
set var(PLL_C_CNT_LOW_3)                                         4
...
set var(PLL_C_CNT_LOW_5)                                         6
set var(PLL_C_CNT_HIGH_5)                                        6
set var(PLL_C_CNT_BYPASS_EN_5)                                   false
