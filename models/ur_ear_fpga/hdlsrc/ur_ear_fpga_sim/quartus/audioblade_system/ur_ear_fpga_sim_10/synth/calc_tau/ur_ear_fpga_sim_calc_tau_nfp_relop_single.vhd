-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\calc_tau\ur_ear_fpga_sim_calc_tau_nfp_relop_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_calc_tau_nfp_relop_single
-- Source Path: calc_tau/nfp_relop_single
-- Hierarchy Level: 6
-- 
...
ENTITY ur_ear_fpga_sim_calc_tau_nfp_relop_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END ur_ear_fpga_sim_calc_tau_nfp_relop_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_calc_tau_nfp_relop_single IS
...
BEGIN
  ...
  Logical_Operator2_out1 <=  NOT Constant8_out1;

  Logical_Operator4_out1 <=  NOT Relational_Operator4_relop1;

  Logical_Operator1_out1 <= Relational_Operator5_relop1 AND Logical_Operator4_out1;

  Logical_Operator5_out1 <=  NOT Relational_Operator2_relop1;

  Logical_Operator2_out1_1 <= Relational_Operator6_relop1 AND Logical_Operator5_out1;

  Logical_Operator3_out1 <= Logical_Operator1_out1 OR Logical_Operator2_out1_1;

  Logical_Operator_out1 <= Logical_Operator2_out1 OR Logical_Operator3_out1;
  ...
  Switch6_out1 <= Logical_Operator4_out1_1 WHEN Logical_Operator_out1 = '0' ELSE
      Constant6_out1;
