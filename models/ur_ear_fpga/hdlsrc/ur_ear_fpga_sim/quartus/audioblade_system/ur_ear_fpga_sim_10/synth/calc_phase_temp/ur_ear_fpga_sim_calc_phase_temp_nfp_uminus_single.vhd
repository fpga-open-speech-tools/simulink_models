-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\calc_phase_temp\ur_ear_fpga_sim_calc_phase_temp_nfp_uminus_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_calc_phase_temp_nfp_uminus_single
-- Source Path: calc_phase_temp/nfp_uminus_single
-- Hierarchy Level: 8
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ur_ear_fpga_sim_calc_phase_temp_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_calc_phase_temp_nfp_uminus_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_calc_phase_temp_nfp_uminus_single IS
