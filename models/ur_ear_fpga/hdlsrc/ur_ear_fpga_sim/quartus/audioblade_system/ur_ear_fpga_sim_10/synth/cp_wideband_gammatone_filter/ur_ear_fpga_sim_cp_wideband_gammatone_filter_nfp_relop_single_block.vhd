-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\cp_wideband_gammatone_filter\ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single_block
-- Source Path: cp_wideband_gammatone_filter/MATLAB Function1/nfp_relop_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single_block IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single_block;


ARCHITECTURE rtl OF ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single_block IS
...
BEGIN
  ...
  Logical_Operator2_out1_2 <=  NOT Logical_Operator5_out1_2;

  Constant1_out1_1 <= '0';

  
  Switch4_out1 <= Logical_Operator2_out1_2 WHEN Logical_Operator_out1_1 = '0' ELSE
      Constant1_out1_1;
