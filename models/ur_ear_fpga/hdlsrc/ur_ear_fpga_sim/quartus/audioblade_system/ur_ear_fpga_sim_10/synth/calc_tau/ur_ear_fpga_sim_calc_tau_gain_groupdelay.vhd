-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\calc_tau\ur_ear_fpga_sim_calc_tau_gain_groupdelay.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_calc_tau_gain_groupdelay
...
ENTITY ur_ear_fpga_sim_calc_tau_gain_groupdelay IS
...
END ur_ear_fpga_sim_calc_tau_gain_groupdelay;


ARCHITECTURE rtl OF ur_ear_fpga_sim_calc_tau_gain_groupdelay IS
  ...
  COMPONENT ur_ear_fpga_sim_calc_tau_nfp_div_single
    PORT( nfp_in1                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT ur_ear_fpga_sim_calc_tau_nfp_cos_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT ur_ear_fpga_sim_calc_tau_nfp_sqrt_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;

  COMPONENT ur_ear_fpga_sim_calc_tau_nfp_floor_single
    PORT( nfp_in                          :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
          nfp_out                         :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
          );
  END COMPONENT;
  ...
  FOR ALL : ur_ear_fpga_sim_calc_tau_nfp_div_single
    USE ENTITY work.ur_ear_fpga_sim_calc_tau_nfp_div_single(rtl);
  ...
  FOR ALL : ur_ear_fpga_sim_calc_tau_nfp_cos_single
    USE ENTITY work.ur_ear_fpga_sim_calc_tau_nfp_cos_single(rtl);

  FOR ALL : ur_ear_fpga_sim_calc_tau_nfp_sqrt_single
    USE ENTITY work.ur_ear_fpga_sim_calc_tau_nfp_sqrt_single(rtl);

  FOR ALL : ur_ear_fpga_sim_calc_tau_nfp_floor_single
    USE ENTITY work.ur_ear_fpga_sim_calc_tau_nfp_floor_single(rtl);
...
BEGIN
  ...
  -- mul #2
  u_nfp_div_comp : ur_ear_fpga_sim_calc_tau_nfp_div_single
  ...
  u_nfp_div_comp_1 : ur_ear_fpga_sim_calc_tau_nfp_div_single
  ...
  u_nfp_add_comp_1 : ur_ear_fpga_sim_calc_tau_nfp_add_single
  ...
  -- mul #1
  u_nfp_mul_comp_1 : ur_ear_fpga_sim_calc_tau_nfp_mul_single
  ...
  -- mul #2
  u_nfp_mul_comp_2 : ur_ear_fpga_sim_calc_tau_nfp_mul_single
    PORT MAP( nfp_in1 => Product_out_1,  -- ufix32
              nfp_in2 => tdres,  -- ufix32
              nfp_out => Product_out1  -- ufix32
              );

  u_nfp_cos_comp : ur_ear_fpga_sim_calc_tau_nfp_cos_single
    PORT MAP( nfp_in => Product_out1,  -- ufix32
              nfp_out => tmpcos_out1  -- ufix32
              );

  u_nfp_mul_comp_3 : ur_ear_fpga_sim_calc_tau_nfp_mul_single
    PORT MAP( nfp_in1 => c1LP_out1,  -- ufix32
              nfp_in2 => tmpcos_out1,  -- ufix32
              nfp_out => c1LP_tmpcos_out1  -- ufix32
              );

  u_nfp_gain_pow2_single_1 : ur_ear_fpga_sim_calc_tau_nfp_gain_pow2_single
  ...
  u_nfp_sub_comp_2 : ur_ear_fpga_sim_calc_tau_nfp_sub_single
    PORT MAP( nfp_in1 => tmp1_op_stage2,  -- ufix32
              nfp_in2 => Product2_out1,  -- ufix32
              nfp_out => tmp1_out1  -- ufix32
              );

  u_nfp_add_comp_2 : ur_ear_fpga_sim_calc_tau_nfp_add_single
  ...
  -- mul #1
  u_nfp_gain_pow2_single_2 : ur_ear_fpga_sim_calc_tau_nfp_gain_pow2_single
  ...
  u_nfp_div_comp_2 : ur_ear_fpga_sim_calc_tau_nfp_div_single
  ...
  -- mul #2
  u_nfp_mul_comp_4 : ur_ear_fpga_sim_calc_tau_nfp_mul_single
