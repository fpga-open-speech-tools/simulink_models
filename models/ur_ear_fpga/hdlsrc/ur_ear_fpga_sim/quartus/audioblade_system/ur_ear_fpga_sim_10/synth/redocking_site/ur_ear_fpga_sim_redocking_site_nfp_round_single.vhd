-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\redocking_site\ur_ear_fpga_sim_redocking_site_nfp_round_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_redocking_site_nfp_round_single
...
ENTITY ur_ear_fpga_sim_redocking_site_nfp_round_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_redocking_site_nfp_round_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_redocking_site_nfp_round_single IS
...
BEGIN
  ...
  isExponentLt126_out1 <= '1' WHEN aExponent <= to_unsigned(16#7E#, 8) ELSE
      '0';
  ...
  shiftRightBinaryPontByOne_out1 <= ShiftBinaryPoint_out1 srl 1;
  ...
  Bitwise_AND_out1 <= Bit_Slice_out1 AND aMantissa;

  
  isfractionGtEqHalf_out1 <= '1' WHEN Bitwise_AND_out1 /= to_unsigned(16#000000#, 23) ELSE
      '0';

  Logical_Operator_out1_1 <= isPosLtShiftlength_relop1 AND isfractionGtEqHalf_out1;
  ...
  isExponentEq126_out1 <= '1' WHEN aExponent = to_unsigned(16#7E#, 8) ELSE
      '0';
