-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\redocking_site\ur_ear_fpga_sim_redocking_site_nfp_log10_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_redocking_site_nfp_log10_single
-- Source Path: redocking_site/Redock Component/nfp_log10_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_redocking_site_nfp_log10_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_redocking_site_nfp_log10_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_redocking_site_nfp_log10_single IS
...
BEGIN
  ...
  Bit_Concat_out1_1 <= Constant_out1_1 & BitSlice_out1 & Constant1_out1_1;
  ...
  exp_unbiased_cast_cfType_Exp_add_temp <= resize(DTC_out1_1, 32) + resize(ExponentBias_out1, 32);
  ...
  Product_mul_temp <= if_w_1_out1 * Constant3_out1;
  ...
  Bit_Concat1_out1_1 <= unsigned(if_w_hat_0_75_out1) & Constant1_out1_3;
  ...
  L_Log10Table_3_1_out1 <= reinterpretcast_bitsliceget_w_2_out1 + if_w_hat_0_75_out1_1;
  ...
  L_Log10Table_4_1_out1 <= reinterpretcast_bitsliceget_w_1_out1 + if_w_hat_0_75_out1_2;
  ...
  L_Log10Table_5_1_out1 <= reinterpretcast_bitsliceget_w_1_out1_1 + if_w_hat_0_75_out1_3;
  ...
  L_Log10Table_6_1_out1 <= reinterpretcast_bitsliceget_w_1_out1_2 + if_w_hat_0_75_out1_4;
  ...
  L_Log10Table_7_1_out1 <= reinterpretcast_bitsliceget_w_1_out1_3 + if_w_hat_0_75_out1_5;
  ...
  L_Log10Table_9_1_out1 <= reinterpretcast_bitsliceget_w_1_out1_4 + if_w_hat_0_75_out1_6;
  ...
  L_Log10Table_10_1_out1 <= reinterpretcast_bitsliceget_w_1_out1_5 + if_w_hat_0_75_out1_7;
  ...
  L_Log10Table_10_1_out1_1 <= reinterpretcast_bitsliceget_w_1_out1_6 + if_w_hat_0_75_out1_8;
  ...
  L_Log10Table_10_out1 <= reinterpretcast_bitsliceget_w_1_out1_7 + if_w_hat_0_75_out1_9;
  ...
  Logical_Operator_out1 <= Bit_Slice3_out1 OR Bit_Slice6_out1;

  Logical_Operator1_out1 <= Bit_Slice5_out1 OR Logical_Operator_out1;
  ...
  Logical_Operator_out1_1 <= Bit_Slice5_out1_1 OR Bit_Slice3_out1_1;

  Logical_Operator1_out1_1 <= Logical_Operator3_out1 OR Logical_Operator_out1_1;
  ...
  Logical_Operator2_out1 <= Bit_Slice_out1_1 OR Bit_Slice4_out1;
  ...
  Logical_Operator_out1_2 <= Bit_Slice5_out1_2 OR Bit_Slice3_out1_2;

  Logical_Operator1_out1_2 <= Logical_Operator3_out1_1 OR Logical_Operator_out1_2;
  ...
  Logical_Operator2_out1_1 <= Bit_Slice_out1_2 OR Bit_Slice4_out1_1;
  ...
  Logical_Operator_out1_3 <= Bit_Slice5_out1_3 OR Bit_Slice3_out1_3;
  ...
  Logical_Operator1_out1_3 <= Logical_Operator3_out1_2 OR Logical_Operator_out1_3;
  ...
  Logical_Operator2_out1_2 <= Logical_Operator1_out1 OR Logical_Operator6_out1;
  ...
  bitsll_w_abs_j_out1 <= if_sign_1_out1 sll to_integer(dynamic_shift_selsig);
  ...
  if_sign_1_out1_1 <= Log4rt10E_out1 WHEN BitSlice_out1_11 = '0' ELSE
      alphaLog4rt10E_out1;

  tmp3_Log4rt10E_cast <= signed(resize(tmp_m1_tmp_m2_out1, 28));
  tmp3_Log4rt10E_mul_temp <= tmp3_Log4rt10E_cast * if_sign_1_out1_1;
  ...
  bitsra_appx_shift_out1 <= SHIFT_RIGHT(tmp3_Log4rt10E_out1, to_integer(dynamic_shift_selsig_1));
  ...
  Switch_out1_4 <= Switch1_out1 WHEN Compare_To_Constant_out1 = '0' ELSE
      Constant2_out1;

  Bit_Concat1_out1_2 <= unsigned(if_bitget_L_L_WordLength_0_out1) & unsigned(if_w_0_out1);

  reinterpretcast_bitconcat_fi_0_out1 <= signed(Bit_Concat1_out1_2);

  exp_tmp_L_out1 <= Switch_out1_4 - reinterpretcast_bitconcat_fi_0_out1;
  ...
  if_aExponent_cfType_Exponent_2_out1 <= BitSlice_out1_13 WHEN alphaaExponent_cfType_Exponent_out1_1 = '0' ELSE
      if_aExponent_0_2_out1;

  
  Switch1_out1_5 <= Constant1_out1 WHEN Constant8_out1 = '0' ELSE
  ...
  Switch_out1_5 <= exp_tmp_L_out1 WHEN BitSlice_out1_13 = '0' ELSE
      Unary_Minus_out1;

  BitSlice1_out1_1 <= unsigned(Switch_out1_5(56 DOWNTO 0));
  ...
  Logical_Operator_out1_4 <= Bit_Slice5_out1_4 OR Bit_Slice3_out1_4;

  Logical_Operator1_out1_4 <= Logical_Operator3_out1_4 OR Logical_Operator_out1_4;
  ...
  Logical_Operator2_out1_3 <= Bit_Slice_out1_4 OR Bit_Slice4_out1_3;
  ...
  Logical_Operator_out1_5 <= Bit_Slice5_out1_5 OR Bit_Slice3_out1_5;

  Logical_Operator1_out1_5 <= Logical_Operator3_out1_5 OR Logical_Operator_out1_5;
  ...
  Logical_Operator2_out1_4 <= Bit_Slice_out1_5 OR Bit_Slice4_out1_4;

  Logical_Operator5_out1_3 <= Logical_Operator4_out1_5 OR Logical_Operator2_out1_4;
  ...
  Logical_Operator_out1_6 <= Bit_Slice5_out1_7 OR Bit_Slice3_out1_6;

  Logical_Operator1_out1_6 <= Logical_Operator3_out1_6 OR Logical_Operator_out1_6;
  ...
  Logical_Operator2_out1_5 <= Bit_Slice_out1_6 OR Bit_Slice4_out1_5;

  Logical_Operator5_out1_4 <= Logical_Operator4_out1_6 OR Logical_Operator2_out1_5;
  ...
  Logical_Operator_out1_7 <= Bit_Slice5_out1_8 OR Bit_Slice3_out1_8;

  Logical_Operator1_out1_8 <= Logical_Operator3_out1_7 OR Logical_Operator_out1_7;
  ...
  Logical_Operator2_out1_6 <= Bit_Slice_out1_7 OR Bit_Slice4_out1_6;

  Logical_Operator5_out1_5 <= Logical_Operator4_out1_7 OR Logical_Operator2_out1_6;
  ...
  Logical_Operator_out1_8 <= Bit_Slice5_out1_9 OR Bit_Slice3_out1_9;

  Logical_Operator1_out1_9 <= Logical_Operator3_out1_8 OR Logical_Operator_out1_8;
  ...
  Logical_Operator2_out1_7 <= Bit_Slice_out1_8 OR Bit_Slice4_out1_7;

  Logical_Operator5_out1_6 <= Logical_Operator4_out1_8 OR Logical_Operator2_out1_7;
  ...
  Logical_Operator_out1_9 <= Bit_Slice5_out1_10 OR Bit_Slice3_out1_10;

  Logical_Operator1_out1_10 <= Logical_Operator3_out1_9 OR Logical_Operator_out1_9;
  ...
  Logical_Operator2_out1_8 <= Bit_Slice_out1_9 OR Bit_Slice4_out1_8;

  Logical_Operator5_out1_7 <= Logical_Operator4_out1_9 OR Logical_Operator2_out1_8;
  ...
  Logical_Operator_out1_10 <= Bit_Slice5_out1_11 OR Bit_Slice3_out1_11;
  ...
  Logical_Operator1_out1_11 <= Logical_Operator3_out1_10 OR Logical_Operator_out1_10;
  ...
  Logical_Operator2_out1_9 <= Logical_Operator6_out1_5 OR Logical_Operator6_out1_6;
  ...
  Switch34_out1_1 <= Switch33_out1_1 WHEN Logical_Operator2_out1_9 = '0' ELSE
      Switch2_out1_8;
  ...
  bitsll_Sum_tmp1_out1 <= BitSlice1_out1_1 sll to_integer(DTC_out1_2);

  BitSlice2_out1_1 <= bitsll_Sum_tmp1_out1(55 DOWNTO 32);

  Bit_Concat_out1_12 <= alpha0_out1_2 & BitSlice2_out1_1;

  BitSlice_out1_14 <= Bit_Concat_out1_12(0);

  BitSlice1_out1_2 <= Bit_Concat_out1_12(1);

  alphabitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_2 OR bitsliceget_mant_norm_mant_no_out1;
  ...
  Compare_To_Constant_out1_1 <= '1' WHEN DTC_out1_2 = to_unsigned(16#39#, 8) ELSE
      '0';

  alpha80_out1 <= to_unsigned(16#86#, 8);

  alpha80_cast_pos_like_exp_out_out1 <= alpha80_out1 - DTC_out1_2;
  ...
  Exp_cast_1_like_Exp_out1 <= Switch1_out1_14 + cast_1_like_Exp_out1;

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= Switch1_out1_14 WHEN BitSlice2_out1_2 = '0' ELSE
  ...
  if_aExponent_cfType_Exponent_out1 <= if_bitget_Mant_tmp_Mant_tmp_Wor_out1 WHEN alphaaExponent_cfType_Exponent_out1_1 = '0' ELSE
      if_aExponent_0_out1;

  
  Switch6_out1_10 <= Constant3_out1_1 WHEN Constant8_out1 = '0' ELSE
  ...
  Logical_Operator_out1_11 <= Compare_To_Zero_out1_1 OR BitSlice2_out1_2;
  ...
  if_bitget_Mant_tmp_Mant_tmp_Wor_1_out1 <= BitSlice3_out1 WHEN Logical_Operator_out1_11 = '0' ELSE
      C_out1_5;
  ...
  if_aExponent_cfType_Exponent_1_out1 <= if_bitget_Mant_tmp_Mant_tmp_Wor_1_out1 WHEN alphaaExponent_cfType_Exponent_out1_1 = '0' ELSE
      if_aExponent_0_1_out1;

  
  Switch5_out1_11 <= Constant2_out1_1 WHEN Constant8_out1 = '0' ELSE
