-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\ihc_nl_log\ur_ear_fpga_sim_ihc_nl_log_nfp_mul_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_ihc_nl_log_nfp_mul_single
-- Source Path: ihc_nl_log/nfp_mul_single
-- Hierarchy Level: 8
-- 
...
ENTITY ur_ear_fpga_sim_ihc_nl_log_nfp_mul_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_ihc_nl_log_nfp_mul_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_ihc_nl_log_nfp_mul_single IS
