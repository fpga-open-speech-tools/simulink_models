-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\ur_ear_fpga_sim_nfp_convert_sfix_32_En28_to_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_nfp_convert_sfix_32_En28_to_single
-- Source Path: ur_ear_fpga_sim/dataplane/Avalon Data Processing/nfp_convert_sfix_32_En28_to_single
-- Hierarchy Level: 2
-- 
...
ENTITY ur_ear_fpga_sim_nfp_convert_sfix_32_En28_to_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_nfp_convert_sfix_32_En28_to_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_nfp_convert_sfix_32_En28_to_single IS

  ATTRIBUTE multstyle : string;

  -- Signals
  SIGNAL nfp_in_signed                    : signed(31 DOWNTO 0);  -- sfix32_En28
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Unary_Minus_cast                 : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Unary_Minus_cast_1               : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL Unary_Minus_out1                 : signed(31 DOWNTO 0);  -- sfix32_En28
  SIGNAL Unary_Minus_out1_dtc             : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Switch_out1                      : unsigned(31 DOWNTO 0);  -- ufix32_En28
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En28
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En28
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN nfp_in_signed = to_signed(0, 32) ELSE
      '0';

  Constant3_out1 <= '1';

  
  Compare_To_Zero_out1 <= '1' WHEN nfp_in_signed < to_signed(0, 32) ELSE
      '0';
  ...
  Switch3_out1 <= Logical_Operator_out1 WHEN CompareToZero1_out1 = '0' ELSE
      Constant2_out1;

  Constant9_out1 <= to_unsigned(16#40#, 8);

  Delay_out1_dtc <= unsigned(nfp_in_signed);

  Unary_Minus_cast <= resize(nfp_in_signed, 33);
  ...
  Compare_To_Constant_out1 <= '1' WHEN Switch5_out1 > to_unsigned(16#38#, 8) ELSE
      '0';
  ...
  Switch_out1_1 <= Switch31_out1 WHEN Compare_To_Constant_out1 = '0' ELSE
      Switch5_out1;
  ...
  Compare_To_Constant1_out1 <= '1' WHEN Switch6_out1 > to_unsigned(16#28#, 8) ELSE
      '0';
  ...
  Switch1_out1_1 <= Switch23_out1 WHEN Compare_To_Constant1_out1 = '0' ELSE
      Switch6_out1;
  ...
  Compare_To_Constant3_out1 <= '1' WHEN Switch2_out1_2 > to_unsigned(16#18#, 8) ELSE
      '0';
  ...
  Switch3_out1_3 <= Switch29_out1_1 WHEN Compare_To_Constant3_out1 = '0' ELSE
      Switch2_out1_2;
  ...
  Compare_To_Constant4_out1 <= '1' WHEN Switch6_out1_1 > to_unsigned(16#08#, 8) ELSE
      '0';
  ...
  Switch4_out1_2 <= Switch22_out1_1 WHEN Compare_To_Constant4_out1 = '0' ELSE
      Switch6_out1_1;
  ...
  Compare_To_Constant_out1_1 <= '1' WHEN Switch23_out1_2 > to_unsigned(16#38#, 8) ELSE
      '0';
  ...
  Switch_out1_2 <= Switch12_out1_2 WHEN Compare_To_Constant_out1_1 = '0' ELSE
      Switch23_out1_2;
  ...
  Compare_To_Constant1_out1_1 <= '1' WHEN Switch4_out1_3 > to_unsigned(16#28#, 8) ELSE
      '0';
  ...
  Switch1_out1_4 <= Switch30_out1_2 WHEN Compare_To_Constant1_out1_1 = '0' ELSE
      Switch4_out1_3;
  ...
  Compare_To_Constant3_out1_1 <= '1' WHEN Switch2_out1_5 > to_unsigned(16#18#, 8) ELSE
      '0';
  ...
  Switch3_out1_6 <= Switch29_out1_3 WHEN Compare_To_Constant3_out1_1 = '0' ELSE
      Switch2_out1_5;
  ...
  Compare_To_Constant4_out1_1 <= '1' WHEN Switch6_out1_4 > to_unsigned(16#08#, 8) ELSE
      '0';
  ...
  Switch4_out1_5 <= Switch22_out1_3 WHEN Compare_To_Constant4_out1_1 = '0' ELSE
      Switch6_out1_4;
  ...
  Constant_out1 <= to_signed(16#62#, 8);

  Subtract_add_cast <= signed(resize(Switch14_out1_4, 10));
  ...
  Switch_out1_3 <= Switch14_out1_4 WHEN Switch14_out1_4 = to_unsigned(16#00#, 8) ELSE
      Subtract_out1_dtc;

  Constant_out1_1 <= to_unsigned(16#80#, 8);

  Subtract_sub_cast <= signed(resize(Constant_out1_1, 9));
  Subtract_sub_cast_1 <= signed(resize(Switch14_out1_4, 9));
  Subtract_out1_1 <= Subtract_sub_cast - Subtract_sub_cast_1;

  shift_arithmetic_zerosig <= to_signed(16#000#, 9);

  
  shift_arithmetic_selsig <= Subtract_out1_1 WHEN Subtract_out1_1 >= shift_arithmetic_zerosig ELSE
  ...
  Shift_Arithmetic_out1 <= Data_Type_Conversion_out1 sll to_integer(dynamic_shift_cast);

  Bit_Slice1_out1_4 <= Shift_Arithmetic_out1(126 DOWNTO 67);

  Bit_Slice2_out1_4 <= Bit_Slice1_out1_4(36 DOWNTO 35);

  Bit_Slice4_out1_4 <= Bit_Slice2_out1_4(0);

  Bit_Slice1_out1_5 <= Bit_Slice1_out1_4(34 DOWNTO 0);
  ...
  Bit_Slice3_out1_4 <= Bit_Slice1_out1_4(37);
  ...
  Bit_Slice1_out1_6 <= Bit_Slice1_out1_4(59 DOWNTO 37);
  ...
  Add1_out1 <= Switch_out1_3 + Add1_add_cast;

  Constant_out1_3 <= to_unsigned(16#00#, 8);

  
  Switch1_out1_7 <= Add1_out1 WHEN CompareToZero1_out1 = '0' ELSE
      Constant_out1_3;
  ...
  Switch2_out1_6 <= Switch_out1_4 WHEN CompareToZero1_out1 = '0' ELSE
      Constant1_out1_5;

  -- Combine FP sign, exponent, mantissa into 32 bit word
  nfp_out_pack <= Switch3_out1 & Switch1_out1_7 & Switch2_out1_6;
