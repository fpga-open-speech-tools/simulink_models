...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_nl_pla_filter_nfp_signum_single
-- Source Path: nl_pla_filter/Subsystem/nfp_signum_single
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ur_ear_fpga_sim_nl_pla_filter_nfp_signum_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_nl_pla_filter_nfp_signum_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_nl_pla_filter_nfp_signum_single IS
