-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\redocking_site\ur_ear_fpga_sim_redocking_site_nfp_sub_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_redocking_site_nfp_sub_single
-- Source Path: redocking_site/calc_Tref/nfp_sub_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_redocking_site_nfp_sub_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_redocking_site_nfp_sub_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_redocking_site_nfp_sub_single IS
