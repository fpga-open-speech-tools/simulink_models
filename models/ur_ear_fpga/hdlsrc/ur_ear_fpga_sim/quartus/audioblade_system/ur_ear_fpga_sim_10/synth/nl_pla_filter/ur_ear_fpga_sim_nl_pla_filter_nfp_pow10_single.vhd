...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_nl_pla_filter_nfp_pow10_single
-- Source Path: nl_pla_filter/Subsystem/nfp_pow10_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_nl_pla_filter_nfp_pow10_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_nl_pla_filter_nfp_pow10_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_nl_pla_filter_nfp_pow10_single IS
...
BEGIN
  ...
  exp_cor_1_add_temp <= resize(if_Exponent_0_out1, 9) + resize(C1_out1_1, 9);
  ...
  if_bitget_tmp2_tmp2_WordLength_out1 <= exp_cor_1_out1 WHEN BitSlice_out1 = '0' ELSE
      exp_cor_2_out1;
  ...
  if_aSign_out1_1 <= C1_out1_2 WHEN aSign = '0' ELSE
      C_out1_3;
