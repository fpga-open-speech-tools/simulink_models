-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\ohc_nonlinear_filter\ur_ear_fpga_sim_ohc_nonlinear_filter_nfp_relop_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_ohc_nonlinear_filter_nfp_relop_single
...
ENTITY ur_ear_fpga_sim_ohc_nonlinear_filter_nfp_relop_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END ur_ear_fpga_sim_ohc_nonlinear_filter_nfp_relop_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_ohc_nonlinear_filter_nfp_relop_single IS
