-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\cp_wideband_gammatone_filter\ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single
-- Source Path: cp_wideband_gammatone_filter/Calculate wbout/nfp_relop_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_cp_wideband_gammatone_filter_nfp_relop_single IS
...
BEGIN
  ...
  Logical_Operator2_out1_1 <=  NOT Constant8_out1;

  Logical_Operator4_out1 <=  NOT Relational_Operator4_relop1;

  Logical_Operator1_out1_1 <= Relational_Operator5_relop1 AND Logical_Operator4_out1;
  ...
  Logical_Operator3_out1_1 <= Logical_Operator1_out1_1 OR Logical_Operator2_out1_2;

  Logical_Operator1_out1_2 <= Logical_Operator2_out1_1 OR Logical_Operator3_out1_1;
  ...
  Logical_Operator4_out1_3 <=  NOT Logical_Operator3_out1_2;
