-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\redocking_site\ur_ear_fpga_sim_redocking_site_Current_Refactory_Component.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_redocking_site_Current_Refactory_Component
...
ENTITY ur_ear_fpga_sim_redocking_site_Current_Refactory_Component IS
...
END ur_ear_fpga_sim_redocking_site_Current_Refactory_Component;


ARCHITECTURE rtl OF ur_ear_fpga_sim_redocking_site_Current_Refactory_Component IS
...
BEGIN
  ...
  u_nfp_add_comp : ur_ear_fpga_sim_redocking_site_nfp_add_single
    PORT MAP( nfp_in1 => current_release_times,  -- ufix32
              nfp_in2 => Tref,  -- ufix32
  ...
  current_refactory_period <= Switch_out1;
