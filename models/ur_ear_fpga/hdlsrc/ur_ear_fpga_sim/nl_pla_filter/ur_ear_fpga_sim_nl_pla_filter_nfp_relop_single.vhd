...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_nl_pla_filter_nfp_relop_single
-- Source Path: nl_pla_filter/nfp_relop_single
-- Hierarchy Level: 6
-- 
...
ENTITY ur_ear_fpga_sim_nl_pla_filter_nfp_relop_single IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END ur_ear_fpga_sim_nl_pla_filter_nfp_relop_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_nl_pla_filter_nfp_relop_single IS
