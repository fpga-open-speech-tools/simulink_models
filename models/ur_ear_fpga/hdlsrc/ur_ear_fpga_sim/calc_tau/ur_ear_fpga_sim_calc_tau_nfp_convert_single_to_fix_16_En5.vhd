-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\calc_tau\ur_ear_fpga_sim_calc_tau_nfp_convert_single_to_fix_16_En5.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_calc_tau_nfp_convert_single_to_fix_16_En5
-- Source Path: calc_tau/write address generator/nfp_convert_single_to_fix_16_En5
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_calc_tau_nfp_convert_single_to_fix_16_En5 IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- ufix16
        );
END ur_ear_fpga_sim_calc_tau_nfp_convert_single_to_fix_16_En5;


ARCHITECTURE rtl OF ur_ear_fpga_sim_calc_tau_nfp_convert_single_to_fix_16_En5 IS
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(34 DOWNTO 0);  -- ufix35_En24
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(34 DOWNTO 0);  -- ufix35_En24
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Switch1_out1                     : unsigned(34 DOWNTO 0);  -- ufix35_En24
  SIGNAL Data_Type_Conversion1_out1_2     : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Unary_Minus_cast                 : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Unary_Minus_cast_1               : signed(36 DOWNTO 0);  -- sfix37_En24
  SIGNAL Unary_Minus_out1                 : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Switch1_out1_1                   : signed(35 DOWNTO 0);  -- sfix36_En24
  SIGNAL Data_Type_Conversion2_out1       : unsigned(15 DOWNTO 0);  -- ufix16_En5
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Data_Type_Conversion1_out1 & '0', 35);
  ...
  Data_Type_Conversion1_out1_1 <= resize(Data_Type_Conversion1_out1 & '0', 35);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Switch1_out1, 36));

  Unary_Minus_cast <= resize(Data_Type_Conversion1_out1_2, 37);
  ...
  Data_Type_Conversion2_out1 <= unsigned(Switch1_out1_1(34 DOWNTO 19)) + ('0' & Switch1_out1_1(18));
