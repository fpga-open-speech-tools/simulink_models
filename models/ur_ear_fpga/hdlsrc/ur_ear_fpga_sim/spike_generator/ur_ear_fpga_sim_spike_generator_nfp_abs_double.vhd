-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\spike_generator\ur_ear_fpga_sim_spike_generator_nfp_abs_double.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_spike_generator_nfp_abs_double
...
ENTITY ur_ear_fpga_sim_spike_generator_nfp_abs_double IS
  PORT( nfp_in                            :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
        nfp_out                           :   OUT   std_logic_vector(63 DOWNTO 0)  -- ufix64
        );
END ur_ear_fpga_sim_spike_generator_nfp_abs_double;


ARCHITECTURE rtl OF ur_ear_fpga_sim_spike_generator_nfp_abs_double IS
