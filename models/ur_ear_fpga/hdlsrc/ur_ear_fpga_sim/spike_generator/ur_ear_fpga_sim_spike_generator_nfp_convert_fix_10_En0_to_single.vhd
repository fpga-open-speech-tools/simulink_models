-- -------------------------------------------------------------
-- 
-- File Name: D:\NIH3Repo\simulink_models\models\ur_ear_fpga\hdlsrc\ur_ear_fpga_sim\spike_generator\ur_ear_fpga_sim_spike_generator_nfp_convert_fix_10_En0_to_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: ur_ear_fpga_sim_spike_generator_nfp_convert_fix_10_En0_to_single
-- Source Path: spike_generator/Redocking Calculation/Current Redock Component/nfp_convert_fix_10_En0_to_single
-- Hierarchy Level: 7
-- 
...
ENTITY ur_ear_fpga_sim_spike_generator_nfp_convert_fix_10_En0_to_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(9 DOWNTO 0);  -- ufix10
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END ur_ear_fpga_sim_spike_generator_nfp_convert_fix_10_En0_to_single;


ARCHITECTURE rtl OF ur_ear_fpga_sim_spike_generator_nfp_convert_fix_10_En0_to_single IS
  ...
  SIGNAL Unary_Minus_cast                 : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Unary_Minus_cast_1               : signed(10 DOWNTO 0);  -- sfix11
  SIGNAL Unary_Minus_cast_2               : signed(10 DOWNTO 0);  -- sfix11
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN nfp_in_unsigned = to_unsigned(16#000#, 10) ELSE
      '0';
  ...
  Data_Type_Conversion1_out1 <= signed(nfp_in_unsigned);

  Unary_Minus_cast <= unsigned(Data_Type_Conversion1_out1);
  Unary_Minus_cast_1 <= signed(resize(Unary_Minus_cast, 11));
  Unary_Minus_cast_2 <=  - (Unary_Minus_cast_1);
  Unary_Minus_out1 <= unsigned(Unary_Minus_cast_2(9 DOWNTO 0));

  
  Switch_out1 <= nfp_in_unsigned WHEN Logical_Operator_out1 = '0' ELSE
      Unary_Minus_out1;
  ...
  Shift_Arithmetic_out1 <= Data_Type_Conversion_out1 sll to_integer(dynamic_shift_selsig);
