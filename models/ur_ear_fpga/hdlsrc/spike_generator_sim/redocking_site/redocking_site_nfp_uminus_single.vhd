-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\spike_generator_sim\redocking_site\redocking_site_nfp_uminus_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: redocking_site_nfp_uminus_single
...
ENTITY redocking_site_nfp_uminus_single IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END redocking_site_nfp_uminus_single;


ARCHITECTURE rtl OF redocking_site_nfp_uminus_single IS
