-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\spike_generator_sim\redocking_site\redocking_site_nfp_convert_single_to_fix_32_En0.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: redocking_site_nfp_convert_single_to_fix_32_En0
...
ENTITY redocking_site_nfp_convert_single_to_fix_32_En0 IS
...
END redocking_site_nfp_convert_single_to_fix_32_En0;


ARCHITECTURE rtl OF redocking_site_nfp_convert_single_to_fix_32_En0 IS
  ...
  SIGNAL Delay4_out1_1                    : unsigned(55 DOWNTO 0);  -- ufix56_En24
  ...
  SIGNAL Delay6_out1                      : unsigned(55 DOWNTO 0);  -- ufix56_En24
  SIGNAL Switch1_out1                     : unsigned(55 DOWNTO 0);  -- ufix56_En24
  SIGNAL Delay9_out1                      : unsigned(55 DOWNTO 0);  -- ufix56_En24
  ...
  SIGNAL Delay8_out1                      : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 56);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay4_out1_1 <= to_unsigned(0, 56);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 56);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 57));
