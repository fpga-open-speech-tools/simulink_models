-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\spike_generator_sim\redocking_site\redocking_site_unitRateInterval_Component.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: redocking_site_unitRateInterval_Component
...
ENTITY redocking_site_unitRateInterval_Component IS
...
END redocking_site_unitRateInterval_Component;


ARCHITECTURE rtl OF redocking_site_unitRateInterval_Component IS
  ...
  SIGNAL Switch3_control_abs_1            : std_logic_vector(63 DOWNTO 0);  -- ufix64
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Switch3_control_abs_1 <= X"0000000000000000";
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
        Switch3_control_abs_1 <= Switch3_control_abs;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb_1_2048_1 = '1' THEN
        Delay_bypass_reg <= Switch3_out1;
      END IF;
    END IF;
  END PROCESS Delay_bypass_process;

  
  Switch3_out1_1 <= Switch3_out1 WHEN enb_1_2048_1 = '1' ELSE
      Delay_bypass_reg;

  Delay_out1 <= Switch3_out1_1;
  ...
  Switch3_out1 <= Switch1_out1 WHEN Switch3_control_abs_1 = X"0000000000000000" ELSE
      Constant_out1;
  ...
  BEGIN
    ...
    ELSIF rising_edge(clk) THEN
      IF enb_1_2048_1 = '1' THEN
        Delay1_bypass_reg <= Switch3_out1;
      END IF;
    END IF;
  END PROCESS Delay1_bypass_process;

  
  Switch3_out1_2 <= Switch3_out1 WHEN enb_1_2048_1 = '1' ELSE
      Delay1_bypass_reg;

  unitRateInterval <= Switch3_out1_2;
