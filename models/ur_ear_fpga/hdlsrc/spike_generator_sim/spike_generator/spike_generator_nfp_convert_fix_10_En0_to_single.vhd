-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\spike_generator_sim\spike_generator\spike_generator_nfp_convert_fix_10_En0_to_single.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: spike_generator_nfp_convert_fix_10_En0_to_single
...
ENTITY spike_generator_nfp_convert_fix_10_En0_to_single IS
...
END spike_generator_nfp_convert_fix_10_En0_to_single;


ARCHITECTURE rtl OF spike_generator_nfp_convert_fix_10_En0_to_single IS
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_unsigned(16#000#, 10) ELSE
      '0';
