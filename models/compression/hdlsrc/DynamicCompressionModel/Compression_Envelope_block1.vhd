-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Compression_Envelope_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Compression_Envelope_block1
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_3/Compression_Envelope
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Compression_Envelope_block1 IS
...
END Compression_Envelope_block1;


ARCHITECTURE rtl OF Compression_Envelope_block1 IS

  -- Component Declarations
  COMPONENT Release_Envelope_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Attack_Envelope_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Curr                            :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  FOR ALL : Release_Envelope_block1
    USE ENTITY work.Release_Envelope_block1(rtl);

  FOR ALL : Attack_Envelope_block1
    USE ENTITY work.Attack_Envelope_block1(rtl);
...
BEGIN
  ...
  u_Release_Envelope : Release_Envelope_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Attack_Envelope : Attack_Envelope_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Curr => Curr_Gain,  -- sfix32_En28
