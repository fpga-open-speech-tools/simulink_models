-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Linear_Approximation_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Linear_Approximation_block2
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_4/Compression_Gain_Calc/Linear_Approximation
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Linear_Approximation_block2 IS
...
END Linear_Approximation_block2;


ARCHITECTURE rtl OF Linear_Approximation_block2 IS

  -- Component Declarations
  COMPONENT LSR_N_block2
  ...
  FOR ALL : LSR_N_block2
    USE ENTITY work.LSR_N_block2(rtl);

  FOR ALL : LSL_N_block5
    USE ENTITY work.LSL_N_block5(rtl);
