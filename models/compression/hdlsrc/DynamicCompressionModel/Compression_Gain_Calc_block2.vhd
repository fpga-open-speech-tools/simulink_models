-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Compression_Gain_Calc_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Compression_Gain_Calc_block2
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_4/Compression_Gain_Calc
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Compression_Gain_Calc_block2 IS
...
END Compression_Gain_Calc_block2;


ARCHITECTURE rtl OF Compression_Gain_Calc_block2 IS

  -- Component Declarations
  COMPONENT LogAddressing_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT High_Gain_Table_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Low_Gain_Table_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          wr_din                          :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  COMPONENT Linear_Approximation_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LogAddressing_block2
    USE ENTITY work.LogAddressing_block2(rtl);

  FOR ALL : High_Gain_Table_block2
    USE ENTITY work.High_Gain_Table_block2(rtl);

  FOR ALL : Low_Gain_Table_block2
    USE ENTITY work.Low_Gain_Table_block2(rtl);

  FOR ALL : Linear_Approximation_block2
    USE ENTITY work.Linear_Approximation_block2(rtl);
...
BEGIN
  ...
  u_LogAddressing : LogAddressing_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_High_Gain_Table : High_Gain_Table_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Low_Gain_Table : Low_Gain_Table_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              wr_din => Table_Fill,  -- sfix32_En28
  ...
  u_Linear_Approximation : Linear_Approximation_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
