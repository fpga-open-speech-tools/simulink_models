-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Compression_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Compression_4
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_4
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Compression_4 IS

  -- Component Declarations
  COMPONENT Compression_Gain_Calc_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Compression_Envelope_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Compression_Gain_Calc_block2
    USE ENTITY work.Compression_Gain_Calc_block2(rtl);

  FOR ALL : Compression_Envelope_block2
    USE ENTITY work.Compression_Envelope_block2(rtl);
...
BEGIN
  ...
  u_Compression_Gain_Calc : Compression_Gain_Calc_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Compression_Envelope : Compression_Envelope_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
