-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\LogAddressing_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LogAddressing_block2
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_4/Compression_Gain_Calc/LogAddressing
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LogAddressing_block2 IS
...
END LogAddressing_block2;


ARCHITECTURE rtl OF LogAddressing_block2 IS
  ...
  FOR ALL : LSL_N_block6
    USE ENTITY work.LSL_N_block6(rtl);
