-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\LogAddressing_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LogAddressing_block3
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_5/Compression_Gain_Calc/LogAddressing
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LogAddressing_block3 IS
...
END LogAddressing_block3;


ARCHITECTURE rtl OF LogAddressing_block3 IS
  ...
  FOR ALL : LSL_N_block8
    USE ENTITY work.LSL_N_block8(rtl);
