-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\LogAddressing_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LogAddressing_block
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_2/Compression_Gain_Calc/LogAddressing
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END LogAddressing_block;


ARCHITECTURE rtl OF LogAddressing_block IS
  ...
  FOR ALL : LSL_N_block2
    USE ENTITY work.LSL_N_block2(rtl);
