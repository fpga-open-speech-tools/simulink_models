-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Linear_Approximation_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Linear_Approximation_block3
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_5/Compression_Gain_Calc/Linear_Approximation
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Linear_Approximation_block3 IS
...
END Linear_Approximation_block3;


ARCHITECTURE rtl OF Linear_Approximation_block3 IS

  -- Component Declarations
  COMPONENT LSR_N_block3
  ...
  FOR ALL : LSR_N_block3
    USE ENTITY work.LSR_N_block3(rtl);

  FOR ALL : LSL_N_block7
    USE ENTITY work.LSL_N_block7(rtl);
