-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Linear_Approximation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Linear_Approximation
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_1/Compression_Gain_Calc/Linear_Approximation
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Linear_Approximation IS
...
END Linear_Approximation;


ARCHITECTURE rtl OF Linear_Approximation IS
  ...
  FOR ALL : LSR_N
    USE ENTITY work.LSR_N(rtl);

  FOR ALL : LSL_N
    USE ENTITY work.LSL_N(rtl);
