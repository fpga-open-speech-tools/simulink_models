-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Compression_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Compression_2
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Compression_2 IS

  -- Component Declarations
  COMPONENT Compression_Gain_Calc_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Compression_Envelope_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Compression_Gain_Calc_block
    USE ENTITY work.Compression_Gain_Calc_block(rtl);

  FOR ALL : Compression_Envelope_block
    USE ENTITY work.Compression_Envelope_block(rtl);
...
BEGIN
  ...
  u_Compression_Gain_Calc : Compression_Gain_Calc_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Compression_Envelope : Compression_Envelope_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
