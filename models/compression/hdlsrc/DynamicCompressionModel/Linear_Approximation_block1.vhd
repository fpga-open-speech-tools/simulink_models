-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\DynamicCompressionModel\Linear_Approximation_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Linear_Approximation_block1
-- Source Path: DynamicCompressionModel/recalculate/Nchan_FbankAGC_AID/Compression_3/Compression_Gain_Calc/Linear_Approximation
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Linear_Approximation_block1 IS
...
END Linear_Approximation_block1;


ARCHITECTURE rtl OF Linear_Approximation_block1 IS

  -- Component Declarations
  COMPONENT LSR_N_block1
  ...
  FOR ALL : LSR_N_block1
    USE ENTITY work.LSR_N_block1(rtl);

  FOR ALL : LSL_N_block3
    USE ENTITY work.LSL_N_block3(rtl);
