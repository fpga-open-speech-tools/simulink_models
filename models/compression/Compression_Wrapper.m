function [G_out, xp_spacing, max_gain_prescript, Xp_in] = Compression_Wrapper(fs, X_low_thresh_dB, X_high, bpf_coeff, prescript_FIR_coeff, ref_dB, X_ref)
%% ig_eq, calib_bpfs
...
% Define a 64 point linearly spaced range of inputs
xp_spacing = (X_high-X_thresh)*max_gain_prescript/63;
Xp_in = X_thresh*max_gain_prescript:xp_spacing:X_high*max_gain_prescript;

[G_out] = Populate_Band_Compression_Lookup_Gain ...
    (Xp_in, X_high, X_thresh, safe_max, max_gain_prescript);
