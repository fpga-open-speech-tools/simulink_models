-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\mc_gr\Desktop\FPGA Open Speech Tools\simulink_models\models\pFIR_Testing\hdlsrc\pFIR_Testing\pFIR_Testing_Programmable_Upclocked_FIR_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: pFIR_Testing_Programmable_Upclocked_FIR_block
...
END pFIR_Testing_Programmable_Upclocked_FIR_block;


ARCHITECTURE rtl OF pFIR_Testing_Programmable_Upclocked_FIR_block IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT pFIR_Testing_Addr_Gen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
          enb_1_2048_0                    :   IN    std_logic;
  ...
  COMPONENT pFIR_Testing_B_k_Memory_Block2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  COMPONENT pFIR_Testing_Multiply_And_Sum_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_4_0                       :   IN    std_logic;
  ...
  FOR ALL : pFIR_Testing_Addr_Gen_block
    USE ENTITY work.pFIR_Testing_Addr_Gen_block(rtl);

  FOR ALL : pFIR_Testing_SimpleDualPortRAM_generic
    USE ENTITY work.pFIR_Testing_SimpleDualPortRAM_generic(rtl);

  FOR ALL : pFIR_Testing_B_k_Memory_Block2_block
    USE ENTITY work.pFIR_Testing_B_k_Memory_Block2_block(rtl);
...
BEGIN
  ...
  u_B_k_Memory_Block2 : pFIR_Testing_B_k_Memory_Block2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  u_Multiply_And_Sum : pFIR_Testing_Multiply_And_Sum_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_4_0 => enb_1_4_0,
  ...
  Rate_Transition6_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Rate_Transition6_out1 <= to_signed(0, 32);
    ELSIF rising_edge(clk) THEN
      IF enb_1_4_0 = '1' THEN
        Rate_Transition6_out1 <= B_k_Memory_Block2_out1_signed;
      END IF;
    END IF;
  END PROCESS Rate_Transition6_process;
