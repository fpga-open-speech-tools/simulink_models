-- -------------------------------------------------------------
-- 
-- File Name: /home/justin/Documents/FEI/simulink_models/models/short_window_mean_reduction/hdlsrc/MNR/MNR_Adaptive_Wiener_Filter_Sample_Based_Filtering.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: MNR_Adaptive_Wiener_Filter_Sample_Based_Filtering
-- Source Path: MNR/dataplane/Adaptive_Wiener_Filter Sample Based Filtering
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY MNR_Adaptive_Wiener_Filter_Sample_Based_Filtering IS
...
END MNR_Adaptive_Wiener_Filter_Sample_Based_Filtering;


ARCHITECTURE rtl OF MNR_Adaptive_Wiener_Filter_Sample_Based_Filtering IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT MNR_Right_Channel_Processing1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT MNR_Right_Channel_Processing
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : MNR_Right_Channel_Processing1
    USE ENTITY work.MNR_Right_Channel_Processing1(rtl);

  FOR ALL : MNR_Right_Channel_Processing
    USE ENTITY work.MNR_Right_Channel_Processing(rtl);
...
BEGIN
  ...
  u_Right_Channel_Processing1 : MNR_Right_Channel_Processing1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Right_Channel_Processing : MNR_Right_Channel_Processing
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
