...
set_interface_property avalon_streaming_sink_1 maxChannel 3
...
add_interface_port avalon_streaming_sink_1 avalon_sink_data data Input 32
add_interface_port avalon_streaming_sink_1 avalon_sink_channel channel Input 2
add_interface_port avalon_streaming_sink_1 avalon_sink_error error Input 2
add_interface_port avalon_streaming_sink_1 avalon_sink_valid valid Input 1
