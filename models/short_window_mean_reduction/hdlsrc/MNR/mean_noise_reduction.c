...
static struct platform_driver mean_noise_reduction_platform = {
  ...
  .driver = {
    .name = "Flat Earth mean_noise_reduction Driver",
    .owner = THIS_MODULE,
...
static int mean_noise_reduction_init(void) {
  printk(KERN_ALERT "FUNCTION AUTO GENERATED AT: 2019-11-19 18:04\n");
  int ret_val = 0;
  ...
  pr_info("Flat Earth mean_noise_reduction module successfully initialized!\n");
  return 0;
}
...
static void mean_noise_reduction_exit(void) {
  pr_info("Flat Earth mean_noise_reduction module exit\n");
  platform_driver_unregister(&mean_noise_reduction_platform);
  pr_info("Flat Earth mean_noise_reduction module successfully unregistered\n");
}
