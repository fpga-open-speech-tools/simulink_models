-- -------------------------------------------------------------
-- 
-- File Name: /home/justin/Documents/Flat Earth Inc/simulink_models/simulink_models/models/short_window_mean_reduction/hdlsrc/mean_noise_reduction/mean_noise_reduction_dataplane.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: mean_noise_reduction_dataplane
-- Source Path: mean_noise_reduction/dataplane
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mean_noise_reduction_dataplane IS
...
END mean_noise_reduction_dataplane;


ARCHITECTURE rtl OF mean_noise_reduction_dataplane IS

  -- Component Declarations
  COMPONENT mean_noise_reduction_Adaptive_Wiener_Filter_Sample_Based_Filtering
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mean_noise_reduction_Adaptive_Wiener_Filter_Sample_Based_Filtering
    USE ENTITY work.mean_noise_reduction_Adaptive_Wiener_Filter_Sample_Based_Filtering(rtl);
...
BEGIN
  ...
  u_Adaptive_Wiener_Filter_Sample_Based_Filtering : mean_noise_reduction_Adaptive_Wiener_Filter_Sample_Based_Filtering
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
