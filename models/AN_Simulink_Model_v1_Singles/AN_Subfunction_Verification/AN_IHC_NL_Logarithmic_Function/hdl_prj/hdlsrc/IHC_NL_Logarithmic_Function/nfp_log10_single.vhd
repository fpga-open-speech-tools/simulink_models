...
-- Source Path: IHC_NL_Logarithmic_Function/IHC NL Logarithmic Function Singles/Subsystem/nfp_log10_single
-- Hierarchy Level: 2
-- 
...
END nfp_log10_single;


ARCHITECTURE rtl OF nfp_log10_single IS
  ...
  SIGNAL Delay9_reg                       : std_logic_vector(0 TO 14);  -- ufix1 [15]
  SIGNAL Delay9_reg_next                  : std_logic_vector(0 TO 14);  -- ufix1 [15]
  ...
  SIGNAL Delay15_reg_next                 : vector_of_signed11(0 TO 7);  -- sfix11 [8]
  ...
  SIGNAL Delay7_reg                       : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay7_reg_next                  : std_logic_vector(0 TO 5);  -- ufix1 [6]
  ...
  SIGNAL Delay19_out1                     : signed(35 DOWNTO 0);  -- sfix36_En33
  ...
  SIGNAL Delay18_out1                     : signed(40 DOWNTO 0);  -- sfix41_En38
  ...
  SIGNAL Delay5_reg_1                     : vector_of_signed50(0 TO 4);  -- sfix50 [5]
  SIGNAL Delay5_reg_next_1                : vector_of_signed50(0 TO 4);  -- sfix50_En47 [5]
  SIGNAL Delay5_out1_1                    : signed(49 DOWNTO 0);  -- sfix50_En47
  ...
  SIGNAL Delay22_out1                     : signed(29 DOWNTO 0);  -- sfix30_En25
  ...
  SIGNAL Delay3_out1_2                    : unsigned(25 DOWNTO 0);  -- ufix26_En25
  ...
  SIGNAL Delay24_out1_1                   : signed(29 DOWNTO 0);  -- sfix30_En25
  ...
  SIGNAL Delay4_out1_3                    : unsigned(25 DOWNTO 0);  -- ufix26_En25
  ...
  SIGNAL Delay8_out1_1                    : signed(49 DOWNTO 0);  -- sfix50_En47
  ...
  SIGNAL Delay2_out1_1                    : std_logic;  -- ufix1
  ...
  SIGNAL Delay6_reg_next                  : std_logic_vector(0 TO 14);  -- ufix1 [15]
  ...
  SIGNAL Delay1_out1_2                    : signed(57 DOWNTO 0);  -- sfix58_En47
  ...
  SIGNAL Delay18_out1_1                   : unsigned(23 DOWNTO 0);  -- ufix24
  SIGNAL Bit_Concat_out1_12               : unsigned(24 DOWNTO 0);  -- ufix25
  SIGNAL BitSlice1_out1_2                 : std_logic;  -- ufix1
  SIGNAL Delay22_reg                      : std_logic_vector(0 TO 11);  -- ufix1 [12]
  SIGNAL Delay22_reg_next                 : std_logic_vector(0 TO 11);  -- ufix1 [12]
  SIGNAL Delay22_out1_1                   : std_logic;  -- ufix1
  ...
  SIGNAL Delay7_reg_1                     : vector_of_unsigned8(0 TO 14);  -- ufix8 [15]
  SIGNAL Delay7_reg_next_1                : vector_of_unsigned8(0 TO 14);  -- ufix8 [15]
  ...
  SIGNAL Delay8_reg_1                     : vector_of_unsigned23(0 TO 14);  -- ufix23 [15]
  SIGNAL Delay8_reg_next_1                : vector_of_unsigned23(0 TO 14);  -- ufix23 [15]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay8_out1 <= reinterpretcast_bitsliceget_w_1_out1;
      END IF;
    END IF;
  ...
  L_Log10Table_4_1_out1 <= Delay8_out1 + Delay17_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay19_out1 <= if_w_hat_0_75_out1_4;
      END IF;
    END IF;
  END PROCESS Delay19_process;


  L_Log10Table_6_1_out1 <= Delay10_out1 + Delay19_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay12_out1_1 <= reinterpretcast_bitsliceget_w_1_out1_7;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay18_out1 <= to_signed(0, 41);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay18_out1 <= if_w_hat_0_75_out1_9;
      END IF;
    END IF;
  END PROCESS Delay18_process;


  L_Log10Table_10_out1 <= Delay12_out1_1 + Delay18_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay5_reg_1(0) <= to_signed(0, 50);
      Delay5_reg_1(1) <= to_signed(0, 50);
      Delay5_reg_1(2) <= to_signed(0, 50);
      Delay5_reg_1(3) <= to_signed(0, 50);
      Delay5_reg_1(4) <= to_signed(0, 50);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay5_out1_1 <= Delay5_reg_1(4);
  Delay5_reg_next_1(0) <= reinterpretcast_bitconcat_L_f_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay22_out1 <= to_signed(16#00000000#, 30);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay22_out1 <= if_sign_1_out1;
      END IF;
    END IF;
  ...
  w_abs_2_out1 <= '1' WHEN Delay22_out1 >= to_signed(16#04000000#, 30) ELSE
      '0';

  Bit_Slice_out1 <= unsigned(Delay22_out1(25 DOWNTO 0));
  ...
  bitsll_w_abs_j_out1 <= Delay22_out1 sll to_integer(dynamic_shift_selsig);

  bitsra_w_abs_1_out1 <= SHIFT_RIGHT(Delay22_out1, 1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay3_out1_2 <= reinterpretcast_bitsliceget_tm_out1;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay24_out1_1 <= to_signed(16#00000000#, 30);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay24_out1_1 <= alpha1_tmp1_out1;
      END IF;
    END IF;
  END PROCESS Delay24_1_process;


  BitSlice2_out1 <= unsigned(Delay24_out1_1(25 DOWNTO 0));
  ...
  BEGIN
    IF reset = '1' THEN
      Delay4_out1_3 <= to_unsigned(16#0000000#, 26);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  tmp_m1_tmp_m2_mul_temp <= Delay3_out1_2 * Delay4_out1_3;
  ...
  if_sign_1_out1_1 <= Log4rt10E_out1 WHEN Delay1_out1_1 = '0' ELSE
      alphaLog4rt10E_out1;
  ...
  tmp3_Log4rt10E_mul_temp <= tmp3_Log4rt10E_cast * Delay6_out1;
  ...
  bitsra_appx_shift_out1 <= SHIFT_RIGHT(Delay8_out1_1, to_integer(dynamic_shift_selsig_1));

  L_tmp4_out1 <= Delay5_out1_1 + bitsra_appx_shift_out1;

  
  if_w_0_out1 <= Delay5_out1_1 WHEN Delay7_out1 = '0' ELSE
      L_tmp4_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay2_out1_1 <= BitSlice_out1_13;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay1_out1_2 <= to_signed(0, 58);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_out1_2 <= Switch_out1_5;
      END IF;
    END IF;
  END PROCESS Delay1_2_process;


  BitSlice1_out1_1 <= unsigned(Delay1_out1_2(56 DOWNTO 0));
  ...
  BEGIN
    IF reset = '1' THEN
      Delay18_out1_1 <= to_unsigned(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay18_out1_1 <= BitSlice2_out1_1;
      END IF;
    END IF;
  END PROCESS Delay18_1_process;


  Bit_Concat_out1_12 <= alpha0_out1_2 & Delay18_out1_1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay22_reg(7) <= Delay22_reg_next(7);
        Delay22_reg(8) <= Delay22_reg_next(8);
        Delay22_reg(9) <= Delay22_reg_next(9);
        Delay22_reg(10) <= Delay22_reg_next(10);
        Delay22_reg(11) <= Delay22_reg_next(11);
      END IF;
    END IF;
  END PROCESS Delay22_1_process;

  Delay22_out1_1 <= Delay22_reg(11);
  Delay22_reg_next(0) <= bitsliceget_mant_norm_mant_no_out1;
  Delay22_reg_next(1) <= Delay22_reg(0);
  Delay22_reg_next(2) <= Delay22_reg(1);
  Delay22_reg_next(3) <= Delay22_reg(2);
  Delay22_reg_next(4) <= Delay22_reg(3);
  Delay22_reg_next(5) <= Delay22_reg(4);
  Delay22_reg_next(6) <= Delay22_reg(5);
  Delay22_reg_next(7) <= Delay22_reg(6);
  Delay22_reg_next(8) <= Delay22_reg(7);
  Delay22_reg_next(9) <= Delay22_reg(8);
  Delay22_reg_next(10) <= Delay22_reg(9);
  Delay22_reg_next(11) <= Delay22_reg(10);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_out1_3 <= Delay20_out1;
      END IF;
    END IF;
  END PROCESS Delay1_3_process;


  alphabitget_Mant_tmp_2_0_out1 <= BitSlice1_out1_2 OR Delay1_out1_3;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay17_out1_1 <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay17_out1_1 <= Switch1_out1_14;
      END IF;
    END IF;
  ...
  Exp_cast_1_like_Exp_out1 <= Delay17_out1_1 + cast_1_like_Exp_out1;

  
  if_bitget_Mant_tmp_Mant_tmp_Wor_out1 <= Delay17_out1_1 WHEN BitSlice2_out1_2 = '0' ELSE
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      Delay7_reg_1(3) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(4) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(5) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(6) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(7) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(8) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(9) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(10) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(11) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(12) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(13) <= to_unsigned(16#00#, 8);
      Delay7_reg_1(14) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay7_out1_1 <= Delay7_reg_1(14);
  Delay7_reg_next_1(0) <= if_aExponent_0_out1;
  ...
  Delay7_reg_next_1(9) <= Delay7_reg_1(8);
  Delay7_reg_next_1(10) <= Delay7_reg_1(9);
  Delay7_reg_next_1(11) <= Delay7_reg_1(10);
  Delay7_reg_next_1(12) <= Delay7_reg_1(11);
  Delay7_reg_next_1(13) <= Delay7_reg_1(12);
  Delay7_reg_next_1(14) <= Delay7_reg_1(13);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay4_out1_4 <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay4_out1_4 <= Switch6_out1_10;
      END IF;
    END IF;
  ...
  nfp_out_pack <= Delay3_out1_3 & Delay4_out1_4 & Delay5_out1_2;
