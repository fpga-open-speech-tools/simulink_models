...
-- -------------------------------------------------------------
-- 
-- Module: nfp_log_single
-- Source Path: IHC_NL_Logarithmic_Function/IHC NL Logarithmic Function Singles/nfp_log_single
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_log_single IS
  ...
  SIGNAL Delay9_PS_2_26_reg               : std_logic_vector(0 TO 17);  -- ufix1 [18]
  SIGNAL Delay9_PS_2_26_reg_next          : std_logic_vector(0 TO 17);  -- ufix1 [18]
  ...
  SIGNAL Delay15_PS_6_18_reg_next         : vector_of_signed11(0 TO 8);  -- sfix11 [9]
  ...
  SIGNAL Delay2_PS_19_20_reg_next         : vector_of_signed37(0 TO 1);  -- sfix37_En26 [2]
  SIGNAL Delay2_PS_19_20_out1             : signed(36 DOWNTO 0);  -- sfix37_En26
  SIGNAL Delay1_PS_19_20_reg              : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay1_PS_19_20_reg_next         : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay_PS_19_20_reg               : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay_PS_19_20_reg_next          : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay7_PS_19_20_reg              : std_logic_vector(0 TO 4);  -- ufix1 [5]
  SIGNAL Delay7_PS_19_20_reg_next         : std_logic_vector(0 TO 4);  -- ufix1 [5]
  ...
  SIGNAL Delay5_PS_19_20_reg_next         : vector_of_signed50(0 TO 4);  -- sfix50_En47 [5]
  SIGNAL Delay5_PS_19_20_out1             : signed(49 DOWNTO 0);  -- sfix50_En47
  SIGNAL BitSlice_out1_11                 : std_logic;  -- ufix1
  SIGNAL Delay16_PS_17_18_reg             : std_logic_vector(0 TO 2);  -- ufix1 [3]
  SIGNAL Delay16_PS_17_18_reg_next        : std_logic_vector(0 TO 2);  -- ufix1 [3]
  ...
  SIGNAL Delay14_PS_17_18_reg_next        : vector_of_unsigned52(0 TO 1);  -- ufix52_En50 [2]
  ...
  SIGNAL Delay9_PS_19_20_reg_next         : vector_of_signed8(0 TO 4);  -- sfix8 [5]
  ...
  SIGNAL Delay8_PS_19_20_reg_next         : vector_of_signed50(0 TO 1);  -- sfix50_En47 [2]
  ...
  SIGNAL Delay3_PS_25_reg                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay3_PS_25_reg_next            : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay6_PS_2_26_reg               : std_logic_vector(0 TO 17);  -- ufix1 [18]
  SIGNAL Delay6_PS_2_26_reg_next          : std_logic_vector(0 TO 17);  -- ufix1 [18]
  ...
  SIGNAL Delay1_PS_26_reg                 : std_logic_vector(0 TO 15);  -- ufix1 [16]
  SIGNAL Delay1_PS_26_reg_next            : std_logic_vector(0 TO 15);  -- ufix1 [16]
  ...
  SIGNAL Delay7_PS_2_26_reg_next          : vector_of_unsigned8(0 TO 17);  -- ufix8 [18]
  ...
  SIGNAL Delay8_PS_2_26_reg_next          : vector_of_unsigned23(0 TO 17);  -- ufix23 [18]
...
BEGIN
  ...
  Delay9_PS_2_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay9_PS_2_26_reg(0) <= '0';
      Delay9_PS_2_26_reg(1) <= '0';
      Delay9_PS_2_26_reg(2) <= '0';
      Delay9_PS_2_26_reg(3) <= '0';
      Delay9_PS_2_26_reg(4) <= '0';
      Delay9_PS_2_26_reg(5) <= '0';
      Delay9_PS_2_26_reg(6) <= '0';
      Delay9_PS_2_26_reg(7) <= '0';
      Delay9_PS_2_26_reg(8) <= '0';
      Delay9_PS_2_26_reg(9) <= '0';
      Delay9_PS_2_26_reg(10) <= '0';
      Delay9_PS_2_26_reg(11) <= '0';
      Delay9_PS_2_26_reg(12) <= '0';
      Delay9_PS_2_26_reg(13) <= '0';
      Delay9_PS_2_26_reg(14) <= '0';
      Delay9_PS_2_26_reg(15) <= '0';
      Delay9_PS_2_26_reg(16) <= '0';
      Delay9_PS_2_26_reg(17) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay9_PS_2_26_reg(0) <= Delay9_PS_2_26_reg_next(0);
        Delay9_PS_2_26_reg(1) <= Delay9_PS_2_26_reg_next(1);
        Delay9_PS_2_26_reg(2) <= Delay9_PS_2_26_reg_next(2);
        Delay9_PS_2_26_reg(3) <= Delay9_PS_2_26_reg_next(3);
        Delay9_PS_2_26_reg(4) <= Delay9_PS_2_26_reg_next(4);
        Delay9_PS_2_26_reg(5) <= Delay9_PS_2_26_reg_next(5);
        Delay9_PS_2_26_reg(6) <= Delay9_PS_2_26_reg_next(6);
        Delay9_PS_2_26_reg(7) <= Delay9_PS_2_26_reg_next(7);
        Delay9_PS_2_26_reg(8) <= Delay9_PS_2_26_reg_next(8);
        Delay9_PS_2_26_reg(9) <= Delay9_PS_2_26_reg_next(9);
        Delay9_PS_2_26_reg(10) <= Delay9_PS_2_26_reg_next(10);
        Delay9_PS_2_26_reg(11) <= Delay9_PS_2_26_reg_next(11);
        Delay9_PS_2_26_reg(12) <= Delay9_PS_2_26_reg_next(12);
        Delay9_PS_2_26_reg(13) <= Delay9_PS_2_26_reg_next(13);
        Delay9_PS_2_26_reg(14) <= Delay9_PS_2_26_reg_next(14);
        Delay9_PS_2_26_reg(15) <= Delay9_PS_2_26_reg_next(15);
        Delay9_PS_2_26_reg(16) <= Delay9_PS_2_26_reg_next(16);
        Delay9_PS_2_26_reg(17) <= Delay9_PS_2_26_reg_next(17);
      END IF;
    END IF;
  END PROCESS Delay9_PS_2_26_process;

  Delay9_PS_2_26_out1 <= Delay9_PS_2_26_reg(17);
  Delay9_PS_2_26_reg_next(0) <= Logical_Operator_out1_1;
  Delay9_PS_2_26_reg_next(1) <= Delay9_PS_2_26_reg(0);
  Delay9_PS_2_26_reg_next(2) <= Delay9_PS_2_26_reg(1);
  Delay9_PS_2_26_reg_next(3) <= Delay9_PS_2_26_reg(2);
  Delay9_PS_2_26_reg_next(4) <= Delay9_PS_2_26_reg(3);
  Delay9_PS_2_26_reg_next(5) <= Delay9_PS_2_26_reg(4);
  Delay9_PS_2_26_reg_next(6) <= Delay9_PS_2_26_reg(5);
  Delay9_PS_2_26_reg_next(7) <= Delay9_PS_2_26_reg(6);
  Delay9_PS_2_26_reg_next(8) <= Delay9_PS_2_26_reg(7);
  Delay9_PS_2_26_reg_next(9) <= Delay9_PS_2_26_reg(8);
  Delay9_PS_2_26_reg_next(10) <= Delay9_PS_2_26_reg(9);
  Delay9_PS_2_26_reg_next(11) <= Delay9_PS_2_26_reg(10);
  Delay9_PS_2_26_reg_next(12) <= Delay9_PS_2_26_reg(11);
  Delay9_PS_2_26_reg_next(13) <= Delay9_PS_2_26_reg(12);
  Delay9_PS_2_26_reg_next(14) <= Delay9_PS_2_26_reg(13);
  Delay9_PS_2_26_reg_next(15) <= Delay9_PS_2_26_reg(14);
  Delay9_PS_2_26_reg_next(16) <= Delay9_PS_2_26_reg(15);
  Delay9_PS_2_26_reg_next(17) <= Delay9_PS_2_26_reg(16);
  ...
  Delay9_PS_4_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay15_PS_6_18_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay15_PS_6_18_reg(0) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(1) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(2) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(3) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(4) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(5) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(6) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(7) <= to_signed(16#000#, 11);
      Delay15_PS_6_18_reg(8) <= to_signed(16#000#, 11);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay15_PS_6_18_reg(0) <= Delay15_PS_6_18_reg_next(0);
        Delay15_PS_6_18_reg(1) <= Delay15_PS_6_18_reg_next(1);
        Delay15_PS_6_18_reg(2) <= Delay15_PS_6_18_reg_next(2);
        Delay15_PS_6_18_reg(3) <= Delay15_PS_6_18_reg_next(3);
        Delay15_PS_6_18_reg(4) <= Delay15_PS_6_18_reg_next(4);
        Delay15_PS_6_18_reg(5) <= Delay15_PS_6_18_reg_next(5);
        Delay15_PS_6_18_reg(6) <= Delay15_PS_6_18_reg_next(6);
        Delay15_PS_6_18_reg(7) <= Delay15_PS_6_18_reg_next(7);
        Delay15_PS_6_18_reg(8) <= Delay15_PS_6_18_reg_next(8);
      END IF;
    END IF;
  END PROCESS Delay15_PS_6_18_process;

  Delay15_PS_6_18_out1 <= Delay15_PS_6_18_reg(8);
  Delay15_PS_6_18_reg_next(0) <= Delay9_PS_4_out1;
  Delay15_PS_6_18_reg_next(1) <= Delay15_PS_6_18_reg(0);
  Delay15_PS_6_18_reg_next(2) <= Delay15_PS_6_18_reg(1);
  Delay15_PS_6_18_reg_next(3) <= Delay15_PS_6_18_reg(2);
  Delay15_PS_6_18_reg_next(4) <= Delay15_PS_6_18_reg(3);
  Delay15_PS_6_18_reg_next(5) <= Delay15_PS_6_18_reg(4);
  Delay15_PS_6_18_reg_next(6) <= Delay15_PS_6_18_reg(5);
  Delay15_PS_6_18_reg_next(7) <= Delay15_PS_6_18_reg(6);
  Delay15_PS_6_18_reg_next(8) <= Delay15_PS_6_18_reg(7);
  ...
  Delay2_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay2_PS_19_20_reg(0) <= to_signed(0, 37);
      Delay2_PS_19_20_reg(1) <= to_signed(0, 37);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay2_PS_19_20_reg(0) <= Delay2_PS_19_20_reg_next(0);
        Delay2_PS_19_20_reg(1) <= Delay2_PS_19_20_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay2_PS_19_20_process;

  Delay2_PS_19_20_out1 <= Delay2_PS_19_20_reg(1);
  Delay2_PS_19_20_reg_next(0) <= Product_out1;
  Delay2_PS_19_20_reg_next(1) <= Delay2_PS_19_20_reg(0);

  Delay1_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay1_PS_19_20_reg(0) <= '0';
      Delay1_PS_19_20_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_PS_19_20_reg(0) <= Delay1_PS_19_20_reg_next(0);
        Delay1_PS_19_20_reg(1) <= Delay1_PS_19_20_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay1_PS_19_20_process;

  Delay1_PS_19_20_out1 <= Delay1_PS_19_20_reg(1);
  Delay1_PS_19_20_reg_next(0) <= Compare_To_Constant1_out1;
  Delay1_PS_19_20_reg_next(1) <= Delay1_PS_19_20_reg(0);
  ...
  Delay_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay_PS_19_20_reg(0) <= '0';
      Delay_PS_19_20_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay_PS_19_20_reg(0) <= Delay_PS_19_20_reg_next(0);
        Delay_PS_19_20_reg(1) <= Delay_PS_19_20_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay_PS_19_20_process;

  Delay_PS_19_20_out1 <= Delay_PS_19_20_reg(1);
  Delay_PS_19_20_reg_next(0) <= Compare_To_Constant_out1;
  Delay_PS_19_20_reg_next(1) <= Delay_PS_19_20_reg(0);
  ...
  Delay9_PS_7_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay5_PS_10_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay7_PS_12_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay25_PS_14_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay7_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay7_PS_19_20_reg(0) <= '0';
      Delay7_PS_19_20_reg(1) <= '0';
      Delay7_PS_19_20_reg(2) <= '0';
      Delay7_PS_19_20_reg(3) <= '0';
      Delay7_PS_19_20_reg(4) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay7_PS_19_20_reg(0) <= Delay7_PS_19_20_reg_next(0);
        Delay7_PS_19_20_reg(1) <= Delay7_PS_19_20_reg_next(1);
        Delay7_PS_19_20_reg(2) <= Delay7_PS_19_20_reg_next(2);
        Delay7_PS_19_20_reg(3) <= Delay7_PS_19_20_reg_next(3);
        Delay7_PS_19_20_reg(4) <= Delay7_PS_19_20_reg_next(4);
      END IF;
    END IF;
  END PROCESS Delay7_PS_19_20_process;

  Delay7_PS_19_20_out1 <= Delay7_PS_19_20_reg(4);
  Delay7_PS_19_20_reg_next(0) <= w_0_out1;
  Delay7_PS_19_20_reg_next(1) <= Delay7_PS_19_20_reg(0);
  Delay7_PS_19_20_reg_next(2) <= Delay7_PS_19_20_reg(1);
  Delay7_PS_19_20_reg_next(3) <= Delay7_PS_19_20_reg(2);
  Delay7_PS_19_20_reg_next(4) <= Delay7_PS_19_20_reg(3);
  ...
  Delay17_PS_7_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay18_PS_8_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay4_PS_10_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay20_PS_10_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay6_PS_12_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay24_PS_14_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay26_PS_14_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay5_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay5_PS_19_20_reg(0) <= to_signed(0, 50);
      Delay5_PS_19_20_reg(1) <= to_signed(0, 50);
      Delay5_PS_19_20_reg(2) <= to_signed(0, 50);
      Delay5_PS_19_20_reg(3) <= to_signed(0, 50);
      Delay5_PS_19_20_reg(4) <= to_signed(0, 50);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay5_PS_19_20_reg(0) <= Delay5_PS_19_20_reg_next(0);
        Delay5_PS_19_20_reg(1) <= Delay5_PS_19_20_reg_next(1);
        Delay5_PS_19_20_reg(2) <= Delay5_PS_19_20_reg_next(2);
        Delay5_PS_19_20_reg(3) <= Delay5_PS_19_20_reg_next(3);
        Delay5_PS_19_20_reg(4) <= Delay5_PS_19_20_reg_next(4);
      END IF;
    END IF;
  END PROCESS Delay5_PS_19_20_process;

  Delay5_PS_19_20_out1 <= Delay5_PS_19_20_reg(4);
  Delay5_PS_19_20_reg_next(0) <= reinterpretcast_bitconcat_L_f_out1;
  Delay5_PS_19_20_reg_next(1) <= Delay5_PS_19_20_reg(0);
  Delay5_PS_19_20_reg_next(2) <= Delay5_PS_19_20_reg(1);
  Delay5_PS_19_20_reg_next(3) <= Delay5_PS_19_20_reg(2);
  Delay5_PS_19_20_reg_next(4) <= Delay5_PS_19_20_reg(3);

  BitSlice_out1_11 <= Delay25_PS_14_out1(29);

  Delay16_PS_17_18_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay16_PS_17_18_reg(0) <= '0';
      Delay16_PS_17_18_reg(1) <= '0';
      Delay16_PS_17_18_reg(2) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay16_PS_17_18_reg(0) <= Delay16_PS_17_18_reg_next(0);
        Delay16_PS_17_18_reg(1) <= Delay16_PS_17_18_reg_next(1);
        Delay16_PS_17_18_reg(2) <= Delay16_PS_17_18_reg_next(2);
      END IF;
    END IF;
  END PROCESS Delay16_PS_17_18_process;

  Delay16_PS_17_18_out1 <= Delay16_PS_17_18_reg(2);
  Delay16_PS_17_18_reg_next(0) <= BitSlice_out1_11;
  Delay16_PS_17_18_reg_next(1) <= Delay16_PS_17_18_reg(0);
  Delay16_PS_17_18_reg_next(2) <= Delay16_PS_17_18_reg(1);
  ...
  Delay3_PS_16_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay4_PS_16_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay14_PS_17_18_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay14_PS_17_18_reg(0) <= to_unsigned(0, 52);
      Delay14_PS_17_18_reg(1) <= to_unsigned(0, 52);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay14_PS_17_18_reg(0) <= Delay14_PS_17_18_reg_next(0);
        Delay14_PS_17_18_reg(1) <= Delay14_PS_17_18_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay14_PS_17_18_process;

  Delay14_PS_17_18_out1 <= Delay14_PS_17_18_reg(1);
  Delay14_PS_17_18_reg_next(0) <= tmp_m1_tmp_m2_out1;
  Delay14_PS_17_18_reg_next(1) <= Delay14_PS_17_18_reg(0);
  ...
  Delay9_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay9_PS_19_20_reg(0) <= to_signed(16#00#, 8);
      Delay9_PS_19_20_reg(1) <= to_signed(16#00#, 8);
      Delay9_PS_19_20_reg(2) <= to_signed(16#00#, 8);
      Delay9_PS_19_20_reg(3) <= to_signed(16#00#, 8);
      Delay9_PS_19_20_reg(4) <= to_signed(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay9_PS_19_20_reg(0) <= Delay9_PS_19_20_reg_next(0);
        Delay9_PS_19_20_reg(1) <= Delay9_PS_19_20_reg_next(1);
        Delay9_PS_19_20_reg(2) <= Delay9_PS_19_20_reg_next(2);
        Delay9_PS_19_20_reg(3) <= Delay9_PS_19_20_reg_next(3);
        Delay9_PS_19_20_reg(4) <= Delay9_PS_19_20_reg_next(4);
      END IF;
    END IF;
  END PROCESS Delay9_PS_19_20_process;

  Delay9_PS_19_20_out1 <= Delay9_PS_19_20_reg(4);
  Delay9_PS_19_20_reg_next(0) <= cfType_Log2NumberOfIterations_out1_1;
  Delay9_PS_19_20_reg_next(1) <= Delay9_PS_19_20_reg(0);
  Delay9_PS_19_20_reg_next(2) <= Delay9_PS_19_20_reg(1);
  Delay9_PS_19_20_reg_next(3) <= Delay9_PS_19_20_reg(2);
  Delay9_PS_19_20_reg_next(4) <= Delay9_PS_19_20_reg(3);
  ...
  Delay8_PS_19_20_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay8_PS_19_20_reg(0) <= to_signed(0, 50);
      Delay8_PS_19_20_reg(1) <= to_signed(0, 50);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay8_PS_19_20_reg(0) <= Delay8_PS_19_20_reg_next(0);
        Delay8_PS_19_20_reg(1) <= Delay8_PS_19_20_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay8_PS_19_20_process;

  Delay8_PS_19_20_out1 <= Delay8_PS_19_20_reg(1);
  Delay8_PS_19_20_reg_next(0) <= Switch_out1_5;
  Delay8_PS_19_20_reg_next(1) <= Delay8_PS_19_20_reg(0);
  ...
  Delay11_PS_22_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay21_PS_22_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay12_PS_23_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay3_PS_25_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay3_PS_25_reg(0) <= '0';
      Delay3_PS_25_reg(1) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay3_PS_25_reg(0) <= Delay3_PS_25_reg_next(0);
        Delay3_PS_25_reg(1) <= Delay3_PS_25_reg_next(1);
      END IF;
    END IF;
  END PROCESS Delay3_PS_25_process;

  Delay3_PS_25_out1 <= Delay3_PS_25_reg(1);
  Delay3_PS_25_reg_next(0) <= BitSlice_out1_13;
  Delay3_PS_25_reg_next(1) <= Delay3_PS_25_reg(0);

  Delay13_PS_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay6_PS_2_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay6_PS_2_26_reg(0) <= '0';
      Delay6_PS_2_26_reg(1) <= '0';
      Delay6_PS_2_26_reg(2) <= '0';
      Delay6_PS_2_26_reg(3) <= '0';
      Delay6_PS_2_26_reg(4) <= '0';
      Delay6_PS_2_26_reg(5) <= '0';
      Delay6_PS_2_26_reg(6) <= '0';
      Delay6_PS_2_26_reg(7) <= '0';
      Delay6_PS_2_26_reg(8) <= '0';
      Delay6_PS_2_26_reg(9) <= '0';
      Delay6_PS_2_26_reg(10) <= '0';
      Delay6_PS_2_26_reg(11) <= '0';
      Delay6_PS_2_26_reg(12) <= '0';
      Delay6_PS_2_26_reg(13) <= '0';
      Delay6_PS_2_26_reg(14) <= '0';
      Delay6_PS_2_26_reg(15) <= '0';
      Delay6_PS_2_26_reg(16) <= '0';
      Delay6_PS_2_26_reg(17) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay6_PS_2_26_reg(0) <= Delay6_PS_2_26_reg_next(0);
        Delay6_PS_2_26_reg(1) <= Delay6_PS_2_26_reg_next(1);
        Delay6_PS_2_26_reg(2) <= Delay6_PS_2_26_reg_next(2);
        Delay6_PS_2_26_reg(3) <= Delay6_PS_2_26_reg_next(3);
        Delay6_PS_2_26_reg(4) <= Delay6_PS_2_26_reg_next(4);
        Delay6_PS_2_26_reg(5) <= Delay6_PS_2_26_reg_next(5);
        Delay6_PS_2_26_reg(6) <= Delay6_PS_2_26_reg_next(6);
        Delay6_PS_2_26_reg(7) <= Delay6_PS_2_26_reg_next(7);
        Delay6_PS_2_26_reg(8) <= Delay6_PS_2_26_reg_next(8);
        Delay6_PS_2_26_reg(9) <= Delay6_PS_2_26_reg_next(9);
        Delay6_PS_2_26_reg(10) <= Delay6_PS_2_26_reg_next(10);
        Delay6_PS_2_26_reg(11) <= Delay6_PS_2_26_reg_next(11);
        Delay6_PS_2_26_reg(12) <= Delay6_PS_2_26_reg_next(12);
        Delay6_PS_2_26_reg(13) <= Delay6_PS_2_26_reg_next(13);
        Delay6_PS_2_26_reg(14) <= Delay6_PS_2_26_reg_next(14);
        Delay6_PS_2_26_reg(15) <= Delay6_PS_2_26_reg_next(15);
        Delay6_PS_2_26_reg(16) <= Delay6_PS_2_26_reg_next(16);
        Delay6_PS_2_26_reg(17) <= Delay6_PS_2_26_reg_next(17);
      END IF;
    END IF;
  END PROCESS Delay6_PS_2_26_process;

  Delay6_PS_2_26_out1 <= Delay6_PS_2_26_reg(17);
  Delay6_PS_2_26_reg_next(0) <= if_aExponent_0_2_out1;
  Delay6_PS_2_26_reg_next(1) <= Delay6_PS_2_26_reg(0);
  Delay6_PS_2_26_reg_next(2) <= Delay6_PS_2_26_reg(1);
  Delay6_PS_2_26_reg_next(3) <= Delay6_PS_2_26_reg(2);
  Delay6_PS_2_26_reg_next(4) <= Delay6_PS_2_26_reg(3);
  Delay6_PS_2_26_reg_next(5) <= Delay6_PS_2_26_reg(4);
  Delay6_PS_2_26_reg_next(6) <= Delay6_PS_2_26_reg(5);
  Delay6_PS_2_26_reg_next(7) <= Delay6_PS_2_26_reg(6);
  Delay6_PS_2_26_reg_next(8) <= Delay6_PS_2_26_reg(7);
  Delay6_PS_2_26_reg_next(9) <= Delay6_PS_2_26_reg(8);
  Delay6_PS_2_26_reg_next(10) <= Delay6_PS_2_26_reg(9);
  Delay6_PS_2_26_reg_next(11) <= Delay6_PS_2_26_reg(10);
  Delay6_PS_2_26_reg_next(12) <= Delay6_PS_2_26_reg(11);
  Delay6_PS_2_26_reg_next(13) <= Delay6_PS_2_26_reg(12);
  Delay6_PS_2_26_reg_next(14) <= Delay6_PS_2_26_reg(13);
  Delay6_PS_2_26_reg_next(15) <= Delay6_PS_2_26_reg(14);
  Delay6_PS_2_26_reg_next(16) <= Delay6_PS_2_26_reg(15);
  Delay6_PS_2_26_reg_next(17) <= Delay6_PS_2_26_reg(16);
  ...
  Delay3_PS_27_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay3_PS_27_out1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay1_PS_24_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay4_PS_25_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay5_PS_25_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay18_PS_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay1_PS_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay1_PS_26_reg(0) <= '0';
      Delay1_PS_26_reg(1) <= '0';
      Delay1_PS_26_reg(2) <= '0';
      Delay1_PS_26_reg(3) <= '0';
      Delay1_PS_26_reg(4) <= '0';
      Delay1_PS_26_reg(5) <= '0';
      Delay1_PS_26_reg(6) <= '0';
      Delay1_PS_26_reg(7) <= '0';
      Delay1_PS_26_reg(8) <= '0';
      Delay1_PS_26_reg(9) <= '0';
      Delay1_PS_26_reg(10) <= '0';
      Delay1_PS_26_reg(11) <= '0';
      Delay1_PS_26_reg(12) <= '0';
      Delay1_PS_26_reg(13) <= '0';
      Delay1_PS_26_reg(14) <= '0';
      Delay1_PS_26_reg(15) <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_PS_26_reg(0) <= Delay1_PS_26_reg_next(0);
        Delay1_PS_26_reg(1) <= Delay1_PS_26_reg_next(1);
        Delay1_PS_26_reg(2) <= Delay1_PS_26_reg_next(2);
        Delay1_PS_26_reg(3) <= Delay1_PS_26_reg_next(3);
        Delay1_PS_26_reg(4) <= Delay1_PS_26_reg_next(4);
        Delay1_PS_26_reg(5) <= Delay1_PS_26_reg_next(5);
        Delay1_PS_26_reg(6) <= Delay1_PS_26_reg_next(6);
        Delay1_PS_26_reg(7) <= Delay1_PS_26_reg_next(7);
        Delay1_PS_26_reg(8) <= Delay1_PS_26_reg_next(8);
        Delay1_PS_26_reg(9) <= Delay1_PS_26_reg_next(9);
        Delay1_PS_26_reg(10) <= Delay1_PS_26_reg_next(10);
        Delay1_PS_26_reg(11) <= Delay1_PS_26_reg_next(11);
        Delay1_PS_26_reg(12) <= Delay1_PS_26_reg_next(12);
        Delay1_PS_26_reg(13) <= Delay1_PS_26_reg_next(13);
        Delay1_PS_26_reg(14) <= Delay1_PS_26_reg_next(14);
        Delay1_PS_26_reg(15) <= Delay1_PS_26_reg_next(15);
      END IF;
    END IF;
  END PROCESS Delay1_PS_26_process;

  Delay1_PS_26_out1 <= Delay1_PS_26_reg(15);
  Delay1_PS_26_reg_next(0) <= Delay10_PS_4_out1;
  Delay1_PS_26_reg_next(1) <= Delay1_PS_26_reg(0);
  Delay1_PS_26_reg_next(2) <= Delay1_PS_26_reg(1);
  Delay1_PS_26_reg_next(3) <= Delay1_PS_26_reg(2);
  Delay1_PS_26_reg_next(4) <= Delay1_PS_26_reg(3);
  Delay1_PS_26_reg_next(5) <= Delay1_PS_26_reg(4);
  Delay1_PS_26_reg_next(6) <= Delay1_PS_26_reg(5);
  Delay1_PS_26_reg_next(7) <= Delay1_PS_26_reg(6);
  Delay1_PS_26_reg_next(8) <= Delay1_PS_26_reg(7);
  Delay1_PS_26_reg_next(9) <= Delay1_PS_26_reg(8);
  Delay1_PS_26_reg_next(10) <= Delay1_PS_26_reg(9);
  Delay1_PS_26_reg_next(11) <= Delay1_PS_26_reg(10);
  Delay1_PS_26_reg_next(12) <= Delay1_PS_26_reg(11);
  Delay1_PS_26_reg_next(13) <= Delay1_PS_26_reg(12);
  Delay1_PS_26_reg_next(14) <= Delay1_PS_26_reg(13);
  Delay1_PS_26_reg_next(15) <= Delay1_PS_26_reg(14);
  ...
  Delay17_PS_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay7_PS_2_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay7_PS_2_26_reg(0) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(1) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(2) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(3) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(4) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(5) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(6) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(7) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(8) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(9) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(10) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(11) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(12) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(13) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(14) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(15) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(16) <= to_unsigned(16#00#, 8);
      Delay7_PS_2_26_reg(17) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay7_PS_2_26_reg(0) <= Delay7_PS_2_26_reg_next(0);
        Delay7_PS_2_26_reg(1) <= Delay7_PS_2_26_reg_next(1);
        Delay7_PS_2_26_reg(2) <= Delay7_PS_2_26_reg_next(2);
        Delay7_PS_2_26_reg(3) <= Delay7_PS_2_26_reg_next(3);
        Delay7_PS_2_26_reg(4) <= Delay7_PS_2_26_reg_next(4);
        Delay7_PS_2_26_reg(5) <= Delay7_PS_2_26_reg_next(5);
        Delay7_PS_2_26_reg(6) <= Delay7_PS_2_26_reg_next(6);
        Delay7_PS_2_26_reg(7) <= Delay7_PS_2_26_reg_next(7);
        Delay7_PS_2_26_reg(8) <= Delay7_PS_2_26_reg_next(8);
        Delay7_PS_2_26_reg(9) <= Delay7_PS_2_26_reg_next(9);
        Delay7_PS_2_26_reg(10) <= Delay7_PS_2_26_reg_next(10);
        Delay7_PS_2_26_reg(11) <= Delay7_PS_2_26_reg_next(11);
        Delay7_PS_2_26_reg(12) <= Delay7_PS_2_26_reg_next(12);
        Delay7_PS_2_26_reg(13) <= Delay7_PS_2_26_reg_next(13);
        Delay7_PS_2_26_reg(14) <= Delay7_PS_2_26_reg_next(14);
        Delay7_PS_2_26_reg(15) <= Delay7_PS_2_26_reg_next(15);
        Delay7_PS_2_26_reg(16) <= Delay7_PS_2_26_reg_next(16);
        Delay7_PS_2_26_reg(17) <= Delay7_PS_2_26_reg_next(17);
      END IF;
    END IF;
  END PROCESS Delay7_PS_2_26_process;

  Delay7_PS_2_26_out1 <= Delay7_PS_2_26_reg(17);
  Delay7_PS_2_26_reg_next(0) <= if_aExponent_0_out1;
  Delay7_PS_2_26_reg_next(1) <= Delay7_PS_2_26_reg(0);
  Delay7_PS_2_26_reg_next(2) <= Delay7_PS_2_26_reg(1);
  Delay7_PS_2_26_reg_next(3) <= Delay7_PS_2_26_reg(2);
  Delay7_PS_2_26_reg_next(4) <= Delay7_PS_2_26_reg(3);
  Delay7_PS_2_26_reg_next(5) <= Delay7_PS_2_26_reg(4);
  Delay7_PS_2_26_reg_next(6) <= Delay7_PS_2_26_reg(5);
  Delay7_PS_2_26_reg_next(7) <= Delay7_PS_2_26_reg(6);
  Delay7_PS_2_26_reg_next(8) <= Delay7_PS_2_26_reg(7);
  Delay7_PS_2_26_reg_next(9) <= Delay7_PS_2_26_reg(8);
  Delay7_PS_2_26_reg_next(10) <= Delay7_PS_2_26_reg(9);
  Delay7_PS_2_26_reg_next(11) <= Delay7_PS_2_26_reg(10);
  Delay7_PS_2_26_reg_next(12) <= Delay7_PS_2_26_reg(11);
  Delay7_PS_2_26_reg_next(13) <= Delay7_PS_2_26_reg(12);
  Delay7_PS_2_26_reg_next(14) <= Delay7_PS_2_26_reg(13);
  Delay7_PS_2_26_reg_next(15) <= Delay7_PS_2_26_reg(14);
  Delay7_PS_2_26_reg_next(16) <= Delay7_PS_2_26_reg(15);
  Delay7_PS_2_26_reg_next(17) <= Delay7_PS_2_26_reg(16);
  ...
  Delay4_PS_27_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  Delay8_PS_2_26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay8_PS_2_26_reg(0) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(1) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(2) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(3) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(4) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(5) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(6) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(7) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(8) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(9) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(10) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(11) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(12) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(13) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(14) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(15) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(16) <= to_unsigned(16#000000#, 23);
      Delay8_PS_2_26_reg(17) <= to_unsigned(16#000000#, 23);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay8_PS_2_26_reg(0) <= Delay8_PS_2_26_reg_next(0);
        Delay8_PS_2_26_reg(1) <= Delay8_PS_2_26_reg_next(1);
        Delay8_PS_2_26_reg(2) <= Delay8_PS_2_26_reg_next(2);
        Delay8_PS_2_26_reg(3) <= Delay8_PS_2_26_reg_next(3);
        Delay8_PS_2_26_reg(4) <= Delay8_PS_2_26_reg_next(4);
        Delay8_PS_2_26_reg(5) <= Delay8_PS_2_26_reg_next(5);
        Delay8_PS_2_26_reg(6) <= Delay8_PS_2_26_reg_next(6);
        Delay8_PS_2_26_reg(7) <= Delay8_PS_2_26_reg_next(7);
        Delay8_PS_2_26_reg(8) <= Delay8_PS_2_26_reg_next(8);
        Delay8_PS_2_26_reg(9) <= Delay8_PS_2_26_reg_next(9);
        Delay8_PS_2_26_reg(10) <= Delay8_PS_2_26_reg_next(10);
        Delay8_PS_2_26_reg(11) <= Delay8_PS_2_26_reg_next(11);
        Delay8_PS_2_26_reg(12) <= Delay8_PS_2_26_reg_next(12);
        Delay8_PS_2_26_reg(13) <= Delay8_PS_2_26_reg_next(13);
        Delay8_PS_2_26_reg(14) <= Delay8_PS_2_26_reg_next(14);
        Delay8_PS_2_26_reg(15) <= Delay8_PS_2_26_reg_next(15);
        Delay8_PS_2_26_reg(16) <= Delay8_PS_2_26_reg_next(16);
        Delay8_PS_2_26_reg(17) <= Delay8_PS_2_26_reg_next(17);
      END IF;
    END IF;
  END PROCESS Delay8_PS_2_26_process;

  Delay8_PS_2_26_out1 <= Delay8_PS_2_26_reg(17);
  Delay8_PS_2_26_reg_next(0) <= if_aExponent_0_1_out1;
  Delay8_PS_2_26_reg_next(1) <= Delay8_PS_2_26_reg(0);
  Delay8_PS_2_26_reg_next(2) <= Delay8_PS_2_26_reg(1);
  Delay8_PS_2_26_reg_next(3) <= Delay8_PS_2_26_reg(2);
  Delay8_PS_2_26_reg_next(4) <= Delay8_PS_2_26_reg(3);
  Delay8_PS_2_26_reg_next(5) <= Delay8_PS_2_26_reg(4);
  Delay8_PS_2_26_reg_next(6) <= Delay8_PS_2_26_reg(5);
  Delay8_PS_2_26_reg_next(7) <= Delay8_PS_2_26_reg(6);
  Delay8_PS_2_26_reg_next(8) <= Delay8_PS_2_26_reg(7);
  Delay8_PS_2_26_reg_next(9) <= Delay8_PS_2_26_reg(8);
  Delay8_PS_2_26_reg_next(10) <= Delay8_PS_2_26_reg(9);
  Delay8_PS_2_26_reg_next(11) <= Delay8_PS_2_26_reg(10);
  Delay8_PS_2_26_reg_next(12) <= Delay8_PS_2_26_reg(11);
  Delay8_PS_2_26_reg_next(13) <= Delay8_PS_2_26_reg(12);
  Delay8_PS_2_26_reg_next(14) <= Delay8_PS_2_26_reg(13);
  Delay8_PS_2_26_reg_next(15) <= Delay8_PS_2_26_reg(14);
  Delay8_PS_2_26_reg_next(16) <= Delay8_PS_2_26_reg(15);
  Delay8_PS_2_26_reg_next(17) <= Delay8_PS_2_26_reg(16);
  ...
  Switch5_out1_11 <= Constant2_out1_2 WHEN Relational_Operator_relop1 = '0' ELSE
      Switch3_out1_1;
