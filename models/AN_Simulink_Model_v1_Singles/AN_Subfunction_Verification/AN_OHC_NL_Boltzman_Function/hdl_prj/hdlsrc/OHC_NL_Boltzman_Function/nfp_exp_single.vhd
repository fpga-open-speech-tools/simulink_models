...
-- Source Path: OHC_NL_Boltzman_Function/OHC NL Boltzman Function Singles/nfp_exp_single
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_exp_single IS
  ...
  SIGNAL Delay9_reg                       : std_logic_vector(0 TO 13);  -- ufix1 [14]
  SIGNAL Delay9_reg_next                  : std_logic_vector(0 TO 13);  -- ufix1 [14]
  ...
  SIGNAL Delay6_reg                       : std_logic_vector(0 TO 13);  -- ufix1 [14]
  SIGNAL Delay6_reg_next                  : std_logic_vector(0 TO 13);  -- ufix1 [14]
  ...
  SIGNAL Delay30_reg_next                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay18_reg                      : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay18_reg_next                 : std_logic_vector(0 TO 5);  -- ufix1 [6]
  ...
  SIGNAL Delay15_reg                      : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay15_reg_next                 : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay15_out1                     : std_logic;  -- ufix1
  SIGNAL Delay25_reg                      : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay25_reg_next                 : std_logic_vector(0 TO 3);  -- ufix1 [4]
  ...
  SIGNAL Delay16_reg_next                 : vector_of_signed10(0 TO 5);  -- sfix10 [6]
  SIGNAL Delay16_out1                     : signed(9 DOWNTO 0);  -- sfix10
  SIGNAL Delay26_reg                      : vector_of_signed10(0 TO 3);  -- sfix10 [4]
  SIGNAL Delay26_reg_next                 : vector_of_signed10(0 TO 3);  -- sfix10 [4]
  SIGNAL Delay26_out1                     : signed(9 DOWNTO 0);  -- sfix10
  ...
  SIGNAL Delay1_reg_next                  : vector_of_signed34(0 TO 1);  -- sfix34_En31 [2]
  ...
  SIGNAL Delay17_reg                      : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay17_reg_next                 : std_logic_vector(0 TO 5);  -- ufix1 [6]
  SIGNAL Delay17_out1_1                   : std_logic;  -- ufix1
  SIGNAL Delay27_reg                      : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay27_reg_next                 : std_logic_vector(0 TO 3);  -- ufix1 [4]
  SIGNAL Delay27_out1                     : std_logic;  -- ufix1
  ...
  SIGNAL Delay7_reg                       : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  SIGNAL Delay7_reg_next                  : vector_of_unsigned8(0 TO 13);  -- ufix8 [14]
  ...
  SIGNAL Delay8_reg                       : vector_of_unsigned23(0 TO 13);  -- ufix23 [14]
  SIGNAL Delay8_reg_next                  : vector_of_unsigned23(0 TO 13);  -- ufix23 [14]
...
BEGIN
  ...
  Delay18_reg_next(0) <= Delay2_out1_2;
  ...
  Delay28_reg_next(0) <= Delay18_out1;
  ...
  Delay15_reg_next(0) <= Delay1_out1_3;
  ...
  Delay25_out1 <= Delay25_reg(3);
  Delay25_reg_next(0) <= Delay15_out1;
  ...
  if_aSign_out1_1 <= C1_out1_1 WHEN Delay34_out1 = '0' ELSE
      C_out1_3;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay16_reg(0) <= to_signed(16#000#, 10);
      Delay16_reg(1) <= to_signed(16#000#, 10);
      Delay16_reg(2) <= to_signed(16#000#, 10);
      Delay16_reg(3) <= to_signed(16#000#, 10);
      Delay16_reg(4) <= to_signed(16#000#, 10);
      Delay16_reg(5) <= to_signed(16#000#, 10);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay16_reg_next(0) <= if_aSign_1_out1;
  Delay16_reg_next(1) <= Delay16_reg(0);
  Delay16_reg_next(2) <= Delay16_reg(1);
  Delay16_reg_next(3) <= Delay16_reg(2);
  Delay16_reg_next(4) <= Delay16_reg(3);
  Delay16_reg_next(5) <= Delay16_reg(4);

  Delay26_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Delay26_reg(0) <= to_signed(16#000#, 10);
      Delay26_reg(1) <= to_signed(16#000#, 10);
      Delay26_reg(2) <= to_signed(16#000#, 10);
      Delay26_reg(3) <= to_signed(16#000#, 10);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay26_out1 <= Delay26_reg(3);
  Delay26_reg_next(0) <= Delay16_out1;
  Delay26_reg_next(1) <= Delay26_reg(0);
  Delay26_reg_next(2) <= Delay26_reg(1);
  Delay26_reg_next(3) <= Delay26_reg(2);

  
  exp_out_0_out1 <= '1' WHEN Delay26_out1 > to_signed(16#000#, 10) ELSE
      '0';
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay15_out1_1 <= if_bitget_w_w_WordLength_1_out1_6;
      END IF;
    END IF;
  END PROCESS Delay15_1_process;


  bitsll_w_1_out1_6 <= Delay15_out1_1 sll 1;
  ...
  BEGIN
    IF reset = '1' THEN
      Delay1_reg(0) <= to_signed(0, 34);
      Delay1_reg(1) <= to_signed(0, 34);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay1_reg_next(0) <= if_bitget_w_w_WordLength_1_1_out1_11;
  Delay1_reg_next(1) <= Delay1_reg(0);

  Bit_Slice2_out1 <= unsigned(Delay1_out1_4(32 DOWNTO 12));
  ...
  Delay2_reg_next(0) <= Delay1_out1_4;
  ...
  Delay17_out1_1 <= Delay17_reg(5);
  Delay17_reg_next(0) <= Logical_Operator_out1_1;
  ...
  Delay27_out1 <= Delay27_reg(3);
  Delay27_reg_next(0) <= Delay17_out1_1;
  ...
  BitSlice2_out1_3 <= Delay26_out1(9);
  ...
  DTC_out1_1 <= unsigned(Delay26_out1(7 DOWNTO 0));
