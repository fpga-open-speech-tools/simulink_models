-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OHC_NL_Boltzman_Function\nfp_div_single.vhd
...
-- Source Path: OHC_NL_Boltzman_Function/OHC NL Boltzman Function Singles/nfp_div_single
-- Hierarchy Level: 1
-- 
...
USE work.OHC_NL_Boltzman_Function_Singles_pkg.ALL;
...
ARCHITECTURE rtl OF nfp_div_single IS
  ...
  SIGNAL Delay26_reg                      : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL Delay26_reg_next                 : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  SIGNAL Delay21_reg                      : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL Delay21_reg_next                 : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  SIGNAL Delay23_reg                      : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL Delay23_reg_next                 : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  SIGNAL Delay22_reg                      : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL Delay22_reg_next                 : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  SIGNAL Delay11_reg_next                 : vector_of_unsigned5(0 TO 10);  -- ufix5 [11]
  ...
  SIGNAL Delay8_reg_next                  : vector_of_unsigned8(0 TO 11);  -- ufix8 [12]
  ...
  SIGNAL Delay39_reg_next                 : vector_of_unsigned8(0 TO 12);  -- ufix8 [13]
  ...
  SIGNAL Delay49_reg_next                 : vector_of_unsigned23(0 TO 12);  -- ufix23 [13]
...
BEGIN
  ...
  Delay26_reg_next(0) <= Delay29_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay21_reg(9) <= Delay21_reg_next(9);
        Delay21_reg(10) <= Delay21_reg_next(10);
        Delay21_reg(11) <= Delay21_reg_next(11);
        Delay21_reg(12) <= Delay21_reg_next(12);
      END IF;
    END IF;
  END PROCESS Delay21_process;

  Delay21_out1 <= Delay21_reg(12);
  Delay21_reg_next(0) <= Delay38_out1;
  ...
  Delay21_reg_next(9) <= Delay21_reg(8);
  Delay21_reg_next(10) <= Delay21_reg(9);
  Delay21_reg_next(11) <= Delay21_reg(10);
  Delay21_reg_next(12) <= Delay21_reg(11);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay23_reg(8) <= Delay23_reg_next(8);
        Delay23_reg(9) <= Delay23_reg_next(9);
        Delay23_reg(10) <= Delay23_reg_next(10);
        Delay23_reg(11) <= Delay23_reg_next(11);
        Delay23_reg(12) <= Delay23_reg_next(12);
      END IF;
    END IF;
  END PROCESS Delay23_process;

  Delay23_out1 <= Delay23_reg(12);
  Delay23_reg_next(0) <= Delay32_out1;
  Delay23_reg_next(1) <= Delay23_reg(0);
  Delay23_reg_next(2) <= Delay23_reg(1);
  Delay23_reg_next(3) <= Delay23_reg(2);
  Delay23_reg_next(4) <= Delay23_reg(3);
  Delay23_reg_next(5) <= Delay23_reg(4);
  Delay23_reg_next(6) <= Delay23_reg(5);
  Delay23_reg_next(7) <= Delay23_reg(6);
  Delay23_reg_next(8) <= Delay23_reg(7);
  Delay23_reg_next(9) <= Delay23_reg(8);
  Delay23_reg_next(10) <= Delay23_reg(9);
  Delay23_reg_next(11) <= Delay23_reg(10);
  Delay23_reg_next(12) <= Delay23_reg(11);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay22_reg(12) <= Delay22_reg_next(12);
      END IF;
    END IF;
  END PROCESS Delay22_process;

  Delay22_out1 <= Delay22_reg(12);
  Delay22_reg_next(0) <= Delay35_out1;
  ...
  Delay22_reg_next(12) <= Delay22_reg(11);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay39_reg(0) <= to_unsigned(16#00#, 8);
      Delay39_reg(1) <= to_unsigned(16#00#, 8);
      Delay39_reg(2) <= to_unsigned(16#00#, 8);
      Delay39_reg(3) <= to_unsigned(16#00#, 8);
      Delay39_reg(4) <= to_unsigned(16#00#, 8);
      Delay39_reg(5) <= to_unsigned(16#00#, 8);
      Delay39_reg(6) <= to_unsigned(16#00#, 8);
      Delay39_reg(7) <= to_unsigned(16#00#, 8);
      Delay39_reg(8) <= to_unsigned(16#00#, 8);
      Delay39_reg(9) <= to_unsigned(16#00#, 8);
      Delay39_reg(10) <= to_unsigned(16#00#, 8);
      Delay39_reg(11) <= to_unsigned(16#00#, 8);
      Delay39_reg(12) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Delay39_reg(5) <= Delay39_reg_next(5);
        Delay39_reg(6) <= Delay39_reg_next(6);
        Delay39_reg(7) <= Delay39_reg_next(7);
        Delay39_reg(8) <= Delay39_reg_next(8);
        Delay39_reg(9) <= Delay39_reg_next(9);
        Delay39_reg(10) <= Delay39_reg_next(10);
        Delay39_reg(11) <= Delay39_reg_next(11);
        Delay39_reg(12) <= Delay39_reg_next(12);
      END IF;
    END IF;
  END PROCESS Delay39_process;

  Delay39_out1 <= Delay39_reg(12);
  Delay39_reg_next(0) <= Delay25_out1;
  Delay39_reg_next(1) <= Delay39_reg(0);
  Delay39_reg_next(2) <= Delay39_reg(1);
  Delay39_reg_next(3) <= Delay39_reg(2);
  Delay39_reg_next(4) <= Delay39_reg(3);
  Delay39_reg_next(5) <= Delay39_reg(4);
  Delay39_reg_next(6) <= Delay39_reg(5);
  Delay39_reg_next(7) <= Delay39_reg(6);
  Delay39_reg_next(8) <= Delay39_reg(7);
  Delay39_reg_next(9) <= Delay39_reg(8);
  Delay39_reg_next(10) <= Delay39_reg(9);
  Delay39_reg_next(11) <= Delay39_reg(10);
  Delay39_reg_next(12) <= Delay39_reg(11);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay49_reg(0) <= to_unsigned(16#000000#, 23);
      Delay49_reg(1) <= to_unsigned(16#000000#, 23);
      Delay49_reg(2) <= to_unsigned(16#000000#, 23);
      Delay49_reg(3) <= to_unsigned(16#000000#, 23);
      Delay49_reg(4) <= to_unsigned(16#000000#, 23);
      Delay49_reg(5) <= to_unsigned(16#000000#, 23);
      Delay49_reg(6) <= to_unsigned(16#000000#, 23);
      Delay49_reg(7) <= to_unsigned(16#000000#, 23);
      Delay49_reg(8) <= to_unsigned(16#000000#, 23);
      Delay49_reg(9) <= to_unsigned(16#000000#, 23);
      Delay49_reg(10) <= to_unsigned(16#000000#, 23);
      Delay49_reg(11) <= to_unsigned(16#000000#, 23);
      Delay49_reg(12) <= to_unsigned(16#000000#, 23);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay49_reg(0) <= Delay49_reg_next(0);
        Delay49_reg(1) <= Delay49_reg_next(1);
        Delay49_reg(2) <= Delay49_reg_next(2);
        Delay49_reg(3) <= Delay49_reg_next(3);
        Delay49_reg(4) <= Delay49_reg_next(4);
        Delay49_reg(5) <= Delay49_reg_next(5);
        Delay49_reg(6) <= Delay49_reg_next(6);
        Delay49_reg(7) <= Delay49_reg_next(7);
        Delay49_reg(8) <= Delay49_reg_next(8);
        Delay49_reg(9) <= Delay49_reg_next(9);
        Delay49_reg(10) <= Delay49_reg_next(10);
        Delay49_reg(11) <= Delay49_reg_next(11);
        Delay49_reg(12) <= Delay49_reg_next(12);
      END IF;
    END IF;
  END PROCESS Delay49_process;

  Delay49_out1 <= Delay49_reg(12);
  Delay49_reg_next(0) <= Delay24_out1;
  Delay49_reg_next(1) <= Delay49_reg(0);
  Delay49_reg_next(2) <= Delay49_reg(1);
  Delay49_reg_next(3) <= Delay49_reg(2);
  Delay49_reg_next(4) <= Delay49_reg(3);
  Delay49_reg_next(5) <= Delay49_reg(4);
  Delay49_reg_next(6) <= Delay49_reg(5);
  Delay49_reg_next(7) <= Delay49_reg(6);
  Delay49_reg_next(8) <= Delay49_reg(7);
  Delay49_reg_next(9) <= Delay49_reg(8);
  Delay49_reg_next(10) <= Delay49_reg(9);
  Delay49_reg_next(11) <= Delay49_reg(10);
  Delay49_reg_next(12) <= Delay49_reg(11);
