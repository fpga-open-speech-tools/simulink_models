...
mp.Avalon_Sink_Data.Time    = out.Avalon_Sink_Data.Time;    % time
mp.Avalon_Sink_Data.Data    = out.Avalon_Sink_Data.Data;    % data      
mp.Avalon_Sink_Channel.Data = out.Avalon_Sink_Channel.Data; % channel
mp.Avalon_Sink_Valid.Data   = out.Avalon_Sink_Valid.Data;   % valid
...
data = resample(double(out.Avalon_Sink_Data.Data(:)), mp.Fs, mp.Fs*8);
