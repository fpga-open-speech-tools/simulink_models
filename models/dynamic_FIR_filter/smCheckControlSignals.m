...
if mp.simPrompts == 1  % don't keep displaying when vhdl code is being generated by HDL coder
    disp(' ')
    disp('Checking if the control register fields have been setup correctly in smInitControlSignals.m')
end
...
if error_flag == 1
    error('Register fields are missing.  Please add them in smInitControlSignals.m')
end
...
if error_flag == 1
    error('Widget names are wrong.  Please correct in smInitControlSignals.m')
end
