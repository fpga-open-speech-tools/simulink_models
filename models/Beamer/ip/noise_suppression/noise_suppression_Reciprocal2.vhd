...
ARCHITECTURE rtl OF noise_suppression_Reciprocal2 IS
  ...
  SIGNAL latencyValueConstantSignal       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL initFlagAddDataOut               : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL initFlagAddDataOutDelay_1        : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL Relational_Operator_relop1       : std_logic;
  SIGNAL initFlagDelay_1                  : std_logic;  -- ufix1
  SIGNAL initFlagDelayData                : std_logic;  -- ufix1
  SIGNAL initFlagDelayData_1              : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  latencyValueConstantSignal <= to_unsigned(16#1B#, 6);

  initFlagAddDataOutDelay_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      initFlagAddDataOutDelay_1 <= to_unsigned(16#01#, 6);
  ...
  initFlagDelayData_1 <= '0' & '0' & '0' & '0' & '0' & initFlagDelayData;

  initFlagAddDataOut <= resize(resize(initFlagDelayData_1, 5) + resize(initFlagAddDataOutDelay_1, 5), 6);
