...
ENTITY noise_suppression_streaming_partition_streamed IS
  PORT( clk                               :   IN    std_logic;
        ...
        in2                               :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32_En32
...
ARCHITECTURE rtl OF noise_suppression_streaming_partition_streamed IS
  ...
  SIGNAL in2_unsigned                     : unsigned(31 DOWNTO 0);  -- ufix32_En32
  SIGNAL Add_add_cast                     : signed(35 DOWNTO 0);  -- sfix36_En32
  SIGNAL Add_add_cast_1                   : signed(35 DOWNTO 0);  -- sfix36_En32
...
BEGIN
  ...
  Add_add_cast <= resize(variance & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 36);
  Add_add_cast_1 <= signed(resize(in2_unsigned, 36));
  Add_out1 <= Add_add_cast + Add_add_cast_1;

  Data_Type_Conversion3_out1 <= Add_out1(35 DOWNTO 12);
