...
ENTITY noise_suppression_Adaptive_Wiener_Filter_Sample_Based_Filtering IS
  PORT( clk                               :   IN    std_logic;
        ...
        noise_variance                    :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32_En32
        enable                            :   IN    std_logic;
...
ARCHITECTURE rtl OF noise_suppression_Adaptive_Wiener_Filter_Sample_Based_Filtering IS
  ...
  SIGNAL noise_variance_1                 : unsigned(31 DOWNTO 0);  -- ufix32_En32
  SIGNAL noise_variance_2                 : unsigned(31 DOWNTO 0);  -- ufix32_En32
...
BEGIN
  ...
  u_streaming_partition_streamed : noise_suppression_streaming_partition_streamed
    PORT MAP( clk => clk,
              ...
              in2 => std_logic_vector(noise_variance_2),  -- ufix32_En32
  ...
  BEGIN
    IF reset = '1' THEN
      noise_variance_2 <= to_unsigned(0, 32);
    ELSIF rising_edge(clk) THEN
      IF enb = '1' THEN
