...
component noise_suppression_dataplane is 
  port (
    ...
    register_control_noise_variance  : in  std_logic_vector(31 downto 0);
    clk                              : in  std_logic;
    reset                            : in  std_logic;
  ...
  signal noise_variance                   : std_logic_vector(31 downto 0) := "00000000000000000000000000000000";
...
begin
  if reset = '1' then 
    enable                   <= '1';                             -- 1
    noise_variance           <= "00000000000000000000000000000000"; -- 0
  elsif rising_edge(clk) and avalon_slave_write = '1' then
    case avalon_slave_address is
      when "0" => enable <= avalon_slave_writedata(0);
      when "1" => noise_variance <= avalon_slave_writedata;
      when others => null;
    end case;
  end if;
end process;
