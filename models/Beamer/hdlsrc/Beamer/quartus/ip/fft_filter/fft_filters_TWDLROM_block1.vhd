-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\wickh\Documents\NIH\Review\simulink_models\models\fft_filters\hdlsrc\fft_filters\fft_filters_TWDLROM_block1.vhd
-- 
...
BEGIN
  ...
  BEGIN
    cast_0 := to_signed(0, 32);
    cast_2 := to_signed(0, 32);
    cast_4 := to_signed(0, 32);
    cast_6 := to_signed(0, 32);
    cast_8 := to_signed(0, 32);
    cast_10 := to_signed(0, 32);
    cast := to_signed(0, 32);
    cast_1 := to_signed(0, 32);
    cast_3 := to_signed(0, 32);
    cast_5 := to_signed(0, 32);
    cast_7 := to_signed(0, 32);
    cast_9 := to_signed(0, 32);
