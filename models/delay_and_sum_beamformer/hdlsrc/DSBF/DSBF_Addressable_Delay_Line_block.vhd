-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/trevor/research/NIH_SBIR_R44_DC015443/simulink_models/models/delay_and_sum_beamformer/hdlsrc/DSBF/DSBF_Addressable_Delay_Line_block.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: DSBF_Addressable_Delay_Line_block
...
ENTITY DSBF_Addressable_Delay_Line_block IS
...
END DSBF_Addressable_Delay_Line_block;


ARCHITECTURE rtl OF DSBF_Addressable_Delay_Line_block IS
...
BEGIN
  ...
  switchDataOut <= delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#0#, 4) ELSE
      delayedSignals1 WHEN rdAddr_unsigned = to_unsigned(16#1#, 4) ELSE
      delayedSignals2 WHEN rdAddr_unsigned = to_unsigned(16#2#, 4) ELSE
      delayedSignals3 WHEN rdAddr_unsigned = to_unsigned(16#3#, 4) ELSE
      delayedSignals4 WHEN rdAddr_unsigned = to_unsigned(16#4#, 4) ELSE
      delayedSignals5 WHEN rdAddr_unsigned = to_unsigned(16#5#, 4) ELSE
      delayedSignals6 WHEN rdAddr_unsigned = to_unsigned(16#6#, 4) ELSE
      delayedSignals7 WHEN rdAddr_unsigned = to_unsigned(16#7#, 4) ELSE
      delayedSignals8 WHEN rdAddr_unsigned = to_unsigned(16#8#, 4) ELSE
      delayedSignals9 WHEN rdAddr_unsigned = to_unsigned(16#9#, 4) ELSE
