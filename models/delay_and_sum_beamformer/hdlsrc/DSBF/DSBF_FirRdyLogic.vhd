-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/trevor/research/NIH_SBIR_R44_DC015443/simulink_models/models/delay_and_sum_beamformer/hdlsrc/DSBF/DSBF_FirRdyLogic.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: DSBF_FirRdyLogic
-- Source Path: DSBF/dataplane/Avalon Data Processing/delay signals/delay signal/CIC interpolation compensator/FirRdyLogic
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DSBF_FirRdyLogic;


ARCHITECTURE rtl OF DSBF_FirRdyLogic IS
  ...
  SIGNAL firRdy_xdin                      : signed(31 DOWNTO 0);  -- sfix32
  ...
  SIGNAL firRdy_xdin_next                 : signed(31 DOWNTO 0);  -- sfix32_En28
  ...
  SIGNAL din_tmp                          : signed(31 DOWNTO 0);  -- sfix32_En28
  ...
  BEGIN
    ...
    CASE firRdy_state IS
      WHEN "000" =>
        ...
        firRdy_xdin_next <= to_signed(0, 32);
      ...
      WHEN "010" =>
        ...
        out2 := '0';
        firRdy_state_next <= to_unsigned(16#2#, 3);
        IF firRdy_count = to_unsigned(16#B#, 4) THEN 
