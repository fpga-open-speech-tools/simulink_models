...
-- Source Path: DSBF/dataplane/MATLAB Function
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  MATLAB_Function_output : PROCESS (cos_elevation_1, sin_azimuth_signed, sin_elevation_signed)
  ...
  BEGIN
    --MATLAB Function 'dataplane/MATLAB Function': '<S7>:1'
    -- meters
    -- meters/second
    --'<S7>:1:10'
