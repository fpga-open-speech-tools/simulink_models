-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/trevor/research/NIH_SBIR_R44_DC015443/simulink_models/models/delay_and_sum_beamformer/hdlsrc/DSBF/DSBF_Addressable_Delay_Line_block6.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: DSBF_Addressable_Delay_Line_block6
...
ENTITY DSBF_Addressable_Delay_Line_block6 IS
...
END DSBF_Addressable_Delay_Line_block6;


ARCHITECTURE rtl OF DSBF_Addressable_Delay_Line_block6 IS
  ...
  SIGNAL ZEROCONST                        : signed(41 DOWNTO 0);  -- sfix42_En28
...
BEGIN
  ...
  ZEROCONST <= to_signed(0, 42);

  
  switchDataOut <= delayedSignals2 WHEN rdAddr_unsigned = to_unsigned(16#0#, 3) ELSE
      delayedSignals1 WHEN rdAddr_unsigned = to_unsigned(16#1#, 3) ELSE
      delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#2#, 3) ELSE
      ZEROCONST WHEN rdAddr_unsigned = to_unsigned(16#3#, 3) ELSE
      ZEROCONST;
