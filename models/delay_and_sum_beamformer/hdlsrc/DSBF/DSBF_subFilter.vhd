-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/NIH/simulink_models/models/delay_and_sum_beamformer/hdlsrc/DSBF/DSBF_subFilter.vhd
-- 
...
BEGIN
  u_FilterTap_1 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              ...
              dinReg_0_re => dinReg_0_re,  -- sfix32_En28
  ...
  u_FilterTap_2 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly2,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_3 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_1,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_4 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_2,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_5 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_3,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_6 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_4,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_7 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_5,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_8 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_6,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_9 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly_7,  -- sfix32_En28
              dinPreAdd => std_logic_vector(dinPreAdd),  -- sfix32_En28
  ...
  u_FilterTap_10 : DSBF_FilterTapSystolicPreAddWvlIn
    PORT MAP( clk => clk,
              enb_1_2048_0 => enb_1_2048_0,
              dinReg_0_re => dinDly,  -- sfix32_En28
