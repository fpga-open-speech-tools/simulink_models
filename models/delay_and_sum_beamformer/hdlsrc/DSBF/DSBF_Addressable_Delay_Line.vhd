-- -------------------------------------------------------------
-- 
-- File Name: /mnt/data/trevor/research/NIH_SBIR_R44_DC015443/simulink_models/models/delay_and_sum_beamformer/hdlsrc/DSBF/DSBF_Addressable_Delay_Line.vhd
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: DSBF_Addressable_Delay_Line
...
ENTITY DSBF_Addressable_Delay_Line IS
...
END DSBF_Addressable_Delay_Line;


ARCHITECTURE rtl OF DSBF_Addressable_Delay_Line IS
...
BEGIN
  ...
  switchDataOut <= delayedSignals0 WHEN rdAddr_unsigned = to_unsigned(16#0#, 4) ELSE
      ...
      delayedSignals10 WHEN rdAddr_unsigned = to_unsigned(16#A#, 4) ELSE
      delayedSignals11;
