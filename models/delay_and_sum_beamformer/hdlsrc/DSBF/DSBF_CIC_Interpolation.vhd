...
ARCHITECTURE rtl OF DSBF_CIC_Interpolation IS
  ...
  -- Type Definitions
  -- Constants
  CONSTANT zeroconst                      : signed(32 DOWNTO 0) := to_signed(0, 33); -- sfix33_En25
  -- Signals
  SIGNAL cur_count                        : unsigned(4 DOWNTO 0); -- ufix5
  SIGNAL phase_0                          : std_logic; -- boolean
  SIGNAL input_typeconvert                : signed(31 DOWNTO 0); -- sfix32_En25
  --   -- Section 1 Signals 
  SIGNAL section_in1                      : signed(31 DOWNTO 0); -- sfix32_En25
  SIGNAL section_cast1                    : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL diff1                            : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL section_out1                     : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_cast                         : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_cast_1                       : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_temp                         : signed(33 DOWNTO 0); -- sfix34_En25
  --   -- Section 2 Signals 
  SIGNAL section_in2                      : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL diff2                            : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL section_out2                     : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_cast_2                       : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_cast_3                       : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sub_temp_1                       : signed(33 DOWNTO 0); -- sfix34_En25
  SIGNAL upsampling                       : signed(32 DOWNTO 0); -- sfix33_En25
  --   -- Section 3 Signals 
  SIGNAL section_in3                      : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL sum1                             : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL section_out3                     : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL add_cast                         : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL add_cast_1                       : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL add_temp                         : signed(33 DOWNTO 0); -- sfix34_En25
  --   -- Section 4 Signals 
  SIGNAL section_in4                      : signed(32 DOWNTO 0); -- sfix33_En25
  SIGNAL section_cast4                    : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL sum2                             : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL section_out4                     : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL add_cast_2                       : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL add_cast_3                       : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL add_temp_1                       : signed(37 DOWNTO 0); -- sfix38_En25
  SIGNAL regout                           : signed(36 DOWNTO 0); -- sfix37_En25
  SIGNAL muxout                           : signed(36 DOWNTO 0); -- sfix37_En25
...
BEGIN
  ...
  section_cast4 <= resize(section_in4, 37);
  ...
  muxout <= section_out4 WHEN ( enb_1_64_1 = '1' ) ELSE
            regout;
